  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.packagebrowser.InfoWindow", {
    ...
    construct: function construct(caption, icon) {
      ...
      this.addListener("resize", this.__P_19_0, this);
    },
    properties: {
      /**
    ...
    members: {
      ...
      _getContentContainer: function _getContentContainer() {
        if (!this.__P_19_1) {
          this.__P_19_1 = new qx.ui.container.Composite(new qx.ui.layout.Canvas());

          this.__P_19_1.setMinHeight(20);
        }
  ...
  qxl.packagebrowser.InfoWindow.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=InfoWindow.js.map?dt=1613266910056