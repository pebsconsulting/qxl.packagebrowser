  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_50_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_50_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_50_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_50_3()) {
      ...
      __P_50_0: function __P_50_0() {
        ...
        if (qx.bom.client.Engine.__P_50_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613266913286