  ...
  qx.Class.define("qx.ui.core.SingleSelectionManager", {
    ...
    */
    ...
    construct: function construct(selectionProvider) {
      ...
      this.__P_206_0 = selectionProvider;
    },
    ...
    members: {
      ...
      */
      ...
      getSelectables: function getSelectables(all) {
        var items = this.__P_206_0.getItems();

        var result = [];

        for (var i = 0; i < items.length; i++) {
          if (this.__P_206_0.isItemSelectable(items[i])) {
            result.push(items[i]);
          }
      ...
      */
      // apply method
      __P_206_1: function __P_206_1(value, old) {
        if (!value) {
          this.__P_206_4(this.__P_206_2);
        }
      },
      ...
      */
       ...
       */
      __P_206_4: function __P_206_4(item) {
        var oldSelected = this.__P_206_2;
       ...
       *    <code>false</code> otherwise.
       */
      __P_206_3: function __P_206_3(item) {
        var items = this.__P_206_0.getItems();
...
//# sourceMappingURL=SingleSelectionManager.js.map?dt=1613267629934