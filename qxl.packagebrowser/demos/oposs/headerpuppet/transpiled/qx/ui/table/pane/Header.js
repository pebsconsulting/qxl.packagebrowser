  ...
  qx.Class.define("qx.ui.table.pane.Header", {
    ...
    */
    ...
    construct: function construct(paneScroller) {
      ...
      this.__P_45_0 = new qx.ui.core.Blocker(this);
      this.__P_45_1 = paneScroller;
    },
    ...
    */
    members: {
      ...
      setPointerOverColumn: function setPointerOverColumn(col) {
        if (col != this.__P_45_3) {
          if (this.__P_45_3 != null) {
            var widget = this.getHeaderWidgetAtColumn(this.__P_45_3);
      ...
      showColumnMoveFeedback: function showColumnMoveFeedback(col, x) {
        ...
        if (this.__P_45_2 == null) {
          ...
          this.__P_45_2 = feedback;
        }

        this.__P_45_2.setLayoutProperties({
          left: pos.left + x
        });
    ...
    */
    destruct: function destruct() {
      this.__P_45_0.dispose();

      this._disposeObjects("__P_45_1");
    }
  });
  qx.ui.table.pane.Header.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Header.js.map?dt=1613267620000