  ...
  qx.Class.define("qx.log.appender.Formatter", {
    ...
    members: {
      ...
      formatEntryTime: function formatEntryTime(entry) {
        ...
        if (!qx.log.appender.Formatter.__P_60_0) {
          qx.log.appender.Formatter.__P_60_0 = new qx.util.format.DateFormat("YYYY-MM-dd HH:mm:ss");
        }

        return qx.log.appender.Formatter.__P_60_0.format(entry.time);
      },
    ...
    statics: {
      ...
      getFormatter: function getFormatter() {
        if (!qx.log.appender.Formatter.__P_60_1) {
          qx.log.appender.Formatter.__P_60_1 = new qx.log.appender.Formatter();
        }

        return qx.log.appender.Formatter.__P_60_1;
      },
      ...
      setFormatter: function setFormatter(instance) {
        qx.log.appender.Formatter.__P_60_1 = instance;
      },
      ...
      escapeHTML: function escapeHTML(value) {
        return String(value).replace(/[<>&"']/g, qx.log.appender.Formatter.__P_60_2);
      },
...
//# sourceMappingURL=Formatter.js.map?dt=1613267621013