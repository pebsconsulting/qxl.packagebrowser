  ...
  qx.Class.define("qx.ui.core.queue.Visibility", {
    statics: {
      ...
      remove: function remove(widget) {
        ...
        delete this.__P_69_2[widget.toHashCode()];
      },
      ...
      isVisible: function isVisible(widget) {
        return this.__P_69_2[widget.toHashCode()] || false;
      },
       ...
       * @return {Boolean} Whether the widget is visible
       */
      __P_69_3: function __P_69_3(widget) {
        var data = this.__P_69_2;
      ...
      flush: function flush() {
        ...
        var data = this.__P_69_2; // Dynamically add children to queue
...
//# sourceMappingURL=Visibility.js.map?dt=1613269856873