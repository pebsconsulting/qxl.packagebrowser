  ...
  qx.Bootstrap.define("qx.bom.Label", {
    ...
    */
    statics: {
       ...
       * @return {Element} Helper DOM element
       */
      __P_36_3: function __P_36_3() {
        var el = this.__P_36_2(true);
       ...
       */
      __P_36_2: function __P_36_2(html) {
       ...
       */
      __P_36_4: function __P_36_4(html) {
        var styles = {};
      ...
      create: function create(content, html, win) {
        ...
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
          ...
          qx.bom.element.Style.setStyles(el, this.__P_36_4(html));
        }
      ...
      setValue: function setValue(element, value) {
        ...
        if (element.useHtml) {
          if (qx.bom.Label.__P_36_5 && typeof qx.bom.Label.__P_36_5 === "function") {
            value = qx.bom.Label.__P_36_5(value);
          }
      ...
      getHtmlSize: function getHtmlSize(content, styles, width) {
        var element = this._htmlElement || this.__P_36_3(); // apply width


        element.style.width = width != undefined ? width + "px" : "auto"; // insert content

        element.innerHTML = content;
        return this.__P_36_6(element, styles);
      },
      ...
      getTextSize: function getTextSize(text, styles) {
        var element = this._textElement || this.__P_36_1();
       ...
       * @return {Map} A map with preferred <code>width</code> and <code>height</code>.
       */
      __P_36_6: function __P_36_6(element, styles) {
        // sync styles
        var keys = this.__P_36_0;
...
//# sourceMappingURL=Label.js.map?dt=1613269853977