  ...
  qx.Bootstrap.define("qx.core.WindowError", {
    ...
    */
    ...
    construct: function construct(failMessage, uri, lineNumber, columnNumber, sourceException) {
      ...
      this.__P_137_0 = failMessage;
      this.__P_137_1 = uri || "";
      this.__P_137_2 = lineNumber === undefined ? -1 : lineNumber;
      this.__P_137_3 = columnNumber === undefined ? -1 : columnNumber;
      this.__P_137_4 = sourceException;
    },
...
//# sourceMappingURL=WindowError.js.map?dt=1613269861298