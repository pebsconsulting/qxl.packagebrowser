  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_41_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_41_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_41_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_41_3()) {
      ...
      __P_41_0: function __P_41_0() {
        ...
        if (qx.bom.client.Engine.__P_41_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613269890722