    ...
    statics: {
      ...
      */
      ...
      flush: function flush() {
        ...
        var queue = this.__P_37_2(); // iterate in reversed order to process widgets with the smallest nesting
       ...
       */
      __P_37_3: function __P_37_3() {
        var VisibilityQueue = qx.ui.core.queue.Visibility; // clear cache

        this.__P_37_1 = {}; // sparse level array

        var levels = [];
        var queue = this.__P_37_0;
        var widget, level;
       ...
       */
      __P_37_2: function __P_37_2() {
        var sortedQueue = [];

        var levels = this.__P_37_3();
...
//# sourceMappingURL=Layout.js.map?dt=1613269890293