  ...
  qx.Class.define("qx.ui.core.queue.Visibility", {
    statics: {
      ...
      remove: function remove(widget) {
        if (this.__P_77_1[widget.toHashCode()]) {
          delete this.__P_77_1[widget.toHashCode()];
          qx.lang.Array.remove(this.__P_77_0, widget);
        }

        delete this.__P_77_2[widget.toHashCode()];
      },
      ...
      isVisible: function isVisible(widget) {
        return this.__P_77_2[widget.toHashCode()] || false;
      },
       ...
       * @return {Boolean} Whether the widget is visible
       */
      __P_77_3: function __P_77_3(widget) {
        var data = this.__P_77_2;
      ...
      add: function add(widget) {
        ...
        this.__P_77_0.unshift(widget);

        this.__P_77_1[widget.toHashCode()] = widget;
      ...
      flush: function flush() {
        ...
        var queue = this.__P_77_0;
        var data = this.__P_77_2; // Dynamically add children to queue
...
//# sourceMappingURL=Visibility.js.map?dt=1613269893037