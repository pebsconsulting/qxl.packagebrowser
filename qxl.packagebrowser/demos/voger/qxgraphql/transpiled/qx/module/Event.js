    ...
    statics: {
      ...
      ready: function ready(callback) {
        ...
        var onWindowLoad = function onWindowLoad() {
          qx.module.Event.__P_166_2 = true;
          callback();
        };
      ...
      $registerEventNormalization: function $registerEventNormalization(types, normalizer) {
        ...
        var registry = qx.module.Event.__P_166_0;
      ...
      $getEventNormalizationRegistry: function $getEventNormalizationRegistry() {
        return qx.module.Event.__P_166_0;
      },
      ...
      $registerEventHook: function $registerEventHook(types, registerHook, unregisterHook) {
        ...
        var onHooks = qx.module.Event.__P_166_1.on;
        ...
        var offHooks = qx.module.Event.__P_166_1.off;
      ...
      $getEventHookRegistry: function $getEventHookRegistry() {
        return qx.module.Event.__P_166_1;
      }
    },
    members: {
      /**
      ...
      on: function on(type, listener, context, useCapture) {
        for (var i = 0; i < this.length; i++) {
          ...
          var hooks = qx.module.Event.__P_166_1.on; // generic
          ...
          var bound = function (el, event) {
            ...
            var registry = qx.module.Event.__P_166_0; // generic
          ...
          if (!el.__P_166_3[type]) {
            el.__P_166_3[type] = {};
          }

          el.__P_166_3[type][el.$$lastlistenerId] = bound;
          ...
          if (!context) {
            ...
            el.__P_166_4[el.$$lastlistenerId] = ctx;
          }
        }
      ...
      off: function off(type, listener, context, useCapture) {
        ...
        for (var j = 0; j < this.length; j++) {
          ...
          if (type !== null) {
            ...
            for (var listenerType in el.__P_166_3) {
              types.push(listenerType);
            }
          }

          for (var i = 0, l = types.length; i < l; i++) {
            for (var id in el.__P_166_3[types[i]]) {
              var storedListener = el.__P_166_3[types[i]][id];

              if (removeAll || storedListener == listener || storedListener.original == listener) {
                // get the stored context
                var hasStoredContext = typeof el.__P_166_4 !== "undefined" && el.__P_166_4[id];
                var storedContext;

                if (!context && hasStoredContext) {
                  storedContext = el.__P_166_4[id];
                ...
                if (result !== null) {
                  delete el.__P_166_3[types[i]][id];
                }

                if (hasStoredContext) {
                  delete el.__P_166_4[id];
                }
              }
            } // call hooks


            var hooks = qx.module.Event.__P_166_1.off; // generic
...
//# sourceMappingURL=Event.js.map?dt=1613269898326