    ...
    statics: {
      ...
      */
      ...
      create: function create(element, attributes, variables, params, win) {
        ...
        var flash = this.__P_198_0(element, attributes, params, win);
      ...
      destroy: function destroy(element, win) {
        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 11) {
          element = this.__P_198_1(element);

          if (element.readyState == 4) {
            this.__P_198_2(element);
          } else {
            if (!win) {
              win = window;
            }
            ...
            qx.bom.Event.addNativeListener(win, "load", function () {
              qx.bom.Flash.__P_198_2(element);
            });
          }
        } else {
          element = this.__P_198_1(element);
       ...
       */
      __P_198_1: function __P_198_1(element) {
        if (!element) {
       ...
       */
      __P_198_2: qx.core.Environment.select("engine.name", {
       ...
       * @signature function()
       */
      __P_198_3: qx.event.GlobalError.observeMethod(function () {
        // IE Memory Leak Fix
        for (var key in qx.bom.Flash._flashObjects) {
          qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[key]);
        }

        window.__P_198_4 = function () {};

        window.__P_198_5 = function () {}; // Remove listener again


        qx.bom.Event.removeNativeListener(window, "beforeunload", qx.bom.Flash.__P_198_3);
      }),
       ...
       */
      __P_198_0: function __P_198_0(element, attributes, params, win) {
        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 11) {
    ...
    */
    defer: function defer(statics) {
      if (qx.core.Environment.get("engine.name") == "mshtml") {
        qx.bom.Event.addNativeListener(window, "beforeunload", statics.__P_198_3);
      }
    }
  });
...
//# sourceMappingURL=Flash.js.map?dt=1613269740864