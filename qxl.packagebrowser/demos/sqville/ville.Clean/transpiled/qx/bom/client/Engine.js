  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_75_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_75_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_75_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_75_3()) {
      ...
      __P_75_0: function __P_75_0() {
        ...
        if (qx.bom.client.Engine.__P_75_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613269732862