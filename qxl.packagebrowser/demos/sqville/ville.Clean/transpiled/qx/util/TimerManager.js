  ...
  qx.Class.define("qx.util.TimerManager", {
    ...
    members: {
      ...
      start: function start(callback, recurTime, context, userData, initialTime) {
        ...
        qx.util.TimerManager.__P_85_1[++qx.util.TimerManager.__P_85_2] = {
          callback: callback,
        ...
        this.__P_85_4(expireAt, qx.util.TimerManager.__P_85_2); // Give 'em the timer id


        return qx.util.TimerManager.__P_85_2;
      },
      ...
      stop: function stop(timerId) {
        ...
        var timerQueue = qx.util.TimerManager.__P_85_0;
        ...
        delete qx.util.TimerManager.__P_85_1[timerId]; // If there are no more timers pending...

        if (timerQueue.length == 0 && this.__P_85_3) {
          // ... then stop listening for the periodic timer
          qx.event.Idle.getInstance().removeListener("interval", this.__P_85_5, this);
          this.__P_85_3 = false;
        }
      },
       ...
       *
       */
      __P_85_4: function __P_85_4(expireAt, timerId) {
        ...
        var timerQueue = qx.util.TimerManager.__P_85_0;
        var timerData = qx.util.TimerManager.__P_85_1;
        var length = timerQueue.length;
        ...
        if (!this.__P_85_3) {
          ...
          qx.event.Idle.getInstance().addListener("interval", this.__P_85_5, this);
          this.__P_85_3 = true;
        }
      },
      ...
      __P_85_5: function __P_85_5() {
        ...
        var timerQueue = qx.util.TimerManager.__P_85_0;
        var timerData = qx.util.TimerManager.__P_85_1; // Is it time to process the first timer element yet?
        ...
        while (timerQueue.length > 0 && timerData[timerQueue[0]].expireAt <= timeNow) {
          ...
          if (expiredTimerData.recurTime && timerData[expiredTimerId]) {
            ...
            this.__P_85_4(expiredTimerData.expireAt, expiredTimerId);
          } else {
...
//# sourceMappingURL=TimerManager.js.map?dt=1613269733670