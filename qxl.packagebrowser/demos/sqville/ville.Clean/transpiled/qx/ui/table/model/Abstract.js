  ...
  qx.Class.define("qx.ui.table.model.Abstract", {
    ...
    members: {
      ...
      getColumnIndexById: function getColumnIndexById(columnId) {
        return this.__P_149_2[columnId];
      },
      // overridden
      getColumnId: function getColumnId(columnIndex) {
        return this.__P_149_0[columnIndex];
      },
      // overridden
      getColumnName: function getColumnName(columnIndex) {
        return this.__P_149_1[columnIndex];
      },
      ...
      setColumnIds: function setColumnIds(columnIdArr) {
        this.__P_149_0 = columnIdArr; // Create the reverse map

        this.__P_149_2 = {};

        for (var i = 0; i < columnIdArr.length; i++) {
          this.__P_149_2[columnIdArr[i]] = i;
        }

        this.__P_149_1 = new Array(columnIdArr.length); // Inform the listeners
      ...
      setColumnNamesByIndex: function setColumnNamesByIndex(columnNameArr) {
        if (this.__P_149_0.length != columnNameArr.length) {
          throw new Error("this.__columnIdArr and columnNameArr have different length: " + this.__P_149_0.length + " != " + columnNameArr.length);
        }

        this.__P_149_1 = columnNameArr; // Inform the listeners
      ...
      setColumnNamesById: function setColumnNamesById(columnNameMap) {
        this.__P_149_1 = new Array(this.__P_149_0.length);

        for (var i = 0; i < this.__P_149_0.length; ++i) {
          this.__P_149_1[i] = columnNameMap[this.__P_149_0[i]];
        }
      },
      ...
      setColumns: function setColumns(columnNameArr, columnIdArr) {
        var bSetIds = this.__P_149_0.length == 0 || columnIdArr;

        if (columnIdArr == null) {
          if (this.__P_149_0.length == 0) {
            columnIdArr = columnNameArr;
          } else {
            columnIdArr = this.__P_149_0;
          }
        }
...
//# sourceMappingURL=Abstract.js.map?dt=1613269737228