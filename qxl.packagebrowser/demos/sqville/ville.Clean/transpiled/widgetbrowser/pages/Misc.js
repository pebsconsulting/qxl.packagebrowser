  ...
  ************************************************************************ */
  ...
  qx.Class.define("widgetbrowser.pages.Misc", {
    ...
    construct: function construct() {
      ...
      this.__P_8_0 = new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
      this.add(this.__P_8_0);
      this.initWidgets();
    },
    members: {
      __P_8_0: null,
      initWidgets: function initWidgets() {
        ...
        this.__P_8_0.add(label);

        this.__P_8_0.add(pb); // SlideBar
        ...
        this.__P_8_0.add(slideBar); // Pop-Up
        ...
        this.__P_8_0.add(subcontainer); // DragDrop
...
//# sourceMappingURL=Misc.js.map?dt=1613269726128