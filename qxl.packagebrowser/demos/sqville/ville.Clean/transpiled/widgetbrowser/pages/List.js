  ...
  ************************************************************************ */
  ...
  qx.Class.define("widgetbrowser.pages.List", {
    ...
    construct: function construct() {
      ...
      this.__P_7_0 = new qx.ui.container.Composite(new qx.ui.layout.Grid(10));
      this.__P_7_1 = qx.util.ResourceManager.getInstance().toUri("widgetbrowser/people.json");
      this.add(this.__P_7_0);
      this.initWidgets();
    },
    members: {
      __P_7_0: null,
      ...
      initWidgets: function initWidgets() {
        ...
        this.__P_7_0.add(label, {
          row: 0,
          column: 0
        });

        var list = this.__P_7_2();

        this.__P_7_0.add(list, {
          row: 1,
          column: 0
        });
        ...
        var virtualList = this.__P_7_3();

        this.__P_7_0.add(virtualList, {
          row: 1,
          column: 1
        });
        ...
        var groupedVirtualList = this.__P_7_4();

        this.__P_7_0.add(groupedVirtualList, {
          row: 1,
          column: 2
        });
      ...
      __P_7_2: function __P_7_2() {
        ...
        list.setWidth(150);
        var req = new qx.io.request.Xhr(this.__P_7_1);
        req.setParser("json");
      ...
      __P_7_4: function __P_7_4() {
        var list = this.__P_7_3(); // Creates the delegate for sorting and grouping
      ...
      __P_7_5: function __P_7_5(widget) {
        var store = new qx.data.store.Json(this.__P_7_1);
...
//# sourceMappingURL=List.js.map?dt=1613269726068