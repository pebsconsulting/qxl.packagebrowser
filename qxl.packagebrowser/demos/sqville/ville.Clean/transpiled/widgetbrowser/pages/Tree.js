  ...
  ************************************************************************ */
  ...
  qx.Class.define("widgetbrowser.pages.Tree", {
    ...
    construct: function construct() {
      ...
      this.__P_11_0 = new qx.ui.container.Composite(new qx.ui.layout.Grid(10));
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        this.__P_11_0.add(label, {
          row: 0,
          column: 0
        });

        var tree = this.__P_11_1();

        this.__P_11_0.add(tree, {
          row: 1,
          column: 0
        });
        ...
        var virtualTree = this.__P_11_2();

        this.__P_11_0.add(virtualTree, {
          row: 1,
          column: 1
        });
        ...
        var treeVirtual = this.__P_11_3();

        this.__P_11_0.add(treeVirtual, {
          row: 1,
          column: 2
        });
...
//# sourceMappingURL=Tree.js.map?dt=1613269726325