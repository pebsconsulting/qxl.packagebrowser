  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.RepeatButton", {
    ...
    construct: function construct(label, icon) {
      ...
      this.__P_189_0 = new qx.event.AcceleratingTimer();
    ...
    members: {
      ...
      */
      ...
      _onPointerUp: function _onPointerUp(e) {
        ...
        if (!this.hasState("abandoned")) {
          ...
          if (this.hasState("pressed") && !this.__P_189_1) {
            this.execute();
          }
        }
      ...
      */
       ...
       *
       */
      __P_189_2: function __P_189_2() {
        this.fireEvent("press");
        this.__P_189_1 = false;
...
//# sourceMappingURL=RepeatButton.js.map?dt=1613269824098