    ...
    */
    members: {
      ...
      */
       ...
       * and position.
       */
      __P_15_2: function __P_15_2() {
        var menuBounds = this._getMenuBounds();

        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_15_2, this);
          return;
        }
...
//# sourceMappingURL=Menu.js.map?dt=1613269809494