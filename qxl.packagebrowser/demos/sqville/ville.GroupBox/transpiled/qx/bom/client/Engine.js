  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_23_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_23_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_23_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_23_3()) {
      ...
      __P_23_0: function __P_23_0() {
        ...
        if (qx.bom.client.Engine.__P_23_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613269810054