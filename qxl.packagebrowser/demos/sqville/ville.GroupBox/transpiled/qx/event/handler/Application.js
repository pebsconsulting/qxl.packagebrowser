  ...
  qx.Class.define("qx.event.handler.Application", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_119_0 = false;
      this.__P_119_1 = false;
      this.__P_119_2 = false;
      this.__P_119_3 = false;
      this.__P_119_4 = false; // Initialize observers
    ...
    members: {
      ...
      */
      ...
      __P_119_5: function __P_119_5() {
        ...
        if (!this.__P_119_2 && this.__P_119_0 && qx.$$loader.scriptLoaded) {
          ...
          if (qx.core.Environment.get("engine.name") == "mshtml") {
            if (qx.event.Registration.hasListener(this._window, "ready")) {
              this.__P_119_2 = true; // Fire user event
      ...
      __P_119_6: function __P_119_6() {
        this.__P_119_3 = true; // Fire user event
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_119_7),
          "false": this.__P_119_7
        });
      ...
      _onNativeUnload: function _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_119_8),
          "false": this.__P_119_8
        });
        callback.apply(this, arguments);
      },
...
//# sourceMappingURL=Application.js.map?dt=1613269819174