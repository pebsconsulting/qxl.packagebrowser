(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "ville.groupbox.Appearance": {},
      "qx.theme.manager.Decoration": {},
      "ville.groupbox.Decoration": {},
      "qx.ui.core.Blocker": {},
      "qx.ui.layout.Dock": {},
  ...
  qx.Class.define("wax.demo.Application", {
    ...
    */
    members: {
      ...
      main: function main() {
        // Call super class
        wax.demo.Application.prototype.main.base.call(this); // Enable logging in debug variant
        ...
        qx.Theme.include(qx.theme.manager.Decoration.getInstance().getTheme(), ville.groupbox.Decoration); // *** START of Base Scaffolding **************************************************************************
        // *** Base Scaffolding are objects common to all Wax - Franklin based apps  ******************************
        // ********************************************************************************************************
        // App's Root

        var approot = this.getRoot(); // Add a Blocker to the application's root for the Main Menu Popup
        ...
        var appdocklayout = new qx.ui.layout.Dock(0, 0); //appdocklayout.setSort("x");

        var appcompdock = new qx.ui.container.Composite(appdocklayout).set({
        ...
        var mainmenubtnbutton = new qx.ui.toolbar.Button("MainMenu", "wax/demo/round-menu-24px.svg").set({
          show: "icon"
        });
        mainmenubtnbutton.getChildControl("icon").set({
          width: 24,
          height: 24
        }); // Top-Right MenuButton

        var profilemenubutton = new qx.ui.toolbar.MenuButton("ProfileMenu", "wax/demo/round-account_circle-24px.svg").set({
          show: "icon",
          showArrow: false
        });
        profilemenubutton.getChildControl("icon").set({
          width: 24,
          height: 24
        ...
        mainmenupopup.setLayout(new qx.ui.layout.VBox(0)); // Profile and Settings Menu and Menu Buttons
        ...
        var profilemenubutton1 = new qx.ui.menu.Button("Edit my profile", "wax/demo/edit-24px.svg").set({
          padding: 10
        });
        profilemenubutton1.getChildControl("icon").set({
          width: 24,
          height: 24
        });
        var settingsmenubutton = new qx.ui.menu.Button("Settings", "wax/demo/outline-settings-24px.svg").set({
          padding: 10
        });
        settingsmenubutton.getChildControl("icon").set({
          width: 24,
          height: 24
        });
        var logoutmenubutton = new qx.ui.menu.Button("Log out", "wax/demo/exit_to_app-24px.svg").set({
          padding: 10
        });
        logoutmenubutton.getChildControl("icon").set({
          width: 24,
          height: 24
        }); // Search Button (hybrid mobile)

        var btnsearchbutton = new qx.ui.toolbar.Button("Search", "wax/demo/baseline-search-24px.svg").set({
          show: "icon"
        }); // Back Button (hybrid mobile)

        var btnbackbutton = new qx.ui.toolbar.Button("Back", "wax/demo/baseline-chevron_left-24px.svg").set({
          show: "icon"
        ...
        profilemenubutton.setMenu(profilemenu); //noun_honey_2576471.svg 48x48

        var atmlogocurrentpage = new qx.ui.basic.Atom("wax", "wax/demo/Wax_demo_logo.png").set({
          font: "hym-app-header",
          gap: 10,
          padding: 0,
          visibility: "hidden"
        ...
        profilepart.add(profilemenubutton); //setup northtoolbar for both desktop and mobile, but hide mobile
        ...
        var overviewpage = new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({
          padding: 20
        });
        var gallerypage = new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({
          padding: 20
        });
        ...
        dashboardpage.setLayout(new qx.ui.layout.VBox(6).set({
          alignX: "left"
        }));
        var dashboardsubpage1 = new qx.ui.container.Composite();
        var dashboardflow = new qx.ui.layout.Flow(16, 20, "left");
        dashboardsubpage1.setLayout(dashboardflow); // Controls
        // First page marker 

        var label1 = new qx.ui.basic.Label("My Default Dashboard").set({
          font: "control-header"
        }); // GroubBox
        ...
        var piechartimage = new qx.ui.basic.Image("wax/demo/pie_chart-24px.svg").set({
          scale: true,
          width: 272,
          height: 272
        });
        ...
        groupbox4.add(new qx.ui.basic.Image("wax/demo/bar_chart-24px.svg").set({
          scale: true,
          width: 222,
          height: 222
        }));
        groupbox4.add(new qx.ui.basic.Image("wax/demo/bar_chart-24px.1.svg").set({
          scale: true,
          width: 222,
          height: 222
        }));
        groupbox4.add(new qx.ui.basic.Image("wax/demo/bar_chart-24px.2.svg").set({
          scale: true,
          width: 222,
          height: 222
        }));
        groupbox4.add(new qx.ui.basic.Atom("Year over year growth shows how the market favored the bold", "wax/demo/bolt-24px.svg").set({
          rich: true,
          width: 200,
          height: 142
        }));
        var barchartimage = new qx.ui.basic.Image("wax/demo/view_compact-24px.svg").set({
          scale: true,
          width: 312,
          height: 312
        });
        var bubblechartimage = new qx.ui.basic.Image("wax/demo/bubble_chart-24px.svg").set({
          scale: true,
          width: 312,
          height: 312
        });
        groupbox1.add(piechartimage);
        groupbox1.add(new qx.ui.basic.Label("<b>Results:</b> Half of the pie is divided").set({
          rich: true
        }));
        var labelenv = new qx.ui.basic.Label("device.name=" + qx.core.Environment.get("device.name") + "<br>device.type=" + qx.core.Environment.get("device.type") + "<br>browser.name=" + qx.core.Environment.get("browser.name") + "<br>browser.version=" + qx.core.Environment.get("browser.version") + "<br>os.name=" + qx.core.Environment.get("os.name") + "<br>os.version=" + qx.core.Environment.get("os.version") + "<br>engine.name=" + qx.core.Environment.get("engine.name") + "<br>phonegap=" + qx.core.Environment.get("phonegap") + "<br>phonegap.notification=" + qx.core.Environment.get("phonegap.notification") + "<br>runtime.name=" + qx.core.Environment.get("runtime.name")).set({
          rich: true
        });
        groupbox2.add(labelenv); //groupbox2.add(barchartimage);
        ...
        groupbox3.add(new qx.ui.basic.Label("<b>Insight:</b> Indicators suggest we go with <span style='color:red;'><b>Red</b></span>").set({
          rich: true
        })); // Assemble
        ...
        dashboardsubpage1.add(groupbox3, {
          lineBreak: true
        });
        ...
        dashboardpage.add(dashboardsubpage1); // Second page marker  

        var label5 = new qx.ui.basic.Label("Actions").set({
          font: "control-header"
        });
        var secmidsection = new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
        overviewpage.add(label5); // Do This code

        var secpagegroupbox1 = new ville.groupbox.GroupBox("Do This", "", true, true).set({
          allowStretchX: [true, true],
          allowStretchY: [false, false],
          appearance: "ville-groupbox-connected",
          minWidth: 340
        });
        secpagegroupbox1.getChildControl("open", true).setMarginRight(20);
        secpagegroupbox1.setLayout(new qx.ui.layout.VBox());
        var secpagegroupbox1contentbox = new qx.ui.container.Composite(new qx.ui.layout.HBox(4)).set({
          alignY: "middle"
        });
        secpagegroupbox1contentbox.add(new qx.ui.basic.Label("If you would like to do this. This opens a modal window <b>with</b> a blocker box behind it. Adding more so text will wrap as screen shrinks").set({
          alignY: "middle",
          textAlign: "left",
          rich: true,
          wrap: true
        ...
        secpagegroupbox1contentbox.add(new qx.ui.core.Spacer(30, 20), {
          flex: 1
        });
        var btnDoThis = new qx.ui.form.Button("Do This").set({
          width: 165,
          height: 40,
          maxHeight: 40,
          alignX: "right",
        ...
        var winDoThis = this.__P_2_0();

        winDoThis.set({
          caption: "Do This",
          status: "Modal window with a blocker",
          width: 660,
          contentPadding: 20
        ...
        winDoThis.add(new qx.ui.basic.Label("<b>Action Name:</b>").set({
          rich: true
        }));
        winDoThis.add(new qx.ui.basic.Label(winDoThis.getCaption()).set({
          marginBottom: 18
        }));
        winDoThis.add(new qx.ui.basic.Label("<b>Summary:</b>").set({
          rich: true
        }));
        winDoThis.add(new qx.ui.form.TextField().set({
          placeholder: "Action summary",
          marginBottom: 18
        }));
        winDoThis.add(new qx.ui.basic.Label("<b>Details:</b>").set({
          rich: true
        }));
        winDoThis.add(new qx.ui.form.TextArea().set({
          placeholder: "Action details"
        }));
        var winselectbox01 = new qx.ui.form.SelectBox().set({
          marginBottom: 18,
          maxWidth: 260
        });
        ...
        winDoThis.add(new qx.ui.basic.Label("<b>Status:</b>").set({
          rich: true
        }));
        winDoThis.add(winselectbox01);
        winDoThis.add(new qx.ui.basic.Label("<b>Date:</b>").set({
          rich: true,
          width: 175
        }));
        winDoThis.add(new qx.ui.form.DateField().set({
          marginBottom: 18,
          maxWidth: 260
        }));
        winDoThis.add(new qx.ui.basic.Label("<b>Notes:</b>").set({
          rich: true
        }));
        ...
        winDoThis.add(new qx.ui.core.Spacer(30, 20), {
          flex: 1
        });
        var buttonHBox = new qx.ui.container.Composite(new qx.ui.layout.HBox(10));
        buttonHBox.add(btnUpdatewin, {
          flex: 1
        });
        buttonHBox.add(btnClosewin, {
          flex: 1
        });
        ...
        var secpagegroupbox2 = new ville.groupbox.GroupBox("Do That", "", true, true).set({
          allowStretchX: [true, true],
          allowStretchY: [false, false],
          appearance: "ville-groupbox-connected",
          minWidth: 340
        ...
        var secpagegroupbox2contentbox = new qx.ui.container.Composite(new qx.ui.layout.HBox(4)).set({
          alignY: "middle"
        });
        secpagegroupbox2contentbox.add(new qx.ui.basic.Label("If you would like to do that. That opens a modal window <b>without</b> a blocker box behind it Adding more so text will wrap as screen shrinks").set({
          alignY: "middle",
          textAlign: "left",
          rich: true,
          wrap: true
        ...
        secpagegroupbox2contentbox.add(new qx.ui.core.Spacer(30, 20), {
          flex: 1
        });
        var btnDoThat = new qx.ui.form.Button("Do That").set({
          width: 165,
          height: 40,
          maxHeight: 40,
          alignX: "right",
        ...
        secmidsection.add(secpagegroupbox1, {
          width: "50%",
          flex: 1
        });
        secmidsection.add(secpagegroupbox2, {
          width: "50%",
          flex: 1
        }); // All that you did code

        var secpagegroupbox3 = new ville.groupbox.GroupBox("All That You Did", "", true, true).set({
          allowStretchX: [true, true],
          allowStretchY: [false, false],
          appearance: "ville-groupbox-connected",
          minWidth: 340
        ...
        secpagegroupbox3.add(new qx.ui.basic.Label("Here's a list of all that you did. The table below is just a simple grid rather than a qooxdoo table control. Versatility is the key. There are multiple options for every use case. Adding more so text will wrap as screen shrinks").set({
          alignY: "middle",
          textAlign: "left",
          rich: true,
          wrap: true
        ...
        var secpagegridtable = this.__P_2_1();

        secpagegroupbox3.add(secpagegridtable);
        overviewpage.add(secmidsection);
        overviewpage.add(secpagegroupbox3); // Third page marker

        var label6 = new qx.ui.basic.Label("List of Items").set({
          font: "control-header"
        }); //var tablelistflow = new qx.ui.layout.Flow().set({alignY: "bottom", alignX: "left"});

        var tablelistvbox = new qx.ui.layout.VBox(); //tablelistpage.set({backgroundColor: "yellow"});
        //tablelistpage.setLayout(tablelistflow);

        tablelistpage.setLayout(tablelistvbox);
        tablelistpage.add(label6);
        var tableliststack = new qx.ui.container.Stack().set({
          paddingTop: 10,
          allowGrowY: true
        });

        var tablelisttable = this.__P_2_2();

        var tablelistlist = this.__P_2_3();

        tableliststack.add(tablelisttable);
        tableliststack.add(tablelistlist);
        tablelistpage.add(tableliststack, {
          flex: 1
        }); // Gallery Page

        var lblGalleryHeader = new qx.ui.basic.Label("My Default Gallery").set({
          font: "control-header"
        });
        gallerypage.add(lblGalleryHeader); // Gallery Upload control - desktop only
        ...
        if (qx.core.Environment.get("device.type") == "desktop") {
          ...
          ctrlUpload.getChildControl("message").set({
            icon: "wax/demo/cloud_upload-24px.svg",
            iconPosition: "top",
            gap: 0
          });
          gallerypage.add(ctrlUpload);
          var uploaddemorestore = new qx.ui.form.Button("Restore").set({
            allowGrowX: false
          });
          ...
          var uploadprogress = new qx.ui.form.Button("+ 10%").set({
            allowGrowX: false
          });
          ...
          upldhbox.add(uploadprogress); //gallerypage.add(upldhbox);
        }
        ...
        gallerygroupboxcars.set({
          allowShrinkX: true,
          allowShrinkY: true,
          allowGrowX: true,
          allowGrowY: true
        });
        gallerygroupboxcars.add(new qx.ui.basic.Image("wax/demo/gallery/Yellow_Car2.jpg").set({
          scale: true,
          width: 420,
          height: 280
        }));
        gallerygroupboxcars.add(new qx.ui.basic.Image("wax/demo/gallery/Flame_Car2.jpg").set({
          scale: true,
          width: 420,
          height: 280
        }));
        ...
        gallerygroupboxtrain.set({
          allowShrinkX: true,
          allowShrinkY: true,
          allowGrowX: true,
          allowGrowY: true
        });
        gallerygroupboxtrain.add(new qx.ui.basic.Image("wax/demo/gallery/Deep_Train_Bridge_Sky.JPG").set({
          scale: true,
          width: 420,
          height: 280
        }));
        gallerygroupboxtrain.add(new qx.ui.basic.Image("wax/demo/gallery/Top_Train_Bridge.JPG").set({
          scale: true,
          width: 420,
          height: 280
        }));
        gallerygroupboxtrain.add(new qx.ui.basic.Image("wax/demo/gallery/Train_Bridge_Close.JPG").set({
          scale: true,
          width: 420,
          height: 280
        }));
        gallerygroupboxtrain.add(new qx.ui.basic.Image("wax/demo/gallery/Train_Bridge_Close2.JPG").set({
          scale: true,
          width: 420,
          height: 280
        }));
        gallerygroupboxtrain.add(new qx.ui.basic.Image("wax/demo/gallery/Deep_Train_Bridge.jpg").set({
          scale: true,
          width: 280,
          height: 420
        }));
        ...
        gallerygroupboxfood.set({
          allowShrinkX: true,
          allowShrinkY: true,
          allowGrowX: true,
          allowGrowY: true
        });
        gallerygroupboxfood.add(new qx.ui.basic.Image("wax/demo/gallery/Vegies2.jpg").set({
          scale: true,
          width: 420,
          height: 280
        }));
        ...
        gallerygroupboxart.set({
          allowShrinkX: true,
          allowShrinkY: true,
          allowGrowX: true,
          allowGrowY: true
        });
        gallerygroupboxart.add(new qx.ui.basic.Image("wax/demo/gallery/Crowd_Pressure.png").set({
          scale: true,
          width: 420,
          height: 280
        }));
        gallerygroupboxart.add(new qx.ui.basic.Image("wax/demo/gallery/Normal_Dude.png").set({
          scale: true,
          width: 420,
          height: 350
        }));
        gallerygroupboxart.add(new qx.ui.basic.Image("wax/demo/gallery/RoxArms.jpg").set({
          scale: true
        }));
        gallerygroupboxart.add(new qx.ui.basic.Image("wax/demo/gallery/Santa_Color-Orig.JPG").set({
          scale: true,
          width: 420,
          height: 306
        }));
        gallerygroupboxart.add(new qx.ui.basic.Image("wax/demo/gallery/holiday_cheer.JPG").set({
          scale: true,
          width: 420,
          height: 392
        }));
        gallerygroupboxart.add(new qx.ui.basic.Image("wax/demo/Roxarama-Guy.png").set({
          scale: true
        }));
        ...
        gallerygroupboxvideo.set({
          allowShrinkX: true,
          allowShrinkY: true,
          allowGrowX: true,
          allowGrowY: true
        });
        gallerygroupboxvideo.add(new qx.ui.basic.Image("wax/demo/gallery/movie1.jpg").set({
          scale: true
        }));
        ...
        gallerypage.add(gallerygroupboxvideo); // Menu Page for demo mode = "mobile"
        ...
        menupage.add(btnLogout); //create About Wax popup window
        ...
        winAboutWax.set({
          caption: "About Wax",
          contentPadding: 0,
          status: "Github repo coming soon"
        });
        ...
        txtaboutwax += "Skeletons and the demo browser are not new concepts to Qooxdoo. These features have been around since the beginning. The purpose of this writeup is to convey good-intent, thoughts and ideas on how to improve peoples work lives, and not meant to be critical or take credit for anything in anyway. The past and current qooxdoo core team have done, and are doing, phenomenal work. My thanks go out to them for making me look better than I really am - Cheers."; //var aboutbox = new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
        ...
        waxatom.getChildControl("icon").set({
          scale: true,
          width: 300,
          height: 106
        });
        ...
        aboutmenubutton1.addListener("execute", function (e) {
          ...
          winAboutWax.center();
          winAboutWax.show();
        }, this); // Assemble - THE STACK 

        centerbox.add(dashboardpage);
        centerbox.add(overviewpage);
        centerbox.add(tablelistpage);
        centerbox.add(gallerypage);
        centerbox.add(menupage); // Show the default page

        centerbox.setSelection([dashboardpage]); // *** END of THE STACK ****************************************************************************************
        ...
        atmleftnavheader.getChildControl("icon").set({
          scale: true
        });
        ...
        var btnSubSecondpage = new qx.ui.form.Button("Do This").set({
          appearance: "submenubutton",
          allowGrowX: true,
          padding: [10, 4, 14, 60],
          visibility: "excluded"
        });
        var btnSubSecondpage2 = new qx.ui.form.Button("Do That").set({
          appearance: "submenubutton",
          allowGrowX: true,
          padding: [10, 4, 14, 60],
          visibility: "excluded"
        ...
        westboxbuttongroup.add(tbtndashboardpage, tbtnSecondPage, tbtnThirdPage, tbtnGalleryPage); // CLONE the above controls

        var atmmenuleftnavheader = atmleftnavheader.clone();
        atmmenuleftnavheader.getChildControl("icon").set({
          scale: true
        });
        ...
        btnsubmenusubsecondpage.getChildControl("icon").set({
          scale: true
        });
        var btnsubmenusubsecondpage2 = btnSubSecondpage2.clone();
        btnsubmenusubsecondpage.set({
          visibility: "visible",
          decorator: "mainmenubutton-box"
        });
        btnsubmenusubsecondpage2.set({
          visibility: "visible",
          decorator: "mainmenubutton-box"
        });
        ...
        var tbtnmenuGalleryPage = tbtnGalleryPage.clone(); // Add the clones to the Main Menu Popup
        ...
        mainmenubuttongroup.add(tbtnmenudashboardpage, tbtnmenuSecondPage, tbtnmenuThirdPage, tbtnmenuGalleryPage); //***  CODE for applying popup fading in and out  ***//
        ...
        }, this); // *** END of Main Menu and Main Menu Popup *********************************************************
        // mobile demo mode - Populate southbox with content

        var tbtndashboardpagehym = new wax.demo.MenuButton("Dashboards", "wax/demo/dashboard-24px.svg", true).set({
          appearance: "mainmenubutton-hym",
          iconPosition: "top"
        });
        var tbtnoverviewpagehym = new wax.demo.MenuButton("Actions", "wax/demo/assignment_returned-24px.svg", true).set({
          appearance: "mainmenubutton-hym",
          iconPosition: "top"
        });
        var tbtnlistofitemspagehym = new wax.demo.MenuButton("List of Items", "wax/demo/view_list-24px.svg", true).set({
          appearance: "mainmenubutton-hym",
          iconPosition: "top"
        });
        var tbtngallerypagehym = new wax.demo.MenuButton("Gallery", "wax/demo/camera-24px.svg", true).set({
          appearance: "mainmenubutton-hym",
          iconPosition: "top"
        });
        var tbtnmenuhym = new wax.demo.MenuButton("Menu", "wax/demo/round-menu-24px.svg", true).set({
          appearance: "mainmenubutton-hym",
          iconPosition: "top"
        });
        ...
        southbox.add(tbtngallerypagehym, {
          flex: 1
        });
        southbox.add(tbtnmenuhym, {
          flex: 1
        });
        southbox.setVisibility("excluded"); // Assign all the clones their own RadioGroup

        var mainmenubuttongrouphym = new qx.ui.form.RadioGroup();
        mainmenubuttongrouphym.add(tbtndashboardpagehym, tbtnoverviewpagehym, tbtnlistofitemspagehym, tbtngallerypagehym, tbtnmenuhym); // *** END of Hybrid Mobil (hym) Main Menu and Main Menu Popup ****************************************************************
        ...
        }, this); // Demo mode switching to Mobile
        ...
        switchmenubutton1.addListener("execute", function (e) {
          ...
          mainmenubuttongrouphym.setSelection([tbtnmenuhym]); //mainmenupart.add(btnbackbutton);    
        ...
        btnSwitchBack.addListener("execute", function (e) {
          ...
          centerbox.setSelection([dashboardpage]);
          mainmenubuttongroup.setSelection([tbtnmenudashboardpage]);
          westboxbuttongroup.setSelection([tbtndashboardpage]); //btnsearchbutton.setVisibility("excluded");
        }, this); // *** END of Wiring ************************************************************************************
        // ====================================
        // =======  MediaQuery code  ========== 
        // ====================================
        ...
        if (qx.core.Environment.get("device.type") == "mobile") {
          ...
          scrollwest.setVisibility("excluded"); // This addresses the scroll bouncing in: 
          //  - Chrome for Android

          var dsktopstylsheet = qx.ui.style.Stylesheet.getInstance();
          dsktopstylsheet.addRule("html", "overscroll-behavior : none none;");
          dsktopstylsheet.addRule("body", "overscroll-behavior : none none;"); // Set the body tag's position to prevent scroll bouncing (and pull down refresh) in:
          //  - Safari for iOS
          //      - Edge for iOS (same as above browser now)
          //  - FireFox for iOS

          document.body.style.position = "fixed"; // TODO *Need solution to address scroll bouncing in:
          //   - Chrome for iOS
        ...
        if (qx.core.Environment.get("phonegap")) {// build out south bar
        }
      },
      // property apply
      ...
      **********************************************************/
      __P_2_1: function __P_2_1() {
        ...
        layout.setColumnFlex(5, 1); //layout.setRowFlex(1, 3);

        layout.setSpacing(10);
        container.setLayout(layout); // Table Headers

        container.add(new qx.ui.basic.Label("Action").set({
          font: "default-bold"
        }), {
          row: 0,
          column: 0
        });
        container.add(new qx.ui.basic.Label("Header02").set({
          font: "default-bold"
        }), {
          row: 0,
          column: 1
        });
        container.add(new qx.ui.basic.Label("Header03").set({
          font: "default-bold"
        }), {
          row: 0,
          column: 2
        });
        container.add(new qx.ui.basic.Label("Header04").set({
          font: "default-bold"
        }), {
          row: 0,
          column: 3
        });
        container.add(new qx.ui.basic.Label("Header05").set({
          font: "default-bold"
        }), {
          row: 0,
          column: 4
        });
        container.add(new qx.ui.basic.Label("Revoke").set({
          font: "default-bold"
        }), {
          row: 0,
          column: 5
        ...
        container.add(new qx.ui.basic.Label("Did This"), {
          row: 1,
          column: 0
        });
        container.add(new qx.ui.basic.Label("Row01Column02"), {
          row: 1,
          column: 1
        });
        container.add(new qx.ui.basic.Label("Row01Column03"), {
          row: 1,
          column: 2
        });
        container.add(new qx.ui.basic.Label("Row01Column04"), {
          row: 1,
          column: 3
        });
        container.add(new qx.ui.basic.Label("Row01Column05"), {
          row: 1,
          column: 4
        });
        container.add(new qx.ui.basic.Image("wax/demo/cancel-24px.svg").set({
          opacity: .3,
          width: 24,
          height: 24
        }), {
        ...
        container.add(new qx.ui.basic.Label("Did That"), {
          row: 2,
          column: 0
        });
        container.add(new qx.ui.basic.Label("Row02Column02"), {
          row: 2,
          column: 1
        });
        container.add(new qx.ui.basic.Label("Row02Column03"), {
          row: 2,
          column: 2
        });
        container.add(new qx.ui.basic.Label("Row02Column04"), {
          row: 2,
          column: 3
        });
        container.add(new qx.ui.basic.Label("Row02Column05"), {
          row: 2,
          column: 4
        });
        container.add(new qx.ui.basic.Image("wax/demo/cancel-24px.svg").set({
      ...
      __P_2_2: function __P_2_2() {
        //Get the raw data
        var rowData = this.__P_2_4(); //Create the data (table) model
        ...
        tableModel.setColumnSortable(5, false); //Create a table view for the model
      ...
      __P_2_3: function __P_2_3() {
        ...
        for (var i in rowData) {
          ...
          groupbox1.add(new qx.ui.basic.Label("<b>Status:</b> " + rowData[i][1]).set({
            rich: true
          }));
          groupbox1.add(new qx.ui.basic.Label("<b>Item ID:</b> " + rowData[i][2]).set({
            rich: true
          }));
          groupbox1.add(new qx.ui.basic.Label("<b>Date Submitted:</b> " + rowData[i][4]).set({
            rich: true
          }));
      ...
      __P_2_0: function __P_2_0() {
        // Create the Window
        var win = new qx.ui.window.Window("Generic Window").set({
...
//# sourceMappingURL=Application.js.map?dt=1613269807743