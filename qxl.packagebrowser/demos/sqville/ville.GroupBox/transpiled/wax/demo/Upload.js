(function () {
  ...
  ************************************************************************ */
   ...
   */
  qx.Class.define("wax.demo.Upload", {
    ...
    */
     ...
     */
    construct: function construct(message, label, icon) {
      ...
      this.setPadding([20, 0, 0, 0]); // Add dragndrop listeners during appear event, if enabled

      if (this.getDragndropenabled()) {
        this.__P_27_0();

        this.__P_27_1(this.getDragovermessage());
      }
    ...
    */
    members: {
      ...
      _createChildControlImpl: function _createChildControlImpl(id, hash) {
        ...
        switch (id) {
          case "message":
            control = new qx.ui.basic.Atom(this.getMessage()).set({
              alignX: "center",
              allowGrowX: false,
              gap: 0
            });
          ...
          case "button":
            control = new qx.ui.form.Button("blank", "wax/demo/test.png").set({
              allowGrowX: false
            });
            var inputctrl = new qx.html.Input("file", {
              display: "none"
            }, {
              id: "sqvinputupload1727",
              name: "uploadfiles",
              multiple: true
            });
            inputctrl.addListener("change", function (e) {
              ...
              for (var k = 0; k < files.length; k++) {
                ...
                if (filesize >= filesizemax) {
                  ...
                  filesizerunningsum += filesize; // add file to json string
              ...
              if (triggerupload) {
                ...
                if (this.getDemo()) progressbar.setValue(20);
              }
            }, this);
          ...
          case "progressbar":
            ...
            var animalayer = new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({
              backgroundColor: "white",
              opacity: 0
            });
            var percent = new qx.ui.basic.Label("0%").set({
              textColor: "white",
              alignX: "right",
              allowGrowX: true
            });
            ...
            progress._add(percent, {
              right: 2
            });

            progress._add(animalayer, {
              height: "100%",
              width: "100%"
            });
            ...
            animalayer.addListener("appear", function (e) {
              ...
              qx.bom.element.Animation.animate(domtable, this.__P_27_2, 2000);
            }, this);
        ...
        return control || wax.demo.Upload.prototype._createChildControlImpl.base.call(this, id);
      },
      // overridden
      ...
      __P_27_0: function __P_27_0() {
        ...
        this.addListenerOnce("appear", function (e) {
          ...
          var domtable = this.getContentElement().getDomElement(); //*** ADD DRAG AND DROP EVENTS TO THE DOM ELEMENT:
          ...
          qx.bom.Event.addNativeListener(domtable, "dragenter", function (e) {
            if (e.target.nodeType == 1) {
              ...
              qx.bom.Event.stopPropagation(e); //qx.bom.element.Class.add(this,"plaiddocumentdndenter");
          ...
          qx.bom.Event.addNativeListener(domtable, "dragleave", function (e) {
            if (e.target.nodeType == 1) {
              qx.bom.element.Class.remove(this, "sqvdocumentdndenter1727"); //console.log("dragleave");
            }
          }, this); //*** DRAGEXIT

          qx.bom.Event.addNativeListener(domtable, "dragexit", function (e) {
            qx.bom.Event.stopPropagation(e);
            qx.bom.Event.preventDefault(e); //console.log("dragexit");
  ...
  wax.demo.Upload.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Upload.js.map?dt=1613269810503