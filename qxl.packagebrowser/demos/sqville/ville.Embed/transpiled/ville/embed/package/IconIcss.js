  ...
  */
  qx.Class.define("ville.embed.package.IconIcss", {
    ...
    statics: {
      ...
      EMBEDS: {
        "cube-o": {
          template: "icss-single-element",
          "class": "icss-cube-o"
        },
        "coffee-grain": {
          template: "icss-single-element",
          "class": "icss-coffee-grain"
        },
        "coffee": {
          template: "icss-single-element",
          "class": "icss-coffee"
        ...
        "connection": {
          template: "icss-single-element",
          "class": "icss-connection"
        },
        "cloud-download": {
          template: "icss-single-element",
          "class": "icss-cloud-download"
        },
        "folder-close": {
          template: "icss-single-element",
          "class": "icss-folder-close"
        },
        "trumpet": {
          template: "icss-single-element",
          "class": "icss-trumpet"
        ...
        "visual-code": {
          template: "icss-single-element",
          "class": "icss-visual-code"
        },
        "wolverine-c": {
          template: "icss-single-element",
          "class": "icss-wolverine-c"
        },
        "sun-o": {
          template: "icss-single-element",
          "class": "icss-sun-o"
        ...
        "binocular": {
          template: "icss-single-element",
          "class": "icss-binocular"
        },
        "bombshell": {
          template: "icss-single-element",
          "class": "icss-bombshell"
        },
        "food-pot": {
          template: "icss-single-element",
          "class": "icss-food-pot"
  ...
  ville.embed["package"].IconIcss.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=IconIcss.js.map?dt=1613269778731