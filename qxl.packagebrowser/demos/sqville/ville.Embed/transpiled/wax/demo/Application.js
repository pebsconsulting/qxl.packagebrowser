    ...
    */
    members: {
      ...
      main: function main() {
        ...
        var testimage = "wax/demo/test-image.svg"; // Top-Left Button
        ...
        aboutmenubutton1.addListener("execute", function (e) {
          ...
          winAboutWax.center();
          winAboutWax.show();
        }, this); // Add Main Menu Popup Listeners
        ...
        var lblsimpleembed = new qx.ui.basic.Label("Here, at its most <u>basic</u>, is a lone Embed object (named \"cube-o\"), sized at 3 (\"em\" per the template) and colored <span style='color: blue;'>blue</span>:").set({
          rich: true,
          wrap: true
        });
        var embedCubeo = new ville.embed.Embed({
          name: "cube-o",
          size: 3,
          color: "blue"
        });
        var lblsimpleembedcode = new qx.ui.basic.Label("<span style='color:blue;'>new</span> <span style='color:green;'>ville.embed.Embed</span>({ name: <span style='color:maroon;'>\"cube-o\"</span>, size: <span style='color:green;'>3</span>, color: <span style='color:maroon;'>\"blue\"</span> });").set({
          rich: true,
          wrap: true,
          font: "monospace",
        ...
        var lblmoreembed = new qx.ui.basic.Label("To use the new widget in a Button <b>(qx.ui.form.Button)</b>, you need to first patch the Button's underlying Atom <b>(qx.ui.basic.Atom)</b>. Once patched, use the appropriate naming convention so that the Atom control knows to use the new ville.embed.Embed object instead of the qx.ui.basic.Image object:").set({
          rich: true,
          wrap: true
        });
        qx.Class.patch(qx.ui.basic.Atom, ville.embed.MAtomPatch);
        var btnembedcubeobutton = new qx.ui.form.Button('Click Me', 'data:text/json;{ "name": "cube-o", "size":3, "color":"blue" }').set({
        ...
        dashboardiconflow.setLayout(dashboardiconflowlayout); //icons in Atoms

        var atmcoffeegrain = new qx.ui.basic.Atom("coffee-grain", 'data:text/json;{ "name": "coffee-grain", "size":3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmcoffee = new qx.ui.basic.Atom("coffee", 'data:text/json;{ "name": "coffee", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmshapes = new qx.ui.basic.Atom("shapes", 'data:text/json;{ "name": "shapes", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmconnection = new qx.ui.basic.Atom("connection", 'data:text/json;{ "name": "connection", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmclouddownload = new qx.ui.basic.Atom("cloud-download", 'data:text/json;{ "name": "cloud-download", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmfolderclose = new qx.ui.basic.Atom("folder-close", 'data:text/json;{ "name": "folder-close", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmtrumpet = new qx.ui.basic.Atom("trumpet", 'data:text/json;{ "name": "trumpet", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmfootball = new qx.ui.basic.Atom("football", 'data:text/json;{ "name": "football", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmrocket = new qx.ui.basic.Atom("rocket", 'data:text/json;{ "name": "rocket", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmgear = new qx.ui.basic.Atom("gear", 'data:text/json;{ "name": "gear", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmdrone = new qx.ui.basic.Atom("drone", 'data:text/json;{ "name": "drone", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmhtml5 = new qx.ui.basic.Atom("html5", 'data:text/json;{ "name": "html5", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmcss3 = new qx.ui.basic.Atom("css3", 'data:text/json;{ "name": "css3", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmjs = new qx.ui.basic.Atom("js", 'data:text/json;{ "name": "js", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmgoogledrivec = new qx.ui.basic.Atom("google-drive-c", 'data:text/json;{ "name": "google-drive-c", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmvisualcode = new qx.ui.basic.Atom("visual-code", 'data:text/json;{ "name": "visual-code", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmwolverinec = new qx.ui.basic.Atom("wolverine-c", 'data:text/json;{ "name": "wolverine-c", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmsuno = new qx.ui.basic.Atom("sun-o", 'data:text/json;{ "name": "sun-o", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmbinocular = new qx.ui.basic.Atom("binocular", 'data:text/json;{ "name": "binocular", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmbombshell = new qx.ui.basic.Atom("bombshell", 'data:text/json;{ "name": "bombshell", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmfoodpot = new qx.ui.basic.Atom("food-pot", 'data:text/json;{ "name": "food-pot", "size": 3 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmxsquare = new qx.ui.basic.Atom("x-square", 'data:text/json;{ "name": "x-square", "size": 3, "color": "red" }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        ...
        dashboardiconflow.add(atmxsquare); // Assemble
        ...
        dashboardpage.add(dashboardiconflow); // Second page marker  

        var lblfluentuiheader = new qx.ui.basic.Label("Fluent UI Web Icons (SVG)").set({
          font: "control-header"
        }); //simple description

        var lblfluentsimpledesc = new qx.ui.basic.Label("Microsoft's Fluent UI web icons: <b><a href='https://developer.microsoft.com/en-us/fluentui#/controls/web/icon' target='_blank'>Fluent UI Web Icons</a></b> for the full list of available icons.").set({
          rich: true,
          wrap: true
        }); // Basic usage
        ...
        var lblfuisimpleembed = new qx.ui.basic.Label("Here, at its most <u>basic</u>, is a lone Embed object (named \"fui-airtickets\"), sized 60 x 60, and colored <span style='color: blue;'>blue</span>:").set({
          rich: true,
          wrap: true
        });
        var embedfuiairticket = new ville.embed.Embed({
          name: "fui-airtickets",
          color: "blue",
          width: 60,
          height: 60,
        ...
        var lblsimplefuiembedcode = new qx.ui.basic.Label("<span style='color:blue;'>new</span> <span style='color:green;'>ville.embed.Embed</span>({ name: <span style='color:maroon;'>\"fui-airtickets\"</span>, width: <span style='color:green;'>60</span>, height: <span style='color:green;'>60</span>, color: <span style='color:maroon;'>\"blue\"</span> });").set({
          rich: true,
          wrap: true,
          font: "monospace",
          backgroundColor: "#f2f2f2",
        ...
        var btnembedfuiairticketsbutton = new qx.ui.form.Button('Click Me', 'data:text/json;{ "name": "fui-airtickets", "color":"blue", "width": 60, "height": 60 }').set({
          appearance: "testbutton",
          maxWidth: 200,
          alignX: "left",
          alignY: "middle"
        ...
        var lblsubheaderfuiFavs = new qx.ui.basic.Label("A few of my favorite icons:").set({
          font: "headeratom",
          marginTop: 40
        });
        ...
        var atmaccess = new qx.ui.basic.Atom("Access", 'data:text/json;{ "name": "fui-access", "color": "#AB2325", "width": 60, "height": 60 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmword = new qx.ui.basic.Atom("Word", 'data:text/json;{ "name": "fui-word", "color": "#1748A4", "width": 60, "height": 60 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmexcel = new qx.ui.basic.Atom("Excel", 'data:text/json;{ "name": "fui-excel", "color": "#12743B", "width": 60, "height": 60 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmppt = new qx.ui.basic.Atom("PowerPoint", 'data:text/json;{ "name": "fui-ppt", "color": "#EE3111", "width": 60, "height": 60, "allowGrowX": false }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmpub = new qx.ui.basic.Atom("Publisher", 'data:text/json;{ "name": "fui-pub", "color": "#007462", "width": 60, "height": 60 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmonenote = new qx.ui.basic.Atom("OneNote", 'data:text/json;{ "name": "fui-onenote", "color": "#420F6F", "width": 60, "height": 60 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmfuikey = new qx.ui.basic.Atom("Permissions Icon", 'data:text/json;{ "name": "fui-key", "width": 60, "height": 60, "allowGrowX": false }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmfuirelease = new qx.ui.basic.Atom("Release Definition", 'data:text/json;{ "name": "fui-release", "width": 60, "height": 60, "allowGrowX": false }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmfuishapes = new qx.ui.basic.Atom("Shapes", 'data:text/json;{ "name": "fui-shapes", "width": 60, "height": 60, "allowGrowX": false }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        ...
        overviewpage.add(fuiiconflow); // Third page marker

        var tablelistvbox = new qx.ui.layout.VBox(10);
        tablelistpage.setLayout(tablelistvbox); // Third page marker  
        ...
        var atmevent = new qx.ui.basic.Atom("Event", 'data:text/json;{ "name": "material-event", "width": 60, "height": 60 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmbusiness = new qx.ui.basic.Atom("Business", 'data:text/json;{ "name": "material-business", "width": 60, "height": 60 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmbiotech = new qx.ui.basic.Atom("Biotech", 'data:text/json;{ "name": "material-biotech", "width": 60, "height": 60 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        var atmbolt = new qx.ui.basic.Atom("Bolt", 'data:text/json;{ "name": "material-bolt", "width": 60, "height": 60 }').set({
          iconPosition: "top",
          appearance: "icss-atom"
        });
        ...
        tablelistpage.add(materialiconflow); // Menu Page for phonegap only
        ...
        menupage.add(btnLogout); // Assemble - THE STACK 
        ...
        westboxbuttongroup.add(tbtndashboardpage, tbtnSecondPage, tbtnThirdPage); // CLONE the above controls
        ...
        mainmenupopup.add(tbtnmenuThirdPage); // Assign all the clones their own RadioGroup

        var mainmenubuttongroup = new qx.ui.form.RadioGroup();
        mainmenubuttongroup.add(tbtnmenudashboardpage, tbtnmenuSecondPage, tbtnmenuThirdPage); //***  CODE for applying popup fading in and out  ***//
        ...
        mainmenubuttongrouphym.add(tbtndashboardpagehym, tbtnoverviewpagehym, tbtnlistofitemspagehym, tbtnmenuhym); // <<< END of Hybrid Mobil (hym) Main Menu and Main Menu Popup <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        }, this); // Demo mode switching back to desktop
      ...
      __P_2_0: function __P_2_0() {
        // Create the Window
        var win = new qx.ui.window.Window("Detail Window").set({
...
//# sourceMappingURL=Application.js.map?dt=1613269773088