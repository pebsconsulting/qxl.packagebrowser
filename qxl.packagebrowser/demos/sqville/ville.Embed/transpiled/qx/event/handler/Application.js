  ...
  qx.Class.define("qx.event.handler.Application", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_78_2 = false;
      this.__P_78_3 = false;
      this.__P_78_4 = false; // Initialize observers
    ...
    members: {
      ...
      */
      ...
      __P_78_5: function __P_78_5() {
        ...
        if (!this.__P_78_2 && this.__P_78_0 && qx.$$loader.scriptLoaded) {
          ...
          if (qx.core.Environment.get("engine.name") == "mshtml") {
            if (qx.event.Registration.hasListener(this._window, "ready")) {
              this.__P_78_2 = true; // Fire user event
       ...
       *
       */
      __P_78_6: function __P_78_6() {
        this.__P_78_3 = true; // Fire user event
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_78_7),
          "false": this.__P_78_7
        });
      ...
      _onNativeUnload: function _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_78_8),
          "false": this.__P_78_8
        });
        callback.apply(this, arguments);
      },
...
//# sourceMappingURL=Application.js.map?dt=1613269780215