  ...
  qx.Bootstrap.define("qx.type.BaseError", {
    ...
    */
    ...
    construct: function construct(comment, failMessage) {
      ...
      this.__P_179_0 = comment || ""; // opera 10 crashes if the message is an empty string!!!?!?!
    ...
    */
    members: {
      ...
      toString: function toString() {
        return this.__P_179_0 + (this.message ? ": " + this.message : "");
      }
    }
  });
...
//# sourceMappingURL=BaseError.js.map?dt=1613269785818