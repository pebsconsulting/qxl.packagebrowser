  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_53_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_53_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_53_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_53_3()) {
      ...
      __P_53_0: function __P_53_0() {
        ...
        if (qx.bom.client.Engine.__P_53_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613269777781