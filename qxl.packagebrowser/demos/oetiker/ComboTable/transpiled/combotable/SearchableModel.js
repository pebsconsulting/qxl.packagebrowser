  ...
  qx.Class.define("combotable.SearchableModel", {
    ...
    members: {
      ...
      setData: function setData(rowArr, clearSorting, filtered) {
        ...
        combotable.SearchableModel.prototype.setData.base.call(this, rowArr, clearSorting);
      },
      ...
      addRows: function addRows(rowArr, startIndex, clearSorting) {
        ...
        combotable.SearchableModel.prototype.addRows.base.call(this, rowArr, startIndex, clearSorting);
      ...
      setRows: function setRows(rowArr, startIndex, clearSorting) {
        this.setData(this.__P_3_0);
        combotable.SearchableModel.prototype.setRows.base.call(this, rowArr, startIndex, clearSorting);
      ...
      removeRows: function removeRows(startIndex, howMany, clearSorting) {
        this.setData(this.__P_3_0);
        combotable.SearchableModel.prototype.removeRows.base.call(this, startIndex, howMany, clearSorting);
...
//# sourceMappingURL=SearchableModel.js.map?dt=1613267541303