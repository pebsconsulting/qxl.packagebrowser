  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MLogging", {
    members: {
       ...
       */
      __P_91_1: function __P_91_1(level, varargs) {
        var argumentsArray = qx.lang.Array.fromArguments(varargs);
        argumentsArray.unshift(this);

        this.__P_91_0[level].apply(this.__P_91_0, argumentsArray);
      }
    }
  });
...
//# sourceMappingURL=MLogging.js.map?dt=1613267588303