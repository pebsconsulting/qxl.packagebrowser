(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "qx.ui.layout.VBox": {},
      "qx.ui.basic.Label": {},
      "uploadwidget.UploadForm": {},
      "qx.ui.layout.Basic": {},
      "uploadwidget.UploadButton": {},
      "uploadwidget.UploadField": {},
      "qx.ui.form.Button": {}
    }
  };
  ...
  ************************************************************************ */
  ...
  qx.Class.define("uploaddemo.Application", {
    ...
    */
    members: {
       ...
       */
      main: function main() {
        uploaddemo.Application.prototype.main.base.call(this); // Add log appenders
        ...
        var lbl1Text = "<h1>UploadForm and UploadFile Implementation</h1><p>The class UploadForm creates a hidden iframe which is used as a target for the form submit.</p><p>An event of type <b>\"sending\"</b> is fired after submit. On completion (iframe completed loading) a <b>\"completed\"</b> event is fired.</p><p>Upload form implements the methods getIframeTextContent, getIframeHtmlContent and getIframeXmlContent to get the content of the iframe</p><p>UploadField and UploadButton fire a <b>\"changeFileName\"</b> event after the selection through the OS fileselector is completed</p><p>Multiple UploadField and UploadButton instances are possible.</p>";
  ...
  uploaddemo.Application.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Application.js.map?dt=1613267579922