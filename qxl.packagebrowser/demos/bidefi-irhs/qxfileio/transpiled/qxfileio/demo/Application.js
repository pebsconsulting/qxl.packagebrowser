  ...
  qx.Class.define("qxfileio.demo.Application", {
    ...
    */
    members: {
      ...
      main: function main() {
        // Call super class
        qxfileio.demo.Application.prototype.main.base.call(this); // Enable logging in debug variant
        ...
        */
        ...
        var doc = this.getRoot(); // Create a field to put data
        ...
        var fileChooser = new qxfileio.FileChooser(); // Create a button to interact with the file chooser
        ...
        }, this); // Create a button to change the behavior of the file chooser (multi file)
        ...
        }, this); // Create a button to save text field content to a file

        var saveButton = new qx.ui.form.Button(this.tr("Save"));
        var fw = new qxfileio.FileWriter(); //fw.setType("application/octet-stream");
...
//# sourceMappingURL=Application.js.map?dt=1613267066134