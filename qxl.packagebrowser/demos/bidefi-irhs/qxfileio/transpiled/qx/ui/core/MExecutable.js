    ...
    */
    members: {
      ...
      _applyCommand: function _applyCommand(value, old) {
        // execute forwarding
        if (old != null) {
          old.removeListenerById(this.__P_25_2);
        }

        if (value != null) {
          this.__P_25_2 = value.addListener("execute", this.__P_25_3, this);
        } // binding stuff


        var ids = this.__P_25_0;
...
//# sourceMappingURL=MExecutable.js.map?dt=1613267068664