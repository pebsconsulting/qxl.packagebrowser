  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationCss", {
    statics: {
      ...
      __P_145_5: qx.core.Environment.get("css.animation"),
      ...
      _animate: function _animate(el, desc, duration, reverse) {
        this.__P_145_6(desc); // debug validation
        ...
        if (!this.__P_145_0) {
          this.__P_145_0 = qx.bom.Stylesheet.createElement();
        }
        ...
        if (this.__P_145_5 != null) {
          var name = this.__P_145_7(keyFrames, reverse);

          var style = name + " " + duration + "ms " + desc.timing + " " + (desc.delay ? desc.delay + "ms " : "") + desc.repeat + " " + (desc.alternate ? "alternate" : "");
          qx.bom.Event.addNativeListener(el, this.__P_145_5["start-event"], this.__P_145_8);
          qx.bom.Event.addNativeListener(el, this.__P_145_5["iteration-event"], this.__P_145_9);
          qx.bom.Event.addNativeListener(el, this.__P_145_5["end-event"], this.__P_145_10);
          el.style[qx.lang.String.camelCase(this.__P_145_5["name"])] = style; // use the fill mode property if available and suitable

          if (keep && keep == 100 && this.__P_145_5["fill-mode"]) {
            el.style[this.__P_145_5["fill-mode"]] = "forwards";
          }
        }
        ...
        if (this.__P_145_5 == null) {
          window.setTimeout(function () {
            qx.bom.element.AnimationCss.__P_145_10({
              target: el
            });
          }, 0);
        }
       ...
       */
      __P_145_8: function __P_145_8(e) {
       ...
       * @param e {Event} The native event from the browser.
       */
      __P_145_9: function __P_145_9(e) {
       ...
       * @param e {Event} The native event from the browser.
       */
      __P_145_10: function __P_145_10(e) {
        var el = e.target;
        ...
        if (qx.bom.element.AnimationCss.__P_145_5 != null) {
          // reset the styling
          var key = qx.lang.String.camelCase(qx.bom.element.AnimationCss.__P_145_5["name"]);
          el.style[key] = "";
          qx.bom.Event.removeNativeListener(el, qx.bom.element.AnimationCss.__P_145_5["name"], qx.bom.element.AnimationCss.__P_145_10);
        }
        ...
        qx.bom.element.AnimationCss.__P_145_11(el, desc.keyFrames[animation.keep]);
       ...
       */
      __P_145_11: function __P_145_11(el, endFrame) {
        // keep the element at this animation step
        var transforms;

        for (var style in endFrame) {
          if (style in qx.bom.element.AnimationCss.__P_145_4) {
            if (!transforms) {
              transforms = {};
            }
       ...
       */
      __P_145_6: function __P_145_6(desc) {
       ...
       */
      __P_145_7: function __P_145_7(frames, reverse) {
        ...
        if (this.__P_145_3[rule]) {
          return this.__P_145_3[rule];
        }

        var name = this.__P_145_1 + this.__P_145_2++;
        var selector = this.__P_145_5["keyframes"] + " " + name;
        qx.bom.Stylesheet.addRule(this.__P_145_0, selector, rule);
        this.__P_145_3[rule] = name;
        return name;
      },
      ...
      __P_145_13: function __P_145_13() {
        ...
        if (this.__P_145_0) {
          this.__P_145_0.ownerNode.remove();
...
//# sourceMappingURL=AnimationCss.js.map?dt=1613267076802