  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_20_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_20_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_20_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_20_3()) {
      ...
      __P_20_0: function __P_20_0() {
        ...
        if (qx.bom.client.Engine.__P_20_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613267068435