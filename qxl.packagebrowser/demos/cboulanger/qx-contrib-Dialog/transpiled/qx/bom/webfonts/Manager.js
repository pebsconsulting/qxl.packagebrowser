    ...
    members: {
      ...
      */
      ...
      remove: function remove(familyName, fontWeight, fontStyle) {
        ...
        if (fontLookupKey in this.__P_69_1) {
          this.__P_69_1[fontLookupKey].dispose();

          delete this.__P_69_1[fontLookupKey];
        }
      },
      ...
      */
      ...
      __P_69_7: function __P_69_7(familyName, sources, fontWeight, fontStyle, comparisonString, version, callback, context) {
        ...
        if (!this.__P_69_1[fontLookupKey]) {
          this.__P_69_1[fontLookupKey] = new qx.bom.webfonts.Validator(familyName, comparisonString, fontWeight, fontStyle);

          this.__P_69_1[fontLookupKey].setTimeout(qx.bom.webfonts.Manager.VALIDATION_TIMEOUT);

          this.__P_69_1[fontLookupKey].addListenerOnce("changeStatus", this.__P_69_13, this);
        }

        if (callback) {
          var cbContext = context || window;

          this.__P_69_1[fontLookupKey].addListenerOnce("changeStatus", callback, cbContext);
        }

        this.__P_69_1[fontLookupKey].validate();
      },
...
//# sourceMappingURL=Manager.js.map?dt=1613267180640