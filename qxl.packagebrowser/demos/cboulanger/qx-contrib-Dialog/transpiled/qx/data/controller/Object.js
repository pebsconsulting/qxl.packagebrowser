  ...
  qx.Class.define("qx.data.controller.Object", {
    ...
    */
    ...
    construct: function construct(model) {
      ...
      this.__P_92_0 = {}; // create an array to store all current targets
    ...
    members: {
      ...
      _applyModel: function _applyModel(value, old) {
        ...
        for (var i = 0; i < this.__P_92_1.length; i++) {
          // get the properties
          var targetObject = this.__P_92_1[i][0];
          var targetProperty = this.__P_92_1[i][1];
          var sourceProperty = this.__P_92_1[i][2];
          var bidirectional = this.__P_92_1[i][3];
          var options = this.__P_92_1[i][4];
          var reverseOptions = this.__P_92_1[i][5]; // remove it from the old if possible

          if (old != undefined && !old.isDisposed()) {
            this.__P_92_2(targetObject, targetProperty, sourceProperty, old);
          } // add it to the new if available


          if (value != undefined) {
            this.__P_92_3(targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions);
          } else {
      ...
      addTarget: function addTarget(targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions) {
        ...
        this.__P_92_1.push([targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions]); // delegate the adding
      ...
      *   {@link qx.data.SingleValueBinding} class.
      */
      __P_92_3: function __P_92_3(targetObject, targetProperty, sourceProperty, bidirectional, options, reverseOptions) {
        ...
        if (this.__P_92_0[targetHash] == undefined) {
          this.__P_92_0[targetHash] = [];
        }

        this.__P_92_0[targetHash].push([id, idReverse, targetProperty, sourceProperty, options, reverseOptions]);
      },
      ...
      removeTarget: function removeTarget(targetObject, targetProperty, sourceProperty) {
        this.__P_92_2(targetObject, targetProperty, sourceProperty, this.getModel()); // delete the target in the targets reference


        for (var i = 0; i < this.__P_92_1.length; i++) {
          if (this.__P_92_1[i][0] == targetObject && this.__P_92_1[i][1] == targetProperty && this.__P_92_1[i][2] == sourceProperty) {
            this.__P_92_1.splice(i, 1);
          }
        }
      },
       ...
       *   comes.
       */
      __P_92_2: function __P_92_2(targetObject, targetProperty, sourceProperty, sourceObject) {
        ...
        var currentListing = this.__P_92_0[targetObject.toHashCode()]; // if no binding is stored
...
//# sourceMappingURL=Object.js.map?dt=1613267181987