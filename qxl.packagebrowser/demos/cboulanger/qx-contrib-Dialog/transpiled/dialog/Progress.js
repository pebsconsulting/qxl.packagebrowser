  ...
  ************************************************************************ */
  ...
  qx.Class.define("dialog.Progress", {
    ...
    members: {
       ...
       */
      _applyProgress: function _applyProgress(value, old) {
        if (value == 100) {
       ...
       */
      _applyNewLogText: function _applyNewLogText(value, old) {
        if (value) {
       ...
       */
      _applyOkButtonText: function _applyOkButtonText(value, old) {
        if (value === null) {
  ...
  dialog.Progress.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Progress.js.map?dt=1613267204909