    ...
    */
    members: {
      ...
      createAlert: function createAlert(caption, button) {
        var dlg = dialog.Dialog.alert("Hello World!").set({
          caption: caption
        }); //    old style:
      ...
      createWarning: function createWarning(caption, button) {
        var dlg = dialog.Dialog.warning("I warned you!").set({
          caption: caption
        });
      ...
      createError: function createError(caption, button) {
        var dlg = dialog.Dialog.error("Error, error, error, errr....!").set({
          caption: caption
        });
      ...
      createConfirm: function createConfirm(caption, button) {
        ...
        var dlg = dialog.Dialog.confirm("Do you really want to erase your hard drive?").set({
          caption: caption
        });
        ...
        dlg.promise().then(function (result) {
          var dlg2 = dialog.Dialog.alert("Your answer was: " + result).set({
            caption: caption + " 2"
          });
      ...
      createPrompt: function createPrompt(caption, button) {
        ...
        var dlg = dialog.Dialog.prompt("Please enter the root password for your server").set({
          caption: caption
        });
      ...
      createDialogChain: function createDialogChain(caption, button) {
        ...
        var dlg1 = dialog.Dialog.alert("This demostrates a series of 'nested' dialogs ").set({
          caption: caption
        });
        ...
        dlg1.promise().then(function () {
          var dlg2 = dialog.Dialog.confirm("Do you believe in the Loch Ness monster?").set({
            caption: caption + " 2"
          });
          ...
          var dlg3 = dialog.Dialog.confirm("You really " + (result ? "" : "don't ") + "believe in the Loch Ness monster?").set({
            caption: caption + " 3"
          });
          ...
          var dlg4 = dialog.Dialog.alert(result ? "I tell you a secret: It doesn't exist." : "Good to know.").set({
            caption: caption + " 4"
          });
      ...
      createSelect: function createSelect(caption, button) {
        ...
        dlg1.promise().then(function (result) {
          var dlg2 = dialog.Dialog.alert("You selected: '" + result + "'").set({
            caption: caption + " 2"
          });
      ...
      createForm: function createForm(caption, button) {
        ...
        var form = dialog.Dialog.form("Please fill in the form", formData).set({
          caption: caption
        });
        ...
        form.promise().then(function (result) {
          ...
          return dialog.Dialog.alert("Thank you for your input. See log for result.").set({
            caption: caption + " 2"
          }).promise();
        }); //    same as:
        //    (new dialog.Form({
      ...
      finalCallback: function finalCallback(err, data) {
        if (err) {
          var loginError = dialog.Dialog.alert(err).set({
            caption: "Login Error"
          });

          this._replaceOwnedObject(this.__P_2_0, loginError, "error");
        } else {
          var loginSuccess = dialog.Dialog.alert("User '" + data + "' is now logged in.").set({
...
//# sourceMappingURL=Application.js.map?dt=1613267174756