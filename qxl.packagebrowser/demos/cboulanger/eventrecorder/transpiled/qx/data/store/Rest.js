  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.store.Rest", {
    ...
    members: {
       ...
       */
      __P_136_3: function __P_136_3() {
        var resource = this.getResource(),
            actionName = this.getActionName();

        if (resource && actionName) {
          resource.addListener(this.getActionName() + "Success", this.__P_136_1);
        }
      },
       ...
       */
      __P_136_2: function __P_136_2(e) {
        var data = e.getData(),
...
//# sourceMappingURL=Rest.js.map?dt=1613267109174