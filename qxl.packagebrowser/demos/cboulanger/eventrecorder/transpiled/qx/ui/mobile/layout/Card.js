  ...
  qx.Class.define("qx.ui.mobile.layout.Card", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_347_0 = new qx.ui.mobile.layout.CardAnimation();
    },
    ...
    */
    ...
    members: {
      ...
      _showWidget: function _showWidget(widget, properties) {
        ...
        this.__P_347_1 = widget;

        if (this.__P_347_2 && this.getShowAnimation() && qx.core.Environment.get("css.transform.3d")) {
      ...
      _swapWidget: function _swapWidget() {
        if (this.__P_347_2) {
          this.__P_347_2.removeCssClass("active");

          this.__P_347_2.exclude();
        }

        this.__P_347_2 = this.__P_347_1;

        this.__P_347_2.addCssClass("active");
      },
       ...
       * @param widget {qx.ui.mobile.core.Widget} The target widget
       */
      __P_347_7: function __P_347_7(widget) {
        ...
        this.__P_347_3 = true;
        this.fireDataEvent("animationStart", [this.__P_347_2, widget]);

        var fromElement = this.__P_347_2.getContainerElement();
        ...
        var fromCssClasses = this.__P_347_8("out");

        var toCssClasses = this.__P_347_8("in");

        this._widget.addCssClass("animationParent");

        var toElementAnimation = this.__P_347_0.getAnimation(this.__P_347_4, "in", this.__P_347_5);

        var fromElementAnimation = this.__P_347_0.getAnimation(this.__P_347_4, "out", this.__P_347_5);
      ...
      _onAnimationEnd: function _onAnimationEnd(evt) {
        ...
        this.fireDataEvent("animationEnd", [this.__P_347_2, this.__P_347_1]);
      },
      ...
      __P_347_6: function __P_347_6() {
        if (this.__P_347_3) {
          ...
          var toElement = this.__P_347_1.getContainerElement();
          ...
          qx.bom.element.Class.removeClasses(fromElement, this.__P_347_8("out"));
          qx.bom.element.Class.removeClasses(toElement, this.__P_347_8("in"));
       ...
       */
      __P_347_8: function __P_347_8(direction) {
        var classes = ["animationChild", this.__P_347_4, direction];
...
//# sourceMappingURL=Card.js.map?dt=1613267125270