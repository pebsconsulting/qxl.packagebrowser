  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.RepeatButton", {
    ...
    construct: function construct(label, icon) {
      ...
      this.__P_294_0 = new qx.event.AcceleratingTimer();

      this.__P_294_0.addListener("interval", this._onInterval, this);
    },
    events: {
      /**
    ...
    members: {
      ...
      */
      ...
      _onPointerUp: function _onPointerUp(e) {
        ...
        if (!this.hasState("abandoned")) {
          ...
          if (this.hasState("pressed") && !this.__P_294_1) {
            this.execute();
          }
        }
      ...
      */
       ...
       *
       */
      __P_294_2: function __P_294_2() {
        this.fireEvent("press");
        this.__P_294_1 = false;
...
//# sourceMappingURL=RepeatButton.js.map?dt=1613267121591