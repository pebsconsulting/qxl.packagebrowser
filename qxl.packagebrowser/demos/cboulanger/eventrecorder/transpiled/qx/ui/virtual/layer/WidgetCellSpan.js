  ...
  qx.Class.define("qx.ui.virtual.layer.WidgetCellSpan", {
    ...
    * @param widgetCellProvider {qx.ui.virtual.core.IWidgetCellProvider} This
    ...
    construct: function construct(widgetCellProvider, rowConfig, columnConfig) {
      ...
      this.__P_427_0 = [];
      this._cellLayer = new qx.ui.virtual.layer.WidgetCell(this.__P_427_1());
    ...
    */
    members: {
       ...
       */
      __P_427_2: function __P_427_2(firstRow, firstColumn, rowCount, columnCount) {
      ...
      _fullUpdate: function _fullUpdate(firstRow, firstColumn, rowSizes, columnSizes) {
        this.__P_427_2(firstRow, firstColumn, rowSizes.length, columnSizes.length);
    ...
    destruct: function destruct() {
      ...
      this._cellProvider = this.__P_427_0 = this._cells = this._bounds = this._spanMap = null;
    }
  });
  qx.ui.virtual.layer.WidgetCellSpan.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=WidgetCellSpan.js.map?dt=1613267130326