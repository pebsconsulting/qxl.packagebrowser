  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_76_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_76_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_76_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_76_3()) {
      ...
      __P_76_0: function __P_76_0() {
        ...
        if (qx.bom.client.Engine.__P_76_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613267105464