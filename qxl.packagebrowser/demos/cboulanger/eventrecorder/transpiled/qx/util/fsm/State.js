  ...
  qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      for (var field in stateInfo) {
        ...
        switch (field) {
          case "onentry":
            this.setOnentry(this.__P_459_0(stateInfo[field], context));
            break;

          case "onexit":
            this.setOnexit(this.__P_459_0(stateInfo[field], context));
            break;
    ...
    members: {
       ...
       */
      __P_459_1: function __P_459_1(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_459_2: function __P_459_2(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_459_3: function __P_459_3(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_459_8: function __P_459_8(value) {
       ...
       * @return {var} the final value
       */
      __P_459_4: function __P_459_4(value) {
       ...
       * @return {var} the final value
       */
      __P_459_5: function __P_459_5(value) {
       ...
       * @return {var} the final value
       */
      __P_459_6: function __P_459_6(value) {
       ...
       * @return {var} the final value
       */
      __P_459_7: function __P_459_7(value) {
       ...
       *   unaltered.
       */
      __P_459_0: function __P_459_0(f, context) {
...
//# sourceMappingURL=State.js.map?dt=1613267132268