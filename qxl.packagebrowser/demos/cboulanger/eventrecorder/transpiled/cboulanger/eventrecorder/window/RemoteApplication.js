  ...
  ************************************************************************ */
  ...
  qx.Class.define("cboulanger.eventrecorder.window.RemoteApplication", {
    ...
    construct: function construct(uri, config) {
      ...
      this.__P_464_0 = qx.bom.Window.open(url, window_name, config);
    ...
    members: {
      ...
      open: function open() {
        this.__P_464_0.focus();
      },
      close: function close() {
        this.__P_464_0.close();
      },
      isClosed: function isClosed() {
        return qx.bom.Window.isClosed(this.__P_464_0);
      }
    },
    destruct: function destruct() {
      cboulanger.eventrecorder.window.RemoteApplication.prototype.$$destructor.base.call(this);

      if (!qx.bom.Window.isClosed(this.__P_464_0)) {
        this.__P_464_0.close();
      }
...
//# sourceMappingURL=RemoteApplication.js.map?dt=1613267132527