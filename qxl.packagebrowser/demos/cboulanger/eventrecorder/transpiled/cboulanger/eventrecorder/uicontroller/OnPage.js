(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("cboulanger.eventrecorder.uicontroller.OnPage", {
    ...
    include: [cboulanger.eventrecorder.MHelperMethods, cboulanger.eventrecorder.editor.MEditor, cboulanger.eventrecorder.uicontroller.MUiController],
    properties: {
      engine: {
     ...
     * @ignore(caption)
     */
    construct: function construct(caption = "Event Recorder", engine) {
    ...
    members: {
      ...
      _createChildControlImpl(id) {
          ...
          case "load":
            {
              ...
              control.addListener("execute", engine.load, engine); // enable load button only if player can replay scripts in the browser
        ...
        if (control) {
          ...
          control = cboulanger.eventrecorder.uicontroller.OnPage.prototype._createChildControlImpl.base.call(this, id);
        }
  ...
  cboulanger.eventrecorder.uicontroller.OnPage.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=OnPage.js.map?dt=1613267132924