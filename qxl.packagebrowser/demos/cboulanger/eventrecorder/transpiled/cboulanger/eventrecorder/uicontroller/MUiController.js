(function () {
  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("cboulanger.eventrecorder.uicontroller.MUiController", {
    ...
    members: {
      ...
      _setupAliases() {
        ...
        for (let [alias, base] of Object.entries(cboulanger.eventrecorder.uicontroller.MUiController.aliases)) {
          if (!aliases[alias]) {
      ...
      _setupUi() {
        const engine = this.getEngine(); // caption
      ...
      _manageStopButtonState() {
        ...
        const stopButtonState = () => {
          stopButton.setEnabled(recorder.isRunning() || Boolean(engine.getPlayer()) && engine.getPlayer().isRunning());
        };
  ...
  cboulanger.eventrecorder.uicontroller.MUiController.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MUiController.js.map?dt=1613267133296