  ...
  qx.Class.define("qxl.formdemo.FormItems", {
    ...
    members: {
      ...
      _createView: function _createView() {
        ...
        this.__P_493_0.push(textField);

        form.add(textField, "TextField"); // password field
        ...
        this.__P_493_0.push(passwordField);

        form.add(passwordField, "PasswordField"); // text area

        var textArea = new qx.ui.form.TextArea();
        textArea.setPlaceholder("placeholder text...");
        textArea.setTabIndex(tabIndex++);

        this.__P_493_0.push(textArea);

        form.add(textArea, "TextArea"); // combo box

        var comboBox = new qx.ui.form.ComboBox();
        comboBox.setPlaceholder("Pick an item");
        comboBox.setTabIndex(tabIndex++);

        this.__P_493_1(comboBox);

        this.__P_493_0.push(comboBox);

        form.add(comboBox, "ComboBox"); // virtual combo box
        ...
        this.__P_493_2(virtualComboBox);

        this.__P_493_0.push(virtualComboBox);

        form.add(virtualComboBox, "VirtualComboBox"); // date field

        var dateField = new qx.ui.form.DateField();
        dateField.setPlaceholder("Pick a date");
        dateField.setTabIndex(tabIndex++);

        this.__P_493_0.push(dateField);
        ...
        this.__P_493_1(selectBox);

        this.__P_493_0.push(selectBox); // virtual select box
        ...
        this.__P_493_2(virtualSelectBox);

        this.__P_493_0.push(virtualSelectBox); // list
        ...
        this.__P_493_0.push(list); // radio button group
        ...
        this.__P_493_0.push(radioButtonGroup);
        ...
        this.__P_493_0.push(button); // toggle button
        ...
        this.__P_493_0.push(toggleButton); // toggle button
        ...
        this.__P_493_0.push(repeatButton); // menu button


        var menuButton = new qx.ui.form.MenuButton("MenuButton", null, this.__P_493_3()).set({
          tabIndex: tabIndex++
        });
        ...
        this.__P_493_0.push(menuButton); // split button


        var splitButton = new qx.ui.form.SplitButton("SplitButton", null, this.__P_493_4()).set({
          tabIndex: tabIndex++
        });
        ...
        this.__P_493_0.push(splitButton); // Listener
        ...
        this.__P_493_0.push(checkBox); // tri-state check box
        ...
        this.__P_493_0.push(triCheckBox); // radio button
        ...
        this.__P_493_0.push(radioButton);
        ...
        this.__P_493_0.push(spinner); // slider
      ...
      __P_493_1: function __P_493_1(widget) {
        for (var i = 0; i < 10; i++) {
          var tempItem = new qx.ui.form.ListItem("Item " + i);
          widget.add(tempItem);
        }
      },
      __P_493_2: function __P_493_2(widget) {
      ...
      __P_493_3: function __P_493_3() {
        ...
        groupOptions.add.apply(groupOptions, optionMenu.getChildren()); // create main menu and buttons
...
//# sourceMappingURL=FormItems.js.map?dt=1613267134084