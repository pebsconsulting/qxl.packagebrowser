  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.Controller", {
    ...
    construct: function construct(widgetRegistry) {
      ...
      btn_inherited.addListener("changeValue", this.__P_475_3, this);
      btn_included.addListener("changeValue", this.__P_475_3, this);
      this._history = qx.bom.History.getInstance();

      this.__P_475_4();

      qx.core.Init.getApplication().getRoot().addListener("pointerdown", function (e) {
        this.__P_475_5 = e.isShiftPressed() || e.isCtrlOrCommandPressed();
      }, this, true);
    },
    members: {
      __P_475_5: false,
      ...
      load: function load(apidata) {
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            if (state) {
              this.__P_475_6(this.__P_475_7(state));
            } else {
              this.__P_475_6("");
            }
          });
       ...
       * bind history events
       */
      __P_475_4: function __P_475_4() {
        this._history.addListener("changeState", function (evt) {
          var item = this.__P_475_7(evt.getData());
      ...
      _updateHistory: function _updateHistory(className) {
        ...
        qx.bom.History.getInstance().addToHistory(this.__P_475_8(className), newTitle);
      },
      ...
      _selectClass: function _selectClass(classNode, callback, self) {
        ...
        return classNode.loadDependedClasses().then(() => {
          if (classNode instanceof qxl.apiviewer.dao.Class) {
            return this._tabViewController.openClass(classNode, this.__P_475_5);
          } else {
            return this._tabViewController.openPackage(classNode, this.__P_475_5);
          }
       ...
       */
      __P_475_6: function __P_475_6(fullItemName) {
      ...
      __P_475_8: function __P_475_8(state) {
        return state.replace(/(.*)#(.*)/g, "$1~$2");
      },
      __P_475_7: function __P_475_7(encodedState) {
...
//# sourceMappingURL=Controller.js.map?dt=1613267133085