  ...
  qx.Class.define("qxl.widgetbrowser.pages.Table", {
    ...
    members: {
      ...
      __P_486_1: function __P_486_1() {
        var rowData = this.__P_486_2(500);
      ...
      __P_486_2: function __P_486_2(rowCount) {
        var rowData = [];
        ...
        for (var row = 0; row < rowCount; row++) {
          ...
          rowData.push([this.__P_486_0++, Math.random() * 10000, date, Math.random() > 0.5]);
        }
...
//# sourceMappingURL=Table.js.map?dt=1613267133641