(function () {
  ...
  ************************************************************************ */
   ...
   */
  qx.Class.define("qxl.widgetbrowser.pages.Window", {
    ...
    construct: function construct() {
      ...
      this.__P_487_0 = new qx.ui.window.Desktop().set({
        decorator: decorator
      });
      this.add(this.__P_487_0, {
        edge: 0,
        top: 0
      });
      this.initWidgets();
    ...
    members: {
      ...
      __P_487_4: function __P_487_4() {
        ...
        this.__P_487_0.add(wm1);

        var wm2 = this.__P_487_5();
...
//# sourceMappingURL=Window.js.map?dt=1613267133731