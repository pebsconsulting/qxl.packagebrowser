  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.List", {
    ...
    construct: function construct() {
      ...
      this.__P_485_0 = new qx.ui.container.Composite(new qx.ui.layout.Grid(10));
      this.__P_485_1 = qx.util.ResourceManager.getInstance().toUri("qxl/widgetbrowser/people.json");
      this.add(this.__P_485_0);
      this.initWidgets();
    },
    members: {
      __P_485_0: null,
      ...
      initWidgets: function initWidgets() {
        ...
        var virtualList = this.__P_485_3();

        this.__P_485_0.add(virtualList, {
          row: 1,
          column: 1
        });
        ...
        var groupedVirtualList = this.__P_485_4();

        this.__P_485_0.add(groupedVirtualList, {
          row: 1,
          column: 2
        });
      ...
      __P_485_2: function __P_485_2() {
        var list = new qx.ui.form.List();
        list.setWidth(150);
        var req = new qx.io.request.Xhr(this.__P_485_1);
        req.setParser("json");
      ...
      __P_485_4: function __P_485_4() {
        var list = this.__P_485_3(); // Creates the delegate for sorting and grouping
      ...
      __P_485_5: function __P_485_5(widget) {
        var store = new qx.data.store.Json(this.__P_485_1);
...
//# sourceMappingURL=List.js.map?dt=1613267133626