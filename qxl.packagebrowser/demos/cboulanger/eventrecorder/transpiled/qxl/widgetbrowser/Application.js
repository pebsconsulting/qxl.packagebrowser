  ...
  qx.Class.define("qxl.widgetbrowser.Application", {
    ...
    members: {
      ...
      main: function main() {
        ...
        this.__P_36_0 = new qxl.widgetbrowser.view.Header();
        dockLayoutComposite.add(this.__P_36_0, {
          edge: "north"
        });
        var scroll = this.__P_36_2 = new qx.ui.container.Scroll();
        dockLayoutComposite.add(scroll);
        this.__P_36_1 = this._createTabView();
        ...
        scroll.add(this.__P_36_1);
      },
      _createTabView: function _createTabView() {
        this.__P_36_1 = new qxl.widgetbrowser.view.TabView();
...
//# sourceMappingURL=Application.js.map?dt=1613267101397