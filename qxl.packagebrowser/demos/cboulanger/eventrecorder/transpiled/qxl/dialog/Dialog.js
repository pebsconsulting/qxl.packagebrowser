  ...
  qx.Class.define("qxl.dialog.Dialog", {
    ...
    statics: {
      ...
      useBlocker: function useBlocker(value) {
        qxl.dialog.Dialog.__P_470_0 = value;
      },
    ...
    construct: function construct(properties) {
      ...
      this.__P_470_1 = new qx.ui.core.Blocker(root);

      this.__P_470_1.setOpacity(this.getBlockerOpacity());

      this.__P_470_1.setColor(this.getBlockerColor()); // handle focus
    ...
    members: {
       ...
       */
      _createOkButton: function _createOkButton(noFocus = false) {
      ...
      _createCancelButton: function _createCancelButton() {
        let cancelButton = this._cancelButton = new qx.ui.form.Button(this.tr("Cancel"));
       ...
       */
      show: function show() {
        if (this.isUseBlocker() || qxl.dialog.Dialog.__P_470_0) {
          ...
          this.__P_470_1.blockContent(maxWindowZIndex);
        }

        this.setVisibility("visible");
        this.__P_470_2 = qx.ui.core.FocusHandler.getInstance().getActiveWidget();
      ...
      hide: function hide() {
        if (this.isUseBlocker() || qxl.dialog.Dialog.__P_470_0) {
          this.__P_470_1.unblock();
        }

        if (this.__P_470_2) {
          try {
            //this.__previousFocus.setFocusable(true);
            this.__P_470_2.focus();
          } catch (e) {}
        }
...
//# sourceMappingURL=Dialog.js.map?dt=1613267132751