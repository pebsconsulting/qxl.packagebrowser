  ...
  qx.Mixin.define("cboulanger.eventrecorder.MHelperMethods", {
    members: {
      ...
      getPlayerByType(type) {
        ...
        if (this.__P_467_0[type]) {
          return this.__P_467_0[type];
        }
    ...
    members: {
      ...
      assignObjectIdsToChildren: function assignObjectIdsToChildren(parent, level = 0) {
        ...
        for (let child of children) {
          ...
          this.generateQxObjectId(child, parent); // recurse into children
  ...
  qx.Class.define("qookery.Qookery", {
    ...
    statics: {
      ...
      getOption: function getOption(optionName, defaultValue) {
        ...
        var value = qookery.Qookery.__P_3_0[optionName];
      ...
      setOption: function setOption(optionName, value) {
        qx.core.Assert.assertString(optionName);
        qookery.Qookery.__P_3_0[optionName] = value;
      },
  ...
  */
  qx.Class.define("qookery.internal.layouts.GridLayoutFactory", {
    ...
    statics: {
      ...
      __P_29_0: function __P_29_0(layout, attributes) {
        var configureFunction = function configureFunction(widget) {
          qookery.internal.layouts.GridLayoutFactory.__P_29_1.call(configureFunction, widget);
        };
      ...
      __P_29_1: function __P_29_1(widget) {
    ...
    members: {
      createLayout: function createLayout(attributes) {
        ...
        qookery.internal.layouts.GridLayoutFactory.__P_29_0(layout, attributes);
  ...
  qx.Class.define("qookery.internal.components.Component", {
    ...
    members: {
      ...
      getAttribute: function getAttribute(attributeName, defaultValue) {
        var value = this.__P_13_2[attributeName];
      ...
      setAttribute: function setAttribute(attributeName, value) {
        if (value === undefined) delete this.__P_13_2[attributeName];else this.__P_13_2[attributeName] = value;
      },
      // Namespaces
      resolveNamespacePrefix: function resolveNamespacePrefix(prefix) {
      ...
      resolveQName: function resolveQName(qName) {
        var resolver = this.__P_13_4;
        if (resolver == null) resolver = this.__P_13_4 = this.resolveNamespacePrefix.bind(this);
      ...
      // Access to other components
      getForm: function getForm() {
        if (!this.__P_13_1) return null;
        return this.__P_13_1.getForm();
      },
      getParent: function getParent() {
        return this.__P_13_1;
      },
      setAction: function setAction(actionName, scriptFunction) {
        this.__P_13_3[actionName] = scriptFunction;
      },
      listWidgets: function listWidgets(filterName) {
      ...
      executeAction: function executeAction(actionName, varargs) {
        var actionFunction = this.__P_13_3[actionName];
      ...
      isActionSupported: function isActionSupported(actionName) {
        return this.__P_13_3[actionName] !== undefined;
      },
      validate: function validate() {
      ...
      addToDisposeList: function addToDisposeList(disposable) {
        if (!this.__P_13_5) this.__P_13_5 = [];

        this.__P_13_5.push(disposable);
      },
      ...
      _applyWidgetAttributes: function _applyWidgetAttributes(widget) {
        ...
        var layoutPropertyMap = qookery.internal.components.Component.__P_13_0;
  ...
  qx.Class.define("qookery.internal.components.ContainerComponent", {
    ...
    members: {
      ...
      create: function create(attributes) {
        ...
        var layout = this.__P_14_1 = layoutFactory.createLayout(this);
      ...
      contains: function contains(component) {
        return qx.lang.Array.contains(this.__P_14_0, component);
      },
      validate: function validate() {
      ...
      _addChildComponent: function _addChildComponent(component) {
        this.__P_14_0.push(component);
      },
      _removeChildComponent: function _removeChildComponent(component) {
        qx.lang.Array.remove(this.__P_14_0, component);
      }
    },
    destruct: function destruct() {
      this._disposeArray("__P_14_0");

      this._disposeObjects("__P_14_1");
    }
  });
  ...
  */
  qx.Class.define("qookery.internal.components.ListComponent", {
    ...
    members: {
        ...
        switch (this.getMainWidget().getSelectionMode()) {
          ...
          case "additive":
            for (var i = 0; i < value.length; i++) {
              var item = this.__P_18_0(value[i]);
      ...
      __P_18_0: function __P_18_0(model) {
  ...
  qx.Class.define("qookery.internal.components.RadioButtonGroupComponent", {
    ...
    members: {
      ...
      add: function add(childComponent) {
        ...
        this.__P_19_0.push(childComponent);
      },
      listChildren: function listChildren() {
      ...
      __P_19_2: function __P_19_2(model, label) {
  ...
  qx.Class.define("qookery.internal.components.ScrollComponent", {
    ...
    members: {
      ...
      _createContainerWidget: function _createContainerWidget() {
        ...
        this.__P_20_0 = new qx.ui.container.Composite();
        scroll.add(this.__P_20_0);
  ...
  qx.Class.define("qookery.internal.components.SelectBoxComponent", {
    ...
    members: {
      _createMainWidget: function _createMainWidget() {
        ...
        selectBox.setFormat(this.__P_21_0.bind(this));
      ...
      __P_21_0: function __P_21_0(listItem) {
  ...
  */
  qx.Class.define("qookery.internal.components.VirtualTreeComponent", {
    ...
    members: {
      ...
      setup: function setup() {
        if (this.__P_24_0 !== null) this.getMainWidget().setDelegate(this.__P_24_0);
      ...
      parseXmlElement: function parseXmlElement(elementName, xmlElement) {
        switch (elementName) {
          case "{http://www.qookery.org/ns/Form}virtual-tree-delegate":
            ...
            this.__P_24_0 = new delegateClass();
            return true;
        }
    ...
    statics: {
      ...
      parseValue: function parseValue(component, type, text) {
        switch (type) {
          ...
          case "Size":
            var v = qookery.util.Xml.__P_33_0[text];
  ...
  qx.Class.define("cboulanger.eventrecorder.player.Qooxdoo", {
    ...
    members: {
      ...
      */
       ...
       */
      cmd_execute(id) {
        return "qx.core.Id.getQxObject(\"".concat(id, "\").fireEvent(\"execute\");");
      },
...
(function () {
  ...
  qx.Class.define("cboulanger.eventrecorder.InfoPane", {
    ...
    construct: function construct() {
      ...
      this.__P_466_0 = new qx.ui.basic.Atom();

      this.__P_466_0.getChildControl("label").set({
        rich: true,
        wrap: true
      });

      this.add(this.__P_466_0);
    ...
    members: {
       ...
       */
      getDisplayedText() {
        return this.__P_466_0.getLabel();
      },
      ...
      useIcon(alias) {
        ...
        this.__P_466_0.setIcon(iconpath);
     ...
     */
    destruct: function destruct() {
      this._disposeObjects("__P_466_0");
    }
  });
...
//# sourceMappingURL=package-1.js.map?dt=1613267151361
qx.$$packageData['1'] = {
  "locales": {},
  "resources": {},
  "translations": {
