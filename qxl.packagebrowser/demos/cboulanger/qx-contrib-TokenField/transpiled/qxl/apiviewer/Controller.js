  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.Controller", {
    ...
    construct: function construct(widgetRegistry) {
      ...
      btn_inherited.addListener("changeValue", this.__P_427_3, this);
      btn_included.addListener("changeValue", this.__P_427_3, this);
      this._history = qx.bom.History.getInstance();

      this.__P_427_4();

      qx.core.Init.getApplication().getRoot().addListener("pointerdown", function (e) {
        this.__P_427_5 = e.isShiftPressed() || e.isCtrlOrCommandPressed();
      }, this, true);
    },
    members: {
      __P_427_5: false,
      ...
      load: function load(apidata) {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            if (state) {
              _this.__P_427_6(_this.__P_427_7(state));
            } else {
              _this.__P_427_6("");
            }
          });
      ...
      __P_427_4: function __P_427_4() {
        this._history.addListener("changeState", function (evt) {
          var item = this.__P_427_7(evt.getData());
      ...
      _updateHistory: function _updateHistory(className) {
        ...
        qx.bom.History.getInstance().addToHistory(this.__P_427_8(className), newTitle);
      },
      ...
      _selectClass: function _selectClass(classNode, callback, self) {
        ...
        return classNode.loadDependedClasses().then(function () {
          if (classNode instanceof qxl.apiviewer.dao.Class) {
            return _this2._tabViewController.openClass(classNode, _this2.__P_427_5);
          } else {
            return _this2._tabViewController.openPackage(classNode, _this2.__P_427_5);
          }
        }).then(function () {
       ...
       */
      __P_427_6: function __P_427_6(fullItemName) {
        var _this3 = this;
      ...
      __P_427_8: function __P_427_8(state) {
        return state.replace(/(.*)#(.*)/g, "$1~$2");
      },
      __P_427_7: function __P_427_7(encodedState) {
...
//# sourceMappingURL=Controller.js.map?dt=1613267294125