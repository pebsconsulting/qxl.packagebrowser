  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.PackageTree", {
    ...
    construct: function construct() {
      ...
      this.setPadding(0);
      this.__P_428_0 = new qx.ui.tree.TreeFolder("Packages");

      this.__P_428_0.setOpen(true);

      this.setRoot(this.__P_428_0);
      this.setSelection([this.__P_428_0]); // TODO: Is this workaround still needed?
    ...
    */
    members: {
      ...
      setTreeData: function setTreeData(docTree) {
        ...
        this.__P_428_1(this.__P_428_0, docTree, 0);
      ...
      selectTreeNodeByClassName: function selectTreeNodeByClassName(className) {
        ...
        if (!className) {
          ...
          this.setSelection([this.__P_428_0]);
          this.scrollChildIntoView(this.__P_428_0);
          return qx.Promise.resolve(true);
        }
       ...
       */
      __P_428_2: function __P_428_2(packageTreeNode, packageDoc, depth) {
        var self = this;
        return function () {
          if (!packageTreeNode.loaded) {
            self.__P_428_1(packageTreeNode, packageDoc, depth + 1);
       ...
       *          {var} current depth in the tree
       */
      __P_428_1: function __P_428_1(treeNode, docNode, depth) {
        var _this2 = this;
        ...
        qx.Promise.map(packagesDoc, function (packageDoc) {
          packageDoc.load().then(function () {
            ...
            packageTreeNode.addListener("changeOpen", _this2.__P_428_2(packageTreeNode, packageDoc, depth + 1), _this2); // Register the tree node
...
//# sourceMappingURL=PackageTree.js.map?dt=1613267294198