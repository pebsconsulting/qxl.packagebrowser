  ...
  qx.Class.define("qxl.apiviewer.dao.Package", {
    ...
    statics: {
      ...
      getPackage: function getPackage(name, create) {
        var root = qxl.apiviewer.dao.Package.__P_433_0;

        if (!root) {
          root = qxl.apiviewer.dao.Package.__P_433_0 = new qxl.apiviewer.dao.Package("");
        }
...
//# sourceMappingURL=Package.js.map?dt=1613267294474