  ...
  qx.Class.define("qxl.mobiletweets.page.TweetDetail", {
    ...
    members: {
      ...
      _initialize: function _initialize() {
        qxl.mobiletweets.page.TweetDetail.prototype._initialize.base.call(this); // Create a new label instance


        var label = new qx.ui.mobile.basic.Label();
        this.getContent().add(label); // bind the "tweet.getText" property to the "value" of the label
...
//# sourceMappingURL=TweetDetail.js.map?dt=1613269577991