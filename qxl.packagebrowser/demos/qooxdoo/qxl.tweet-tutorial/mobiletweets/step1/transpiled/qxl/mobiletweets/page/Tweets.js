  ...
  qx.Class.define("qxl.mobiletweets.page.Tweets", {
    ...
    members: {
      ...
      _initialize: function _initialize() {
        qxl.mobiletweets.page.Tweets.prototype._initialize.base.call(this); // Create a new list instance


        var list = this.__P_587_0 = new qx.ui.mobile.list.List();
        var dateFormat = new qx.util.format.DateFormat(); // Use a delegate to configure each single list item
        ...
        list.setDelegate({
          configureItem: function configureItem(item, value, row) {
            ...
            item.setImage(value.getUser().getProfile_image_url()); // we have more data to display, show an arrow

            item.setShowArrow(true);
          }
        });
        list.addListener("changeSelection", this.__P_587_1, this); // bind the "tweets" property to the "model" property of the list instance

        this.bind("tweets", list, "model"); // add the list to the content of the page
       ...
       */
      __P_587_1: function __P_587_1(evt) {
...
//# sourceMappingURL=Tweets.js.map?dt=1613269577977