  ...
  qx.Class.define("qx.test.Theme", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_195_0 = qx.theme.manager.Decoration.getInstance().getTheme();
      },
      tearDown: function tearDown() {
        qx.test.Theme.themes = null;
        qx.theme.manager.Decoration.getInstance().setTheme(this.__P_195_0);
        this.__P_195_0 = null;
      },
...
//# sourceMappingURL=Theme.js.map?dt=1613269550993