  ...
  qx.Class.define("qx.test.data.store.Jsonp", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_233_0 = new qx.data.store.Jsonp();
      ...
      testWholePrimitive: function testWholePrimitive() {
        this.__P_233_0.addListener("loaded", function () {
          this.resume(function () {
            var model = this.__P_233_0.getModel();
      ...
      testErrorEvent: function testErrorEvent() {
        ...
        if (!(qx.core.Environment.get("browser.name") == "ie") && !(qx.core.Environment.get("browser.name") == "opera")) {
          this.__P_233_0.addListener("error", function () {
            this.resume(function () {}, this);
          }, this);

          this.__P_233_0.setUrl("affe");
...
//# sourceMappingURL=Jsonp.js.map?dt=1613269554297