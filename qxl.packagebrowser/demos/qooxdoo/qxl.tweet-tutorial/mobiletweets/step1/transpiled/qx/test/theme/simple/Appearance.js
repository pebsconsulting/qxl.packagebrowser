...
(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.theme.simple.Appearance", {
    ...
    members: (_members = {
      __P_270_0: qx.theme.simple.Appearance.appearances,
      testLabel: function testLabel() {
        var obj = this.__P_270_0.label;
      ...
      testTooltip: function testTooltip() {
        var obj = this.__P_270_0.tooltip;
        var style = obj.style();
      ...
      testTooltipError: function testTooltipError() {
        var obj = this.__P_270_0["tooltip-error"];
        var style = obj.style();
      ...
      testMoveFrame: function testMoveFrame() {
        var obj = this.__P_270_0["move-frame"];
        var style = obj.style();
        this.assertIdentical("main-dark", style.decorator);
      },
      testDragDropCursor: function testDragDropCursor() {
        var obj = this.__P_270_0["dragdrop-cursor"];
        var states = {
          copy: true,
          move: true,
          alias: true
      ...
      testSlideBarButtonForward: function testSlideBarButtonForward() {
        var style = this.__P_270_0["slidebar/button-forward"].style;
      ...
      testSlideBarButtonBackward: function testSlideBarButtonBackward() {
        var style = this.__P_270_0["slidebar/button-backward"].style;
      ...
      testTableStatusBar: function testTableStatusBar() {
        var style = this.__P_270_0["table/statusbar"].style();
      ...
      testTableColumnButton: function testTableColumnButton() {
        var style = this.__P_270_0["table/column-button"].style();
      ...
      testTableScrollerFocusIndicator: function testTableScrollerFocusIndicator() {
        var style = this.__P_270_0["table-scroller/focus-indicator"].style();

        this.assertIdentical("main", style.decorator);
      },
      testTableScrollerResizeLine: function testTableScrollerResizeLine() {
        var style = this.__P_270_0["table-scroller/resize-line"].style();
      ...
      testTableHeaderCell: function testTableHeaderCell() {
        var styleFunc = this.__P_270_0["table-header-cell"].style;
        var states = {
          first: true,
          disabled: true,
          sorted: true,
      ...
      testTableHeaderCellIcon: function testTableHeaderCellIcon() {
        var style = this.__P_270_0["table-header-cell/icon"].style();

        this.assertIdentical(5, style.paddingRight);
      },
      testTableHeaderCellSortIcon: function testTableHeaderCellSortIcon() {
        var style = this.__P_270_0["table-header-cell/sort-icon"].style();
      ...
      testTableEditorTextField: function testTableEditorTextField() {
        var style = this.__P_270_0["table-editor-textfield"].style();
      ...
      testTableEditorSelectBox: function testTableEditorSelectBox() {
        var style = this.__P_270_0["table-editor-selectbox"].style();

        this.assertArrayEquals([0, 2], style.padding);
      },
      testTableEditorComboBox: function testTableEditorComboBox() {
        var style = this.__P_270_0["table-editor-combobox"].style();

        this.assertUndefined(style.decorator);
      },
      testProgressiveTableHeader: function testProgressiveTableHeader() {
        var style = this.__P_270_0["progressive-table-header"].style();
      ...
      testProgressiveTableHeaderCell: function testProgressiveTableHeaderCell() {
        var style = this.__P_270_0["progressive-table-header-cell"].style();
      ...
      testTreeVirtual: function testTreeVirtual() {
        var styleFunc = this.__P_270_0["treevirtual"].style;
        var superStyles = {
          padding: [3, 4]
        };
      ...
      testTreeVirtualFolder: function testTreeVirtualFolder() {
        var styleFunc = this.__P_270_0["treevirtual-folder"].style;
        var states = {
          opened: true,
          drag: true
        };
      ...
      testTreeVirtualFile: function testTreeVirtualFile() {
        var styleFunc = this.__P_270_0["treevirtual-file"].style;
      ...
      testTreeVirtualLine: function testTreeVirtualLine() {
        var style = this.__P_270_0["treevirtual-line"].style();
      ...
      testTreeVirtualContract: function testTreeVirtualContract() {
        var style = this.__P_270_0["treevirtual-contract"].style();
      ...
      testTreeVirtualExpand: function testTreeVirtualExpand() {
        var style = this.__P_270_0["treevirtual-expand"].style();
      ...
      testTreeVirtualOnlyContract: function testTreeVirtualOnlyContract() {
        var style = this.__P_270_0["treevirtual-only-contract"].style();
      ...
      testTreeVirtualOnlyExpand: function testTreeVirtualOnlyExpand() {
        var style = this.__P_270_0["treevirtual-only-expand"].style();
      ...
      testTreeVirtualStartContract: function testTreeVirtualStartContract() {
        var style = this.__P_270_0["treevirtual-start-contract"].style();
      ...
      testTreeVirtualStartExpand: function testTreeVirtualStartExpand() {
        var style = this.__P_270_0["treevirtual-start-expand"].style();
      ...
      testTreeVirtualEndContract: function testTreeVirtualEndContract() {
        var style = this.__P_270_0["treevirtual-end-contract"].style();
      ...
      testTreeVirtualEndExpand: function testTreeVirtualEndExpand() {
        var style = this.__P_270_0["treevirtual-end-expand"].style();
      ...
      testTreeVirtualCrossContract: function testTreeVirtualCrossContract() {
        var style = this.__P_270_0["treevirtual-cross-contract"].style();
      ...
      testTreeVirtualCrossExpand: function testTreeVirtualCrossExpand() {
        var style = this.__P_270_0["treevirtual-cross-expand"].style();
      ...
      testTreeVirtualEnd: function testTreeVirtualEnd() {
        var style = this.__P_270_0["treevirtual-end"].style();
      ...
      testTreeVirtualCross: function testTreeVirtualCross() {
        var style = this.__P_270_0["treevirtual-cross"].style();

        this.assertIdentical(qx.theme.simple.Image.URLS["treevirtual-cross"], style.icon);
      }
    }, _defineProperty(_members, "testTreeVirtualCross", function testTreeVirtualCross() {
      var style = this.__P_270_0["treevirtual-cross"].style();

      this.assertIdentical(qx.theme.simple.Image.URLS["treevirtual-cross"], style.icon);
    }), _defineProperty(_members, "testResizer", function testResizer() {
      var style = this.__P_270_0["resizer"].style();

      this.assertIdentical("main-dark", style.decorator);
    }), _defineProperty(_members, "testSplitpaneSplitter", function testSplitpaneSplitter() {
      var style = this.__P_270_0["splitpane/splitter"].style();

      this.assertIdentical("light-background", style.backgroundColor);
    }), _defineProperty(_members, "testSplitpaneSplitterKnob", function testSplitpaneSplitterKnob() {
      var styleFunc = this.__P_270_0["splitpane/splitter/knob"].style;
      var states = {
        horizontal: true
      };
      var style = styleFunc(states);
    ...
    }), _defineProperty(_members, "testSplitpaneSlider", function testSplitpaneSlider() {
      var style = this.__P_270_0["splitpane/slider"].style();

      this.assertIdentical("border-light-shadow", style.backgroundColor);
      this.assertIdentical(0.3, style.opacity);
    }), _defineProperty(_members, "testMenu", function testMenu() {
      var styleFunc = this.__P_270_0["menu"].style;
      var states = {
        submenu: true,
        contextmenu: true
      };
    ...
    }), _defineProperty(_members, "testMenuSlideBarButton", function testMenuSlideBarButton() {
      var styleFunc = this.__P_270_0["menu-slidebar-button"].style;
      var style = styleFunc({
        hovered: true
      });
      ...
      this.assertUndefined(style.backgroundColor);
    }), _defineProperty(_members, "testMenuSlideBarButtonBackward", function testMenuSlideBarButtonBackward() {
      var styleFunc = this.__P_270_0["menu-slidebar/button-backward"].style;
      var style = styleFunc({
        hovered: true
      });
    ...
    }), _defineProperty(_members, "testMenuSlideBarButtonForward", function testMenuSlideBarButtonForward() {
      var styleFunc = this.__P_270_0["menu-slidebar/button-forward"].style;
      var style = styleFunc({
        hovered: true
      });
    ...
    }), _defineProperty(_members, "testMenuSeparator", function testMenuSeparator() {
      var style = this.__P_270_0["menu-separator"].style();
    ...
    }), _defineProperty(_members, "testMenuButton", function testMenuButton() {
      var styleFunc = this.__P_270_0["menu-button"].style;
    ...
    }), _defineProperty(_members, "testMenuButtonIcon", function testMenuButtonIcon() {
      var style = this.__P_270_0["menu-button/icon"].style();

      this.assertIdentical("middle", style.alignY);
    }), _defineProperty(_members, "testMenuButtonLabel", function testMenuButtonLabel() {
      var style = this.__P_270_0["menu-button/label"].style();

      this.assertIdentical("middle", style.alignY);
      this.assertIdentical(1, style.padding);
    }), _defineProperty(_members, "testMenuButtonShortcut", function testMenuButtonShortcut() {
      var style = this.__P_270_0["menu-button/shortcut"].style();

      this.assertIdentical("middle", style.alignY);
      this.assertIdentical(1, style.padding);
      this.assertIdentical(14, style.marginLeft);
    }), _defineProperty(_members, "testMenuButtonArrow", function testMenuButtonArrow() {
      var styleFunc = this.__P_270_0["menu-button/arrow"].style;
      var states = {
        selected: true
      };
      var style = styleFunc(states);
    ...
    }), _defineProperty(_members, "testMenuCheckbox", function testMenuCheckbox() {
      var styleFunc = this.__P_270_0["menu-checkbox"].style;
      var states = {
        checked: true,
        selected: true
      };
    ...
    }), _defineProperty(_members, "testMenuRadioButton", function testMenuRadioButton() {
      var styleFunc = this.__P_270_0["menu-radiobutton"].style;
      var states = {
        checked: true,
        selected: true
      };
      ...
      style = styleFunc(states);
      this.assertUndefined(style.icon);
    }), _defineProperty(_members, "testMenuBar", function testMenuBar() {
      var style = this.__P_270_0["menubar"].style();

      this.assertIdentical("light-background", style.backgroundColor);
      this.assertArrayEquals([4, 2], style.padding);
    }), _defineProperty(_members, "testMenuBarButton", function testMenuBarButton() {
      var styleFunc = this.__P_270_0["menubar-button"].style;
      var states = {
        disabled: false,
        pressed: true,
        hovered: false
    ...
    }), _defineProperty(_members, "testGroupItem", function testGroupItem() {
      var style = this.__P_270_0["group-item"].style();
      ...
      this.assertIdentical("bold", style.font);
    }), _defineProperty(_members, "testVirtualTree", function testVirtualTree() {
      var style = this.__P_270_0["virtual-tree"].style();

      this.assertIdentical(21, style.itemHeight);
    }), _defineProperty(_members, "testCell", function testCell() {
      var styleFunc = this.__P_270_0["cell"].style;
      var style = styleFunc({
        selected: true
      });
      ...
      this.assertIdentical("text", style.textColor);
    }), _defineProperty(_members, "testCellNumber", function testCellNumber() {
      var style = this.__P_270_0["cell-number"].style();
...
//# sourceMappingURL=Appearance.js.map?dt=1613269557727