  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.structure.Default", {
    ...
    construct: function construct(header, footer, pane) {
      ...
      if (!header) {
        this.__P_491_0 = new qx.ui.progressive.headfoot.Null();
        this.__P_491_1 = this.__P_491_0;
      } else {
        this.__P_491_0 = null;
        this.__P_491_1 = header;
      } // If no footer was specified, use a null footer


      if (!footer) {
        this.__P_491_2 = new qx.ui.progressive.headfoot.Null();
        this.__P_491_3 = this.__P_491_2;
      } else {
        this.__P_491_2 = null;
        this.__P_491_3 = footer;
      }
    },
    members: {
      __P_491_1: null,
      ...
      applyStructure: function applyStructure(progressive) {
        ...
        this.__P_491_1.join(progressive);

        this.__P_491_3.join(progressive); // Add the header, pane, and footer to the Progressive.


        progressive.add(this.__P_491_1);
        progressive.add(this.getPane(), {
          flex: 1
        });
        progressive.add(this.__P_491_3);
      },
      ...
      getFooter: function getFooter() {
        return this.__P_491_3;
      }
    },
    destruct: function destruct() {
      if (this.__P_491_0) {
        this.__P_491_0.dispose();

        this.__P_491_0 = null;
      }

      if (this.__P_491_2) {
        this.__P_491_2.dispose();

        this.__P_491_2 = null;
      }

      this.__P_491_1 = this.__P_491_3 = null;
    }
  });
  qx.ui.progressive.structure.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1613269571943