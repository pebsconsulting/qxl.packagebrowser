  ...
  qx.Class.define("qx.test.ui.core.Placement", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_283_0 = new qx.ui.core.Widget().set({
          backgroundColor: "red",
          width: 100,
          height: 300
        });
        this.getRoot().add(this.__P_283_0, {
          left: 150
        }); // set the always visible element

        qx.ui.core.MPlacement.setVisibleElement(this.__P_283_0);
      },
      tearDown: function tearDown() {
        qx.test.ui.core.Placement.prototype.tearDown.base.call(this);
        qx.ui.core.MPlacement.setVisibleElement(null);

        this.__P_283_0.destroy();
      },
      __P_283_1: function __P_283_1(w) {
      ...
      __P_283_2: function __P_283_2(w) {
        // force an addition to the dom!
        w.show();
        w.hide(); // modify the placed widget
      ...
      __P_283_3: function __P_283_3(w) {
        // force an addition to the dom!
        w.show();
        w.hide();

        this.__P_283_0.setLayoutProperties({
          top: 100
      ...
      __P_283_4: function __P_283_4(w) {
        // force an addition to the dom!
        w.show();
        w.hide(); // modify the placed widget
...
//# sourceMappingURL=Placement.js.map?dt=1613268694460