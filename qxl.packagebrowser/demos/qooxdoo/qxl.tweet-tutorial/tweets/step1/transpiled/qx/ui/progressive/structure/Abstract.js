  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.structure.Abstract", {
    ...
    construct: function construct(pane) {
      ...
      if (!pane) {
        this.__P_490_0 = new qx.ui.core.Widget();
        this.__P_490_1 = this.__P_490_0;
      } else {
        this.__P_490_0 = null;
        this.__P_490_1 = pane;
      }

      this.__P_490_1.getContentElement().setStyle("overflowY", "auto");
    },
    members: {
      __P_490_0: null,
      __P_490_1: null,
      ...
      getPane: function getPane() {
        return this.__P_490_1;
      }
    },
    destruct: function destruct() {
      if (this.__P_490_0) {
        this.__P_490_0.dispose();
      }
...
//# sourceMappingURL=Abstract.js.map?dt=1613268707919