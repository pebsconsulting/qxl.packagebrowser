(function () {
  ...
  qx.Class.define("qxl.tweets.MainWindow", {
    ...
    construct: function construct() {
      qx.ui.window.Window.constructor.call(this, "tweets", "qxl/tweets/logo.png"); // hide the window buttons

      this.setShowClose(false);
      this.setShowMaximize(false);
      this.setShowMinimize(false); // adjust size

      this.setWidth(250);
      this.setHeight(300); // add the layout

      var layout = new qx.ui.layout.Grid(0, 0);
      layout.setRowFlex(1, 1);
      layout.setColumnFlex(0, 1);
      this.setLayout(layout);
      this.setContentPadding(0); // toolbar
      ...
      toolbar.addSpacer(); // settings button
      ...
      this.__P_586_0 = new qx.ui.form.List();
      this.add(this.__P_586_0, {
        row: 1,
        column: 0,
        colSpan: 2
      }); // textarea

      this.__P_586_1 = new qx.ui.form.TextArea();
      this.add(this.__P_586_1, {
        row: 2,
        column: 0
      });

      this.__P_586_1.setPlaceholder(this.tr("Enter your message here..."));

      this.__P_586_1.addListener("input", function (e) {
        var value = e.getData();
      ...
      postButton.addListener("execute", function () {
        this.fireDataEvent("post", this.__P_586_1.getValue());
      }, this);
...
//# sourceMappingURL=MainWindow.js.map?dt=1613269393406