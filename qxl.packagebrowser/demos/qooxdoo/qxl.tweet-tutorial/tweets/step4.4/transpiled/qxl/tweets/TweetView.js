(function () {
  ...
  qx.Class.define("qxl.tweets.TweetView", {
    ...
    construct: function construct() {
      qx.ui.core.Widget.constructor.call(this); // create a date format like "June 18, 2010 9:31 AM"

      this._dateFormat = new qx.util.format.DateFormat(qx.locale.Date.getDateFormat("long") + " " + qx.locale.Date.getTimeFormat("short")); // initialize the layout and allow wrap for "post"
    ...
    members: {
      ...
      _createChildControlImpl: function _createChildControlImpl(id) {
        ...
        return control || qxl.tweets.TweetView.prototype._createChildControlImpl.base.call(this, id);
      },
      // property apply
...
//# sourceMappingURL=TweetView.js.map?dt=1613269393442