  ...
  qx.Class.define("qx.test.data.controller.FormWithArrayAndModel", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        qx.Class.define("qx.test.data.controller.fixture.ArrayField", {
          ...
          members: {
            ...
            setValue: function setValue(value) {
              var oldValue = this.__P_222_4;
              this.__P_222_4 = value;
        ...
        this.__P_222_0 = new qx.test.data.controller.fixture.ArrayField();
        this.__P_222_1 = new qx.test.data.controller.fixture.ModelField();
        this.__P_222_2 = new qx.ui.form.Form();

        this.__P_222_2.add(this.__P_222_0, "One", null, "f1");

        this.__P_222_2.add(this.__P_222_1, "Two", null, "f2");

        this.__P_222_3 = qx.data.marshal.Json.createModel({
          f1: null,
          f2: null,
          f3: null
        });
      ...
      tearDown: function tearDown() {
        this._disposeObjects("__P_222_0", "__P_222_1", "__P_222_2", "__P_222_3");
      ...
      "test self update: array": function testSelfUpdateArray() {
        ...
        this.__P_222_0.setValue(arr); // sync form and model, model (null) takes preference over form (arr)


        var ctrl = new qx.data.controller.Form(this.__P_222_3, this.__P_222_2, true);
        this.assertNull(this.__P_222_0.getValue());
        this.assertNull(this.__P_222_3.getF1()); // user changes field and hits ok button

        this.__P_222_0.setValue(arr);

        ctrl.updateModel();
        this.assertIdentical(arr, this.__P_222_3.getF1());
        ctrl.dispose();
        arr.dispose();
      },
      "test self update: model": function testSelfUpdateModel() {
        var addressForm = this.__P_222_5();

        this.__P_222_1.setTarget(addressForm);

        var ctrl = new qx.data.controller.Form(this.__P_222_3, this.__P_222_2, true);
        this.assertNull(this.__P_222_0.getValue());
        this.assertNull(this.__P_222_1.getValue()); // let's make an address for this user (this.__model being a user now ;) )

        this.__P_222_1.createModel(false);
        ...
        this.assertIdentical("42", this.__P_222_3.getF2().getHouseNr());
        this.assertIdentical("Nowhere Ln", this.__P_222_3.getF2().getStreetName());
        ctrl.dispose();
        addressForm.dispose();
      },
      "test updating view": function testUpdatingView() {
        ...
        var ctrl = new qx.data.controller.Form(this.__P_222_3, this.__P_222_2);
        this.assertNull(this.__P_222_0.getValue());
        this.assertNull(this.__P_222_3.getF1()); // user changes field and hits ok button
      ...
      "test updating model: array field": function testUpdatingModelArrayField() {
        ...
        arr.setAutoDisposeItems(true);
        var ctrl = new qx.data.controller.Form(this.__P_222_3, this.__P_222_2); // change model, view should follow

        this.__P_222_3.setF1(arr);

        this.assertIdentical(arr, this.__P_222_0.getValue());
        ctrl.dispose();
        arr.dispose();
      },
      "test updating model: model field": function testUpdatingModelModelField() {
        ...
        var ctrl = new qx.data.controller.Form(this.__P_222_3, this.__P_222_2);
        this.assertNull(this.__P_222_0.getValue());
        this.assertNull(this.__P_222_1.getValue());

        this.__P_222_1.createModel(false);

        this.assertIdentical(this.__P_222_1.getModel(), this.__P_222_3.getF2());
        ctrl.dispose();
        addressForm.dispose();
      }
    }
...
//# sourceMappingURL=FormWithArrayAndModel.js.map?dt=1613269368359