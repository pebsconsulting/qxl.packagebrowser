  ...
  qx.Class.define("qx.test.ui.form.virtual.VirtualComboBox", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_317_0 = new qx.ui.form.VirtualComboBox();
        this.getRoot().add(this.__P_317_0);
        this.flush();
      },
      tearDown: function tearDown() {
        qx.test.ui.form.virtual.VirtualComboBox.prototype.tearDown.base.call(this);

        this.__P_317_0.destroy();
      ...
      testPreselectOnOpen: function testPreselectOnOpen() {
        this.__P_317_1 = this.__P_317_2();

        this.__P_317_0.setModel(this.__P_317_1);

        this.__P_317_0.setValue("i");
        ...
        this.__P_317_0.close();

        this.flush(); // Preselection may not change the actual value

        this.assertNotEquals("item 1", this.__P_317_0.getValue());
        this.assertEquals("i", this.__P_317_0.getValue());
      },
      testSelectFirstMatch: function testSelectFirstMatch() {
        ...
        this.__P_317_0.setValue("item 4");
        ...
        var preselected = this.__P_317_0.getChildControl("dropdown")._preselected;

        this.assertEquals("item 4", preselected);
        this.assertEquals("item 4", this.__P_317_0.getValue());
      },
      testSelectFirstMatchWithSortedModel: function testSelectFirstMatchWithSortedModel() {
        ...
        this.__P_317_0.setDelegate(delegate);
        ...
        this.assertEquals("item 4", this.__P_317_0.getValue()); // The virtual list uses a timeout to asynchronously flush the layout
      ...
      testSelectFirstMatchWithFilteredModel: function testSelectFirstMatchWithFilteredModel() {
        ...
        this.__P_317_0.setValue("item 22");
        ...
        this.assertEquals("item 22", this.__P_317_0.getValue());
      },
      testSelectFirstMatchWithFormatter: function testSelectFirstMatchWithFormatter() {
        this.__P_317_1 = this.__P_317_3();
        ...
        this.__P_317_0.setDefaultFormat(function (data) {
          if (data) {
      ...
      testSelectFirstMatchByLabelPath: function testSelectFirstMatchByLabelPath() {
        this.__P_317_1 = this.__P_317_4();

        this.__P_317_0.setLabelPath("lastname");

        this.__P_317_0.setModel(this.__P_317_1);

        this.__P_317_0.setValue("Si");
        ...
        var preselected = this.__P_317_0.getChildControl("dropdown")._preselected.getLastname();

        this.assertEquals("Sisko", preselected);
        this.assertEquals("Si", this.__P_317_0.getValue());
      },
      testEmptySelection: function testEmptySelection() {
        this.__P_317_0.setLabelPath("label");

        var rawData = [{
          label: "foo"
        }];
        var model = this.__P_317_1 = qx.data.marshal.Json.createModel(rawData);

        this.__P_317_0.setModel(model);

        var selection = this.__P_317_0.getChildControl("dropdown").getSelection();

        selection.push(this.__P_317_0.getModel().getItem(0));
        selection.removeAll();
      },
...
//# sourceMappingURL=VirtualComboBox.js.map?dt=1613268791973