  ...
  qx.Class.define("qxl.tweets.Application", {
    ...
    */
    members: {
      ...
      main: function main() {
        // Call super class
        qxl.tweets.Application.prototype.main.base.call(this); // Enable logging in debug variant
        ...
        */
        ...
        main.moveTo(50, 30);
        main.open();
        var service = new qxl.tweets.IdenticaService(); // handler after posting a tweet

        service.addListener("postOk", function () {
          main.clearPostMessage();
          service.fetchTweets();
        }, this); // reload handling
        ...
        service.bind("tweets", controller, "model"); // show the login window on startup

        this.__P_584_0 = new qxl.tweets.LoginWindow();

        this.__P_584_0.addListener("changeLoginData", function (ev) {
          var loginData = ev.getData();
          service.fetchTweets(loginData.username, loginData.password);
        });

        this.__P_584_0.moveTo(320, 30);
...
//# sourceMappingURL=Application.js.map?dt=1613269012233