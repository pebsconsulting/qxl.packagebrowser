  ...
  qx.Mixin.define("qx.ui.core.MMovable", {
    ...
    members: {
      ...
      */
      ...
      _activateMoveHandle: function _activateMoveHandle(widget) {
        ...
        widget.addListener("losecapture", this.__P_377_10, this);
      },
       ...
       */
      __P_377_11: function __P_377_11() {
        var frame = this.__P_377_1;

        if (!frame) {
          frame = this.__P_377_1 = new qx.ui.core.Widget();
      ...
      */
       ...
       */
      __P_377_13: function __P_377_13(e) {
        var range = this.__P_377_2;
        ...
        var viewportLeft = this.__P_377_3 + pointerLeft;
        var viewportTop = this.__P_377_4 + pointerTop;
        return {
          viewportLeft: parseInt(viewportLeft, 10),
          viewportTop: parseInt(viewportTop, 10),
          parentLeft: parseInt(viewportLeft - this.__P_377_5, 10),
          parentTop: parseInt(viewportTop - this.__P_377_6, 10)
        };
      },
      ...
      */
      ...
      _onMovePointerDown: function _onMovePointerDown(e) {
        ...
        if (qx.Class.implementsInterface(parent, qx.ui.window.IDesktop)) {
          if (!parent.isBlocked()) {
            this.__P_377_8 = parent.getBlockerColor();
            this.__P_377_9 = parent.getBlockerOpacity();
        ...
        this.__P_377_5 = parentLocation.left;
        this.__P_377_6 = parentLocation.top;
        this.__P_377_3 = widgetLocation.left - e.getDocumentLeft();
        this.__P_377_4 = widgetLocation.top - e.getDocumentTop(); // Add state

        this.addState("move"); // Enable capturing

        this.__P_377_0.capture(); // Enable drag frame
      ...
      _onMovePointerMove: function _onMovePointerMove(e) {
        ...
        var coords = this.__P_377_13(e);

        if (this.getUseMoveFrame()) {
          this.__P_377_11().setDomPosition(coords.viewportLeft, coords.viewportTop);
        } else {
      ...
      _onMovePointerUp: function _onMovePointerUp(e) {
        ...
        if (qx.Class.implementsInterface(parent, qx.ui.window.IDesktop)) {
          if (this.__P_377_7) {
            parent.unblock();
            parent.setBlockerColor(this.__P_377_8);
            parent.setBlockerOpacity(this.__P_377_9);
            this.__P_377_8 = null;
            this.__P_377_9 = 0;
        ...
        this.__P_377_0.releaseCapture(); // Apply them to the layout
       ...
       */
      __P_377_10: function __P_377_10(e) {
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_377_1", "__P_377_0");
...
//# sourceMappingURL=MMovable.js.map?dt=1613269194124