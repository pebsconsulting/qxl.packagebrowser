  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.dev.unit.MeasurementResult", {
    ...
    construct: function construct(message, iterations, ownTime, renderTime) {
      this.__P_105_0 = message;
      this.__P_105_1 = iterations;
      this.__P_105_2 = ownTime;
      this.__P_105_3 = renderTime;
    },
    members: {
      __P_105_0: null,
      __P_105_1: null,
      ...
      getData: function getData() {
        return {
          message: this.__P_105_0,
          iterations: this.__P_105_1,
          ownTime: this.__P_105_2,
          renderTime: this.__P_105_3
        };
      },
      ...
      toString: function toString() {
        return ["Measured: " + this.__P_105_0, "Iterations: " + this.__P_105_1, "Time: " + this.__P_105_2 + "ms", "Render time: " + this.__P_105_3 + "ms"].join("\n");
      }
    }
  });
...
//# sourceMappingURL=MeasurementResult.js.map?dt=1613269173334