  ...
  qx.Class.define("qx.test.ui.embed.Iframe", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_287_0 = new qx.ui.embed.Iframe();
      ...
      testHiddenSetSourceInitial: function testHiddenSetSourceInitial() {
        ...
        this.assertNotNull(this.__P_287_0.getContentElement().getDomElement());
      },
      testHiddenSetSource: function testHiddenSetSource() {
        ...
        this.__P_287_0.setSource(src);

        qx.ui.core.queue.Manager.flush();

        this.__P_287_0.addListenerOnce("load", function () {
          this.resume(function () {
            this.assertEquals(this.__P_287_0.getSource(), this.__P_287_0.getWindow().location.href);
          });
        }, this);
      ...
      testGetWindow: function testGetWindow() {
        ...
        this.__P_287_0.addListener("load", function () {
          this.resume(function () {
            this.assertNotNull(this.__P_287_0.getWindow());
          }, this);
        }, this);
...
//# sourceMappingURL=Iframe.js.map?dt=1613269187905