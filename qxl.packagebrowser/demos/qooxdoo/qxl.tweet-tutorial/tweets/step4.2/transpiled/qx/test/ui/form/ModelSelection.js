(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.ModelSelection", {
    ...
    members: {
      __P_303_0: function __P_303_0(widget, children) {
      ...
      __P_303_1: function __P_303_1(widget, children) {
        var children = children || widget.getChildren(); // check the model selection
      ...
      __P_303_2: function __P_303_2(widget, children) {
      ...
      __P_303_3: function __P_303_3(widget, children) {
        var children = children || widget.getChildren(); // check the set selection
      ...
      __P_303_5: function __P_303_5(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_303_7: function __P_303_7() {
        var group = new qx.ui.form.RadioGroup();

        this.__P_303_8(group);

        return group;
      },
      __P_303_9: function __P_303_9() {
      ...
      __P_303_8: function __P_303_8(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_303_10: function __P_303_10() {
      ...
      __P_303_11: function __P_303_11(box) {
      ...
      testListGetSingle: function testListGetSingle() {
        var list = this.__P_303_6();

        this.__P_303_0(list);

        this.__P_303_11(list);
      },
      ...
      testTreeGetSingle: function testTreeGetSingle() {
        var widget = this.__P_303_10();

        var children = widget.getItems(true);

        this.__P_303_0(widget, children);
      ...
      testTreeSetSingle: function testTreeSetSingle() {
        ...
        this.__P_303_2(widget, children);
      ...
      testTreeGetMulti: function testTreeGetMulti() {
        ...
        this.__P_303_1(widget, children);
      ...
      testTreeSetMulti: function testTreeSetMulti() {
        ...
        this.__P_303_3(widget, children);
...
//# sourceMappingURL=ModelSelection.js.map?dt=1613269092758