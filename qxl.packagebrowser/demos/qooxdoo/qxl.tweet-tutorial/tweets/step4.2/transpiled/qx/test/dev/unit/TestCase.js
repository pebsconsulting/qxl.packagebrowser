  ...
  qx.Class.define("qx.test.dev.unit.TestCase", {
    ...
    members: {
      ...
      testResumeHandler: function testResumeHandler() {
        this.__P_235_0(this.resumeHandler(function (param) {
      ...
      __P_235_0: function __P_235_0(callback) {
        window.setTimeout(this.__P_235_1.bind(this, callback), 0);
      },
      __P_235_1: function __P_235_1(callback) {
...
//# sourceMappingURL=TestCase.js.map?dt=1613269087449