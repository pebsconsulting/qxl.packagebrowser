  ...
  qx.Class.define("qx.test.ui.form.VirtualSelectBox", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_316_0 = new qx.ui.form.VirtualSelectBox();
        this.getRoot().add(this.__P_316_0);
        this.flush();
      },
      tearDown: function tearDown() {
        qx.test.ui.form.VirtualSelectBox.prototype.tearDown.base.call(this);

        this.__P_316_0.destroy();

        this.__P_316_0 = null;
      },
      __P_316_1: function __P_316_1() {
        // focus -> array key down -> array key down -> enter
        this.__P_316_0.getSelection().setItem(0, this.__P_316_0.getModel().getItem(1));
      },
      testChangeValueEvent: function testChangeValueEvent() {
        var m = qx.data.marshal.Json.createModel(["a", "b"]);

        this.__P_316_0.addListenerOnce("changeValue", function (e) {
          this.assertIdentical("a", e.getData());
          this.assertNull(e.getOldData());
        }.bind(this));

        this.__P_316_0.setModel(m);
      ...
      "test dropdown list same width as selectbox": function testDropdownListSameWidthAsSelectbox() {
        ...
        this.__P_316_0.setAllowGrowDropDown(false);

        this.__P_316_0.setModel(m);

        this.__P_316_0.setWidth(150);

        this.__P_316_0.open();

        this.flush();
        setTimeout(function () {
          test.assertIdentical(test.__P_316_0.getWidth(), test.__P_316_0.getBounds().width);
          test.assertIdentical(test.__P_316_0.getWidth(), test.__P_316_0.getChildControl('dropdown').getBounds().width);
          test.resume();
        }, 10);
        this.wait();
      },
      "test dropdown list wider than selectbox": function testDropdownListWiderThanSelectbox() {
        ...
        this.__P_316_0.setAllowGrowDropDown(true);
        ...
        setTimeout(function () {
          test.assertIdentical(test.__P_316_0.getWidth(), test.__P_316_0.getBounds().width);
          test.assertTrue(test.__P_316_0.getChildControl('dropdown').getBounds().width > 666, "dropdown could not fit the whole item");
          test.resume();
        }, 10);
        this.wait();
      }
...
//# sourceMappingURL=VirtualSelectBox.js.map?dt=1613268889272