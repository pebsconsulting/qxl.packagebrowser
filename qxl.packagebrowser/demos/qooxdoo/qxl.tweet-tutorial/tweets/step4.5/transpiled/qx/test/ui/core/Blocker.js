  ...
  qx.Class.define("qx.test.ui.core.Blocker", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_282_0 = new qx.ui.core.Blocker(this.getRoot());

        this.__P_282_0.setColor("green");

        this.__P_282_0.setOpacity(0.5);
      },
      tearDown: function tearDown() {
        qx.test.ui.core.Blocker.prototype.tearDown.base.call(this);

        this.__P_282_0.dispose();
      },
      testBlocker: function testBlocker() {
        var blockerElement = this.__P_282_0.getBlockerElement();

        this.__P_282_0.block();

        this.flush();
        this.assertTrue(this.__P_282_0.isBlocked(), "isBlocked()");
        this.assertTrue(blockerElement.isIncluded(), "isIncluded()");

        this.__P_282_0.unblock();

        this.flush();
        this.assertFalse(this.__P_282_0.isBlocked(), "isBlocked()");
      ...
      testBlockedEvent: function testBlockedEvent() {
        ...
        this.__P_282_0.addListenerOnce("blocked", function (e) {
          this.__P_282_1 = true;
        }, this);

        this.__P_282_0.addListenerOnce("unblocked", function (e) {
          this.__P_282_2 = true;
        }, this);
        ...
        this.wait(100, function () {
          this.assertTrue(this.__P_282_1, "'blocked' event was not fired, after block() was executed!");
          this.assertTrue(this.__P_282_2, "'unblocked' event was not fired, after unblock() was executed!");
        }, this);
      },
...
//# sourceMappingURL=Blocker.js.map?dt=1613269466416