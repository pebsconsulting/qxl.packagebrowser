  ...
  qx.Class.define("qx.test.ui.virtual.cell.WidgetCell", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_339_0 = new qx.ui.virtual.cell.WidgetCell();
      },
      ...
      testCreateWidget: function testCreateWidget() {
        var item = this.__P_339_0.getCellWidget();
      ...
      testPoolOnDelegateChange: function testPoolOnDelegateChange() {
        var item1 = this.__P_339_0.getCellWidget();

        this.assertQxWidget(item1);

        var item2 = this.__P_339_0.getCellWidget();

        this.assertQxWidget(item2);

        this.__P_339_0.pool(item1);

        this.__P_339_0.pool(item2);
      ...
      testEvent: function testEvent() {
        var that = this;
        var widget = null;
        this.assertEventFired(this.__P_339_0, "created", function () {
          widget = that.__P_339_0.getCellWidget();
        }, function (e) {
          that.assertQxWidget(e.getData());
        });

        this.__P_339_0.pool(widget);

        this.assertEventNotFired(this.__P_339_0, "created", function () {
          that.__P_339_0.getCellWidget();
        }, function (e) {
          that.assertQxWidget(e.getData());
        });
        widget.dispose();
      ...
      testUpdateData: function testUpdateData() {
        ...
        this.__P_339_0.updateData(item, data);
      ...
      testUpdateEmptyData: function testUpdateEmptyData() {
        ...
        this.__P_339_0.updateData(item);
      ...
      testUpdateWrongData: function testUpdateWrongData() {
        ...
        this.assertException(function () {
          that.__P_339_0.updateData(item, data);
        });
        item.dispose();
      },
      __P_339_1: function __P_339_1() {
        this.__P_339_0.setDelegate({
...
//# sourceMappingURL=WidgetCell.js.map?dt=1613269469419