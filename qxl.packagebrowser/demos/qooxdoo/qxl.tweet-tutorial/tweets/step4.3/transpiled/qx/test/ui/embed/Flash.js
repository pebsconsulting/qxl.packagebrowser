  ...
  qx.Class.define("qx.test.ui.embed.Flash", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        var flash = this.__P_286_0 = new qx.ui.embed.Flash("qx/test/UnitTestFlash.swf", "flashmovie");
        flash.setVariables(this.__P_286_2);
        flash.setScale("noscale");
        flash.setPlay(true);
        flash.setLoop(true);
        flash.setMenu(true);
        this.getRoot().add(this.__P_286_0, {
          edge: 10
        });
      },
      ...
      testEvents: function testEvents() {
        ...
        this.__P_286_0.addListener("loading", test.loading);

        this.__P_286_0.addListener("loaded", test.loaded);

        this.__P_286_0.addListener("timeout", test.timeout);
      ...
      testCreateFlash: function testCreateFlash() {
        var that = this;
        this.wait(2000, function () {
          var flash = that.__P_286_0.getFlashElement();
...
//# sourceMappingURL=Flash.js.map?dt=1613269281772