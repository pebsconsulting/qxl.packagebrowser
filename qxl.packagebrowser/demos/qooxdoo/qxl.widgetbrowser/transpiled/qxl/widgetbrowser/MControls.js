  ...
  qx.Mixin.define("qxl.widgetbrowser.MControls", {
    members: {
      initControls: function initControls(widgets, options) {
        ...
        if (options.overflow) {
          var _toggleInvalid = new qx.ui.form.ToggleButton("Overflow");

          _toggleInvalid.addListener("changeValue", function (e) {
            widgets.forEach(function (widget, index) {
              widget.toggleOverflow(widget, e.getData());
            }, this);
          });

          controls.add(_toggleInvalid);
        }
...
//# sourceMappingURL=MControls.js.map?dt=1613269687678