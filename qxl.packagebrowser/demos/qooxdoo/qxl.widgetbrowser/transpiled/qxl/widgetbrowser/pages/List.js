  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.List", {
    ...
    construct: function construct() {
      ...
      this.__P_6_0 = new qx.ui.container.Composite(new qx.ui.layout.Grid(10));
      this.__P_6_1 = qx.util.ResourceManager.getInstance().toUri("qxl/widgetbrowser/people.json");
      this.add(this.__P_6_0);
      this.initWidgets();
    },
    members: {
      __P_6_0: null,
      ...
      initWidgets: function initWidgets() {
        ...
        this.__P_6_0.add(label, {
          row: 0,
          column: 0
        });

        var list = this.__P_6_2();

        this.__P_6_0.add(list, {
          row: 1,
          column: 0
        });
        ...
        var virtualList = this.__P_6_3();

        this.__P_6_0.add(virtualList, {
          row: 1,
          column: 1
        });
        ...
        var groupedVirtualList = this.__P_6_4();

        this.__P_6_0.add(groupedVirtualList, {
          row: 1,
          column: 2
        });
      ...
      __P_6_2: function __P_6_2() {
        ...
        list.setWidth(150);
        var req = new qx.io.request.Xhr(this.__P_6_1);
        req.setParser("json");
      ...
      __P_6_4: function __P_6_4() {
        var list = this.__P_6_3(); // Creates the delegate for sorting and grouping
      ...
      __P_6_5: function __P_6_5(widget) {
        var store = new qx.data.store.Json(this.__P_6_1);
...
//# sourceMappingURL=List.js.map?dt=1613269672675