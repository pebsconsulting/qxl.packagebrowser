  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Table", {
    ...
    members: {
      ...
      __P_9_2: function __P_9_2(rowCount) {
        var rowData = [];
        ...
        for (var row = 0; row < rowCount; row++) {
          ...
          rowData.push([this.__P_9_0++, Math.random() * 10000, date, Math.random() > 0.5]);
        }
...
//# sourceMappingURL=Table.js.map?dt=1613269672820