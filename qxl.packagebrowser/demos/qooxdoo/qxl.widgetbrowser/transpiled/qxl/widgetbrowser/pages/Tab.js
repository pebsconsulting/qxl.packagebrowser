  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Tab", {
    ...
    construct: function construct() {
      ...
      this.__P_8_0 = new qx.ui.container.Composite(new qx.ui.layout.Grid(10, 20));
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        var tabTop = this.__P_8_1();

        tabTop.setBarPosition("top");

        this.__P_8_0.add(tabTop, {
          row: 0,
          column: 0
        });
        ...
        var tabBottom = this.__P_8_1();

        tabBottom.setBarPosition("bottom");

        this.__P_8_0.add(tabBottom, {
          row: 0,
          column: 1
        });
        ...
        var tabLeft = this.__P_8_1();

        tabLeft.setBarPosition("left");

        this.__P_8_0.add(tabLeft, {
          row: 1,
          column: 0
        });
        ...
        var tabRight = this.__P_8_1();

        tabRight.setBarPosition("right");

        this.__P_8_0.add(tabRight, {
          row: 1,
          column: 1
        });
...
//# sourceMappingURL=Tab.js.map?dt=1613269672782