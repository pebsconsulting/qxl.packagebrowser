  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Window", {
    ...
    construct: function construct() {
      ...
      this.__P_11_0 = new qx.ui.window.Desktop().set({
        decorator: decorator
      });
      this.add(this.__P_11_0, {
        edge: 0,
        top: 0
      });
      this.initWidgets();
    ...
    members: {
      ...
      __P_11_4: function __P_11_4() {
        ...
        this.__P_11_0.add(wm1);

        var wm2 = this.__P_11_5();
...
//# sourceMappingURL=Window.js.map?dt=1613269673015