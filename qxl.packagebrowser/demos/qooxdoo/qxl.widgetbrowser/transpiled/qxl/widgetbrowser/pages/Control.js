  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Control", {
    ...
    construct: function construct() {
      ...
      this.__P_4_0 = new qx.ui.container.Composite(new qx.ui.layout.VBox(20));
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        this.__P_4_0.add(label);

        this.__P_4_0.add(colorSelector); // ColorPopup
        ...
        this.__P_4_0.add(openColorPopup);
...
//# sourceMappingURL=Control.js.map?dt=1613269672503