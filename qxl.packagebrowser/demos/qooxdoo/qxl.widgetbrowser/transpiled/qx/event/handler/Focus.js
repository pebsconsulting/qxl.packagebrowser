      ...
      */
      ...
      _initObserver: qx.core.Environment.select("engine.name", {
        "gecko": function gecko() {
          ...
          this.__P_211_5 = qx.lang.Function.listener(this.__P_211_22, this); // Register events

          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_211_1, true);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_211_2, true); // Capturing is needed for gecko to correctly
          // handle focus of input and textarea fields

          qx.bom.Event.addNativeListener(this._window, "focus", this.__P_211_3, true);
          qx.bom.Event.addNativeListener(this._window, "blur", this.__P_211_4, true); // Capture drag events
        ...
        "mshtml": function mshtml() {
          ...
          this.__P_211_6 = qx.lang.Function.listener(this.__P_211_25, this); // Register events

          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_211_1);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_211_2); // MSHTML supports their own focusin and focusout events
          ...
          qx.bom.Event.addNativeListener(this._document, "focusout", this.__P_211_8); // Add selectstart to prevent selection
        ...
        "opera": function opera() {
          ...
          this.__P_211_2 = qx.lang.Function.listener(this.__P_211_19, this);
          this.__P_211_7 = qx.lang.Function.listener(this.__P_211_23, this);
          this.__P_211_8 = qx.lang.Function.listener(this.__P_211_24, this); // Register events
      ...
      */
      ...
      __P_211_23: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(domEvent) {
          ...
          this.__P_211_17(); // Update internal data
      ...
      __P_211_24: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(domEvent) {
          ...
          if (relatedTarget == null) {
            ...
            this.__P_211_16(); // Reset active and focus
        ...
        "opera": function opera(domEvent) {
          ...
          if (target == this._document) {
            this.__P_211_16(); // Store old focus/active elements
      ...
      __P_211_20: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "gecko": function gecko(domEvent) {
          ...
          if (target === this._window || target === this._document) {
            this.__P_211_17(); // Always speak of the body, not the window or document
...
//# sourceMappingURL=Focus.js.map?dt=1613269688969