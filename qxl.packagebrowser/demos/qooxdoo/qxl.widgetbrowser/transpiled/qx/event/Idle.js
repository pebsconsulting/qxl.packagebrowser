    ...
    */
    ...
    members: {
      ...
      _applyTimeoutInterval: function _applyTimeoutInterval(value) {
        if (this.__P_95_0) {
          this.__P_95_0.setInterval(value);
        }
      },
      ...
      __P_95_1: function __P_95_1() {
        if (!this.__P_95_0 && this.hasListener("interval")) {
       ...
       */
      __P_95_2: function __P_95_2() {
        if (this.__P_95_0 && !this.hasListener("interval")) {
          this.__P_95_0.stop();

          this.__P_95_0.dispose();
...
//# sourceMappingURL=Idle.js.map?dt=1613269681336