    ...
    members: {
      ...
      _applyQxObjectId: function _applyQxObjectId(value, oldValue) {
        if (!this.__P_197_1) {
          ...
          if (owner) {
            owner.__P_197_2(this, value, oldValue);
          }
       ...
       */
      __P_197_2: function __P_197_2(obj, newId, oldId) {
        delete this.__P_197_0[oldId];
        this.__P_197_0[newId] = obj;
      },
      ...
      _cascadeQxObjectIdChanges: function _cascadeQxObjectIdChanges() {
        ...
        if (this.__P_197_0) {
          for (var name in this.__P_197_0) {
            var obj = this.__P_197_0[name];
       ...
       */
      __P_197_3: function __P_197_3(obj) {
        if (obj !== null) {
      ...
      getOwnedQxObjects: function getOwnedQxObjects() {
        return this.__P_197_0 ? Object.values(this.__P_197_0) : [];
      }
    }
  });
...
//# sourceMappingURL=MObjectId.js.map?dt=1613269688117