  ...
  qx.Class.define("qx.bom.webfonts.Validator", {
    ...
    */
    statics: {
      ...
      removeDefaultHelperElements: function removeDefaultHelperElements() {
        var defaultHelpers = qx.bom.webfonts.Validator.__P_246_2;
        ...
        delete qx.bom.webfonts.Validator.__P_246_2;
      }
    },
    ...
    members: {
      ...
      */
      ...
      validate: function validate() {
        this.__P_246_4 = new Date().getTime();

        if (this.__P_246_3) {
          this.__P_246_3.restart();
        } else {
          this.__P_246_3 = new qx.event.Timer(100);

          this.__P_246_3.addListener("interval", this.__P_246_5, this); // Give the browser a chance to render the new elements


          qx.event.Timer.once(function () {
            this.__P_246_3.start();
          }, this, 0);
        }
      },
      ...
      */
      ...
      _isFontValid: function _isFontValid() {
        if (!qx.bom.webfonts.Validator.__P_246_1) {
          this.__P_246_6();
        }
        ...
        if (requestedSans !== cls.__P_246_1.sans || requestedSerif !== cls.__P_246_1.serif) {
          return true;
        }
      ...
      */
      ...
      __P_246_6: function __P_246_6() {
        ...
        cls.__P_246_1 = {
          sans: qx.bom.element.Dimension.getWidth(cls.__P_246_2.sans),
          serif: qx.bom.element.Dimension.getWidth(cls.__P_246_2.serif)
        };
      },
      ...
      __P_246_5: function __P_246_5() {
        if (this._isFontValid()) {
          ...
          if (now - this.__P_246_4 >= this.getTimeout()) {
            this.__P_246_3.stop();
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_246_3.removeListener("interval", this.__P_246_5, this);

      this._disposeObjects("__P_246_3");
    }
  });
  qx.bom.webfonts.Validator.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Validator.js.map?dt=1613269691064