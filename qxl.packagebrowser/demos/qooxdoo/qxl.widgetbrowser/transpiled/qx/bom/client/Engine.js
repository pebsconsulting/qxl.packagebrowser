  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_73_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_73_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_73_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_73_3()) {
      ...
      __P_73_0: function __P_73_0() {
        ...
        if (qx.bom.client.Engine.__P_73_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613269679869