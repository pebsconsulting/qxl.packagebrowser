  ...
  qx.Bootstrap.define("qx.bom.Label", {
    ...
    */
    statics: {
       ...
       */
      __P_72_2: function __P_72_2(html) {
       ...
       */
      __P_72_4: function __P_72_4(html) {
        var styles = {};
      ...
      create: function create(content, html, win) {
        ...
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
          ...
          qx.bom.element.Style.setStyles(el, this.__P_72_4(html));
        }
      ...
      setValue: function setValue(element, value) {
        ...
        if (element.useHtml) {
          if (qx.bom.Label.__P_72_5 && typeof qx.bom.Label.__P_72_5 === "function") {
            value = qx.bom.Label.__P_72_5(value);
          }
      ...
      getHtmlSize: function getHtmlSize(content, styles, width) {
        var element = this._htmlElement || this.__P_72_3(); // apply width


        element.style.width = width != undefined ? width + "px" : "auto"; // insert content

        element.innerHTML = content;
        return this.__P_72_6(element, styles);
      },
      ...
      getTextSize: function getTextSize(text, styles) {
        var element = this._textElement || this.__P_72_1();
       ...
       * @return {Map} A map with preferred <code>width</code> and <code>height</code>.
       */
      __P_72_6: function __P_72_6(element, styles) {
        // sync styles
        var keys = this.__P_72_0;
...
//# sourceMappingURL=Label.js.map?dt=1613269679840