    ...
    statics: {
      ...
      addClasses: {
        ...
        "default": function _default(element, classes) {
          ...
          if (old) {
            result = old.split(this.__P_160_0);
      ...
      removeClasses: {
        ...
        "default": function _default(element, classes) {
          ...
          return element.className = element.className.replace(reg, "").replace(this.__P_160_1, "").replace(this.__P_160_0, " ");
        }
      }[qx.core.Environment.get("html.classlist") ? "native" : "default"],
...
//# sourceMappingURL=Class.js.map?dt=1613267878651