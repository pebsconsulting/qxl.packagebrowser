  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_25_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_25_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_25_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_25_3()) {
      ...
      __P_25_0: function __P_25_0() {
        ...
        if (qx.bom.client.Engine.__P_25_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613267864820