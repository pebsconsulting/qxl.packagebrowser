    ...
    members: {
      ...
      _applyQxObjectId: function _applyQxObjectId(value, oldValue) {
        if (!this.__P_97_1) {
          ...
          if (owner) {
            owner.__P_97_2(this, value, oldValue);
          }
       ...
       */
      __P_97_2: function __P_97_2(obj, newId, oldId) {
        delete this.__P_97_0[oldId];
        this.__P_97_0[newId] = obj;
      },
      ...
      _cascadeQxObjectIdChanges: function _cascadeQxObjectIdChanges() {
        ...
        if (this.__P_97_0) {
          for (var name in this.__P_97_0) {
            var obj = this.__P_97_0[name];
       ...
       */
      __P_97_3: function __P_97_3(obj) {
        if (obj !== null) {
      ...
      getOwnedQxObjects: function getOwnedQxObjects() {
        return this.__P_97_0 ? Object.values(this.__P_97_0) : [];
      }
    }
  });
...
//# sourceMappingURL=MObjectId.js.map?dt=1613267872136