      ...
      moveToCell: function moveToCell(col, row, editing) {
        ...
        if (col == null) {
          ...
          if (xPos === -1) {
            ...
            if (editing && this.__P_177_0.getMinCellEditHeight() && this.__P_177_0.getMinCellEditHeight() > userHeight) {
              userTop -= Math.floor((this.__P_177_0.getMinCellEditHeight() - userHeight) / 2);
              userHeight = this.__P_177_0.getMinCellEditHeight();
            }
...
//# sourceMappingURL=FocusIndicator.js.map?dt=1613269644176