    ...
    */
    members: {
      ...
      _updateSingleRow: function _updateSingleRow(row) {
        ...
        this.__P_173_4.innerHTML = "<div>" + this._getRowsHtml(row, 1) + "</div>";
        var newTableRows = this.__P_173_4.firstChild.childNodes;
...
//# sourceMappingURL=Pane.js.map?dt=1613269643904