  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.playground.view.RiaPlayArea", {
    ...
    construct: function construct() {
      ...
      this.__P_436_0 = new qx.ui.basic.Label().set({
        font: "bold",
        padding: 7,
        allowGrowX: true,
        allowGrowY: true
      ...
      this._caption.add(this.__P_436_0);
      ...
      this.__P_436_1 = new qx.ui.container.Scroll();

      this.__P_436_1.getChildControl("scrollbar-x");

      this.__P_436_1.getChildControl("scrollbar-y");

      this.__P_436_1.getChildControl("corner");

      this._dummy = new qx.ui.core.Widget();

      this.__P_436_1.add(this._dummy);

      this.add(this.__P_436_1, {
        flex: 1
      });
    },
    events: {
    ...
    members: {
      ...
      init: function init() {
        ...
        this._playRoot.getLayoutParent = function () {
          return self.__P_436_1;
        };

        this.__P_436_1.getChildren = this.__P_436_1._getChildren = function () {
          return [self._playRoot];
        }; // copy the initial size which is availbale due to the flush at the beginning


        this._playRoot.setMinWidth(this.__P_436_1.getBounds().width);

        this._playRoot.setMinHeight(this.__P_436_1.getBounds().height);

        this.__P_436_1.addListener("resize", function (e) {
          var data = e.getData();
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_436_0", "__P_436_1", "_dummy", "_playRoot", "_playApp");
    }
  });
  qxl.playground.view.RiaPlayArea.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=RiaPlayArea.js.map?dt=1613268598499