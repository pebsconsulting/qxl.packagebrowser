  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.tutorial.Application", {
    ...
    members: {
      ...
      main: function main() {
        // Call super class
        qxl.tutorial.Application.prototype.main.base.call(this); // Enable logging in debug variant
        ...
        this.__P_424_0 = new qxl.tutorial.view.Header();

        this.__P_424_0.addListener("selectTutorial", this.openSelectionWindow, this);

        mainComposite.add(this.__P_424_0); // create the content
        ...
        this.__P_424_3 = new qxl.tutorial.view.Description();

        this.__P_424_3.addListener("run", this.run, this);

        this.__P_424_3.addListener("update", this.updateEditor, this);

        content.add(this.__P_424_3, 1);
        var actionArea = new qx.ui.splitpane.Pane();
        this.__P_424_5 = actionArea;
        this.__P_424_2 = new qxl.playground.view.Editor();
        actionArea.add(this.__P_424_2);
        qxl.playground.view.Editor.loadAce(function () {
          this.__P_424_2.init();
        }, this);
        this.__P_424_1 = new qxl.playground.view.PlayArea();

        this.__P_424_1.setBackgroundColor("white");

        actionArea.add(this.__P_424_1);

        this.__P_424_1.updateCaption("");

        this.__P_424_1.addListener("toggleMaximize", function (e) {
          if (!this.__P_424_2.isExcluded()) {
            this.__P_424_2.exclude();

            this.__P_424_3.exclude();
          } else {
            this.__P_424_2.show();
        ...
        content.add(actionArea, 3); // set the blocker color
      ...
      openSelectionWindow: function openSelectionWindow() {
        if (!this.__P_424_4) {
          this.__P_424_4 = new qxl.tutorial.view.SelectionWindow(this.__P_424_6, this.__P_424_7);

          this.__P_424_4.addListener("changeTutorial", this.__P_424_9, this);
        }
      ...
      __P_424_9: function __P_424_9(e) {
        ...
        this.__P_424_2.setCode("");

        this.__P_424_2.setError();

        this.__P_424_1.reset();
      ...
      confirm: function confirm(text, callback, ctx) {
        if (!this.__P_424_8) {
          this.__P_424_8 = new qxl.tutorial.view.Confirm();
        }

        if (this.__P_424_8.getIgnore()) {
          callback.call(ctx, {
        ...
        this.__P_424_8.setMessage(text);
        ...
        if (qxl.tutorial.Application.allowFade()) {
          this.__P_424_8.fadeIn(300);
        } else {
          this.__P_424_8.show();
        }

        this.__P_424_8.addListenerOnce("confirm", callback, ctx);
      },
      run: function run() {
        var code = this.__P_424_2.getCode(); // don't run if we have no code
        ...
        var exc; // try to create a function
        ...
        try {
          // run the application
          this.fun.call(this.__P_424_1.getApp());
        } catch (ex) {
          exc = ex;
        }

        if (exc) {
          this.__P_424_2.setBackgroundColor("#FFF0F0");

          this.__P_424_2.setError(exc);

          this.error(exc);
        } else {
          this.__P_424_2.setError();

          this.__P_424_2.setBackgroundColor("white");
        }
      },
      ...
      loadTutorial: function loadTutorial(name, type) {
        ...
        req.addListener("success", function (e) {
          ...
          this.__P_424_3.setTutorial(this.parseTutorial(name, type, req.getResponse()));

          this.__P_424_1.updateCaption(name.replace(/_/g, " ") + " (" + type + ")");

          this.__P_424_1.setMode(type !== "desktop" ? "mobile" : "ria");

          this.__P_424_5.setOrientation(type == "desktop" ? "vertical" : "horizontal");
        }, this);
        req.send();
...
//# sourceMappingURL=Application.js.map?dt=1613268597889