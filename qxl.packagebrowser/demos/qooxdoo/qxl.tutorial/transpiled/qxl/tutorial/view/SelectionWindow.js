  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.tutorial.view.SelectionWindow", {
    ...
    construct: function construct(desktopTutorials, mobileTutorials) {
      qx.ui.window.Window.constructor.call(this, "Select Tutorial"); // configure window
      ...
      this.__P_430_0 = new qx.bom.Font(12, ["Lucida Grande", "DejaVu Sans", "Verdana", "sans-serif"]);
      ...
      this.__P_430_1(desktopTutorials, mobileTutorials);
    ...
    members: {
      __P_430_0: null,
      __P_430_2: function __P_430_2(name, desc) {
      ...
      __P_430_1: function __P_430_1(desktopTutorials, mobileTutorials) {
        var i = 0;
        ...
        for (var key in desktopTutorials) {
          ...
          var button = this.__P_430_2(name, desc);
        ...
        for (key in mobileTutorials) {
          ...
          var _button = this.__P_430_2(_name, _desc);
...
//# sourceMappingURL=SelectionWindow.js.map?dt=1613268598206