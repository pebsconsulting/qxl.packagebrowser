  ...
  ************************************************************************ */
  qx.Class.define("qxl.tutorial.view.Confirm", {
    ...
    construct: function construct(desktopTutorials, mobileTutorials) {
      qx.ui.window.Window.constructor.call(this, "Confirm"); // configure window
      ...
      this.getLayout().setColumnWidth(0, 200); // message

      this.__P_431_0 = new qx.ui.basic.Label();

      this.__P_431_0.setFont("bold");
      ...
      ignoreBox.bind("value", this, "ignore"); // cancel button
...
//# sourceMappingURL=Confirm.js.map?dt=1613268598225