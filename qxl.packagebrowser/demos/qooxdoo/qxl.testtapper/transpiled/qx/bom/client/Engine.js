  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_44_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_44_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_44_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_44_3()) {
      ...
      __P_44_0: function __P_44_0() {
        ...
        if (qx.bom.client.Engine.__P_44_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613268536534