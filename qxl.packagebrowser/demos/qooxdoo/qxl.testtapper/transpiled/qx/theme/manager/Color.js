    ...
    members: {
      ...
      __P_37_0: function __P_37_0(colors, name) {
        ...
        if (typeof color === "string") {
          ...
          return this.__P_37_0(colors, color(name));
      ...
      resolve: function resolve(value) {
        ...
        if (theme !== null && theme.colors[value]) {
          return cache[value] = this.__P_37_0(theme.colors, value);
        }
      ...
      isDynamic: function isDynamic(value) {
        ...
        if (theme !== null && value && theme.colors[value] !== undefined) {
          cache[value] = this.__P_37_0(theme.colors, value);
          return true;
        }
...
//# sourceMappingURL=Color.js.map?dt=1613268536266