  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.testrunner.runner.TestItem", {
    ...
    statics: {
       ...
       */
      sortFunction: function sortFunction(aItem, bItem) {
        var aType = aItem.getType();
        var bType = bItem.getType(); // always sort packages before classes
    ...
    members: {
       ...
       */
      getStackTrace: function getStackTrace(ex) {
        var trace = [];
       ...
       */
      _applyState: function _applyState(newState, oldState) {
        if (oldState) {
  ...
  qxl.testrunner.runner.TestItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=TestItem.js.map?dt=1613268459688