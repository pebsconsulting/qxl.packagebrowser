  ...
  qx.Class.define("qxl.testrunner.runner.TestRunner", {
    ...
    */
    construct: function construct() {
      ...
      qxl.testrunner.runner.TestRunnerBasic.constructor.call(this); // Get log appender element from view

      if (this.view.getLogAppenderElement) {
        this.__P_164_0 = new qx.log.appender.Element();
        qx.log.Logger.unregister(this.__P_164_0);

        this.__P_164_0.setElement(this.view.getLogAppenderElement());

        if (this._origin != "iframe") {
          qx.log.Logger.register(this.__P_164_0);
        }
      }
    },
    ...
    */
    members: {
      ...
      _loadTests: function _loadTests() {
        switch (this._origin) {
          case "iframe":
            ...
            this.__P_164_1 = this.view.getIframe();
            qx.event.Registration.addListener(this.__P_164_1, "load", this._onLoadIframe, this);
          ...
          case "push":
            var pushType = "code"; //var pushType = "uri";

            if (pushType == "uri") {
              this.__P_164_1 = this.view.getIframe();
              this.frameWindow = qx.bom.Iframe.getWindow(this.__P_164_1);
              ...
              req.addListener("success", function (e) {
                ...
                this.__P_164_1 = this.view.getIframe();
                var doc = qx.bom.Iframe.getDocument(this.__P_164_1);
                var el = doc.createElement("script");
                el.text = test;
                doc.getElementsByTagName("head")[0].appendChild(el);
                this.loader = qx.bom.Iframe.getWindow(this.__P_164_1).qxl.testrunner.TestLoader.getInstance();
      ...
      _runTests: function _runTests() {
        if (this.__P_164_0) {
          this.__P_164_0.clear();
        }

        qxl.testrunner.runner.TestRunner.prototype._runTests.base.call(this);
      },
      _getTestResult: function _getTestResult() {
        if (this._origin == "iframe" || this._origin == "push") {
          var frameWindow = qx.bom.Iframe.getWindow(this.__P_164_1);
      ...
      _onTestEnd: function _onTestEnd(ev) {
        ...
        qxl.testrunner.runner.TestRunner.prototype._onTestEnd.base.call(this);
      },
      ...
      _onLoadIframe: function _onLoadIframe(ev) {
        ...
        if (this.__P_164_2 <= 300) {
          // Detect failure to access frame after some period of time
          if (!this.frameWindow.body) {
            if (this.__P_164_2 >= 20 && window.location.protocol == "file:") {
              alert("Failed to load application from the file system.\n\nThe security settings of your browser may prohibit to access frames loaded using the file protocol. Please try the http protocol instead."); // Quit
          ...
          if (!this.frameWindow.qxl || !this.frameWindow.qxl.testrunner) {
            this.__P_164_3 = qx.event.Timer.once(this._onLoadIframe, this, 100);
            return;
          }

          this.loader = this.frameWindow.qxl.testrunner.TestLoader.getInstance(); // Avoid errors in slow browsers
      ...
      __P_164_4: function __P_164_4() {
        var w = qx.bom.Iframe.getWindow(this.__P_164_1);
        var logger;
        ...
        if (w.qx && w.qx.log && w.qx.log.Logger) {
          ...
          logger.register(this.__P_164_0);
          logger.clear();
          logger.unregister(this.__P_164_0);
        }
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__P_164_0", "__P_164_3");

      this.__P_164_1 = null;
      delete this.__P_164_1;
...
//# sourceMappingURL=TestRunner.js.map?dt=1613268434761