  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.testrunner.runner.ModelUtil", {
    ...
    statics: {
       ...
       */
      createModelData: function createModelData(testRep) {
        var data = {};
       ...
       */
      getItemsByProperty: function getItemsByProperty(model, property, value) {
       ...
       */
      getItemByFullName: function getItemByFullName(model, fullName) {
       ...
       */
      addDataFields: function addDataFields(model) {
        if (!model.parent) {
        ...
        if (model.getChildren) {
          ...
          for (var i = 0, l = kids.length; i < l; i++) {
            ...
            arguments.callee(child); // skip binding the children's state to the parent in old IEs to
       ...
       */
      addChainToMap: function addChainToMap(nsArr, obj) {
        if (nsArr.length == 0) {
          return;
        }
       ...
       */
      getNextSiblingOf: function getNextSiblingOf(node) {
        if (!node.parent) {
          return null;
        }
       ...
       */
      hasTestClassWithMixin: function hasTestClassWithMixin(node, mixin, win) {
  ...
  qxl.testrunner.runner.ModelUtil.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ModelUtil.js.map?dt=1613268436347