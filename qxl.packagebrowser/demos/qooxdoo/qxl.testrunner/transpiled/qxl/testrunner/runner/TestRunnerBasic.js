(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "qxl.testrunner.runner.TestItem": {},
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.testrunner.runner.TestRunnerBasic", {
    ...
    */
    members: {
       ...
       */
      _getTestNameSpace: function _getTestNameSpace() {
       ...
       */
      _resetSuite: function _resetSuite() {
        if (this.loader) {
          this.loader.dispose();
          this.loader = null;
        }
       ...
       */
      _addTestClass: function _addTestClass(membersMap) {
        this.setTestSuiteState("loading");
       ...
       */
      define: function define(membersMap) {
       ...
       */
      _loadExternalTests: function _loadExternalTests() {
        this._resetSuite();
       ...
       * representation data
       */
      _getTestModel: function _getTestModel() {
       ...
       * Testrunner's window.
       */
      _wrapAssertions: function _wrapAssertions(autWindow) {
        ...
        for (var prop in tCase) {
          if ((prop.indexOf("assert") == 0 || prop === "fail") && typeof tCase[prop] == "function") {
            ...
            tCase[originalName] = tCase[prop]; // create wrapped assertion func

            var body = "var argumentsArray = qx.lang.Array.fromArguments(arguments);try {this[arguments.callee.originalName].apply(this, argumentsArray);} catch(ex) {this.fireDataEvent(\"assertionFailed\", ex);}"; // need to use the AUT window's Function since IE 6/7/8 can't catch
       ...
       */
      _stopTests: function _stopTests() {
      ...
      runTests: function runTests() {
        ...
        var testResult = this.__P_415_2(currentTest);
      ...
      __P_415_2: function __P_415_2() {
        ...
        testResult.addListener("startTest", function (e) {
          ...
          if (!this.__P_415_0.includes(this.currentTestData.fullName)) {
            this.view.addTestResult(this.currentTestData);

            this.__P_415_0.push(this.currentTestData.fullName);
          }
        }, this);
       ...
       */
      _onTestWait: function _onTestWait(ev) {
       ...
       */
      _onTestFailure: function _onTestFailure(ev) {
        this.__P_415_3(this.currentTestData, ev.getData());
       ...
       */
      _onTestError: function _onTestError(ev) {
        this.__P_415_3(this.currentTestData, ev.getData());
       ...
       */
      _onTestSkip: function _onTestSkip(ev) {
        this.__P_415_3(this.currentTestData, ev.getData());
       ...
       */
      _onTestEndMeasurement: function _onTestEndMeasurement(ev) {
        this.__P_415_3(this.currentTestData, ev.getData());
       ...
       */
      __P_415_3: function __P_415_3(testResult, exceptions) {
       ...
       */
      _applySelectedTests: function _applySelectedTests(value, old) {
        if (!value) {
          return;
        }
       ...
       */
      _onChangeTestSelection: function _onChangeTestSelection() {
        this.testList = this._getFlatTestList(); // Make sure the value is applied even if it didn't change so the view is
        // updated
       ...
       */
      _getFlatTestList: function _getFlatTestList() {
       ...
       * @param ex
       */
      _handleGlobalError: function _handleGlobalError(ex) {
        this.error(ex);
      }
    },
  ...
  qxl.testrunner.runner.TestRunnerBasic.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=TestRunnerBasic.js.map?dt=1613268454113