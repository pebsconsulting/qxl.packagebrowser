  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.testrunner.view.widget.Widget", {
    ...
    construct: function construct() {
      ...
      mainContainer.add(this.__P_2_2()); // Toolbar

      mainContainer.add(this.__P_2_3()); // Main Pane
      // split
    ...
    members: {
      ...
      __P_2_3: function __P_2_3() {
        ...
        part1.add(runButton); // Stop button
        ...
        part1.add(stopButton); // Reload button
        ...
        nativeProfilingToggle.exclude(); // enable overflow handling
        ...
        toolbar.add(chevron);
        toolbar.setOverflowIndicator(chevron); // set priorities for overflow handling

        toolbar.setRemovePriority(part1, 2);
        toolbar.setRemovePriority(part3, 3);
        toolbar.setRemovePriority(autUriField, 1); // add the overflow menu

        this.__P_2_11 = new qx.ui.menu.Menu();
        chevron.setMenu(this.__P_2_11); // add the listener
      ...
      __P_2_5: function __P_2_5() {
        var layout = new qx.ui.layout.VBox(); //layout.setSeparator("separator-vertical");
      ...
      _getResultsMenuButton: function _getResultsMenuButton() {
        ...
        var resultsMenu = new qx.ui.menu.Menu(); // Stack trace toggle
      ...
      __P_2_32: function __P_2_32() {
        this.__P_2_23 = new qxl.logpane.LogPane(); //this.__logView.setShowLogLevel(true);
      ...
      _applyTestSuiteState: function _applyTestSuiteState(value, old) {
        switch (value) {
          ...
          case "ready":
            ...
            this.__P_2_12.setEnabled(true); // Don't apply the cookie selection if the previous state was
      ...
      addTestResult: function addTestResult(testResultData) {
        qxl.testrunner.view.widget.Widget.prototype.addTestResult.base.call(this, testResultData);
...
//# sourceMappingURL=Widget.js.map?dt=1613268420118