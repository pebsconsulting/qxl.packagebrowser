  ...
  qx.Class.define("qxl.testrunner.view.widget.TestResultView", {
    ...
    */
    members: {
       ...
       */
      __P_182_2: function __P_182_2(testResult) {
        ...
        if (!this.__P_182_1[testName]) {
          var resultElement = this._getResultElement(testName);

          this.__P_182_1[testName] = resultElement;
      ...
      _updateResultElement: function _updateResultElement(testResult) {
        ...
        var coll = this.__P_182_1[fullName];
        coll.removeAttribute("class").addClasses(["testResult", state]); //remove old error info
       ...
       * @return {void}
       */
      __P_182_0: function __P_182_0(value) {
...
//# sourceMappingURL=TestResultView.js.map?dt=1613268436178