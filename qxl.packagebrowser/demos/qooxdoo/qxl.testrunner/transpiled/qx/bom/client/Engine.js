  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_211_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_211_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_211_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_211_3()) {
      ...
      __P_211_0: function __P_211_0() {
        ...
        if (qx.bom.client.Engine.__P_211_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613268439329