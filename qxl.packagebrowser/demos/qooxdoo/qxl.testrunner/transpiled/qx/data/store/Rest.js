  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.store.Rest", {
    ...
    construct: function construct(resource, actionName, delegate) {
      ...
      this.__P_282_1 = qx.lang.Function.bind(this.__P_282_2, this);
    ...
    members: {
      ...
      __P_282_3: function __P_282_3() {
        ...
        if (resource && actionName) {
          resource.addListener(this.getActionName() + "Success", this.__P_282_1);
        }
      },
...
//# sourceMappingURL=Rest.js.map?dt=1613268443951