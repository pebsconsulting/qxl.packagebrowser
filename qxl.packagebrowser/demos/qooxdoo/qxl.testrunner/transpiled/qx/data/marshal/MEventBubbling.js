    ...
    members: {
      ...
      _registerEventChaining: function _registerEventChaining(value, old, name) {
        ...
        if (value instanceof qx.core.Object && qx.Class.hasMixin(value.constructor, qx.data.marshal.MEventBubbling)) {
          // create the listener
          var listener = qx.lang.Function.bind(this.__P_277_0, this, name); // add the listener
       ...
       *   change.
       */
      __P_277_0: function __P_277_0(name, e) {
        var data = e.getData();
...
//# sourceMappingURL=MEventBubbling.js.map?dt=1613268443576