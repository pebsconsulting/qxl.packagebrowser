  ...
  qx.Class.define("qx.ui.form.RadioGroup", {
    ...
    */
    ...
    construct: function construct(varargs) {
      ...
      this.__P_356_0 = []; // add listener before call add!!!

      this.addListener("changeSelection", this.__P_356_1, this);
    ...
    members: {
      ...
      */
      ...
      _applyGroupedProperty: function _applyGroupedProperty(value, old) {
        ...
        for (var i = 0; i < this.__P_356_0.length; i++) {
          item = this.__P_356_0[i]; // remove the listener for the old change event
      ...
      _applyInvalidMessage: function _applyInvalidMessage(value, old) {
        for (var i = 0; i < this.__P_356_0.length; i++) {
          this.__P_356_0[i].setInvalidMessage(value);
        }
      },
      // property apply
      _applyValid: function _applyValid(value, old) {
        for (var i = 0; i < this.__P_356_0.length; i++) {
          this.__P_356_0[i].setValid(value);
        }
      },
      // property apply
      ...
      */
      ...
      _isItemSelectable: function _isItemSelectable(item) {
        return this.__P_356_0.indexOf(item) != -1;
      },
...
//# sourceMappingURL=RadioGroup.js.map?dt=1613268450284