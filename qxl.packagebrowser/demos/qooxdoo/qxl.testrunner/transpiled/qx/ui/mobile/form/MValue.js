    ...
    members: {
      ...
      */
      ...
      _onChangeContent: function _onChangeContent(evt) {
        this.__P_472_3(this._convertValue(evt.getData()));
      },
      ...
      _onInput: function _onInput(evt) {
        ...
        if (this.getLiveUpdate()) {
          if (this._setValue) {
            ...
            this.__P_472_3(this._convertValue(data));
          }
        }
      },
...
//# sourceMappingURL=MValue.js.map?dt=1613268457415