        ...
        switch (id) {
          ...
          case "date-pane":
            ...
            for (var y = 0; y < 6; y++) {
              ...
              this.__P_349_2.push(label); // Add the day labels
      ...
      */
      ...
      _updateDatePane: function _updateDatePane() {
        ...
        for (var week = 0; week < 6; week++) {
          this.__P_349_2[week].setValue(weekFormat.format(helpDate));

          for (var i = 0; i < 7; i++) {
            var dayLabel = this.__P_349_1[week * 7 + i];
...
//# sourceMappingURL=DateChooser.js.map?dt=1613268449745