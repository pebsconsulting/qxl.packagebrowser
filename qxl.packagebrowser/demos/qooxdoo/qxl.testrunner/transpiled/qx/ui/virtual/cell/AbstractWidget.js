  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractWidget", {
    ...
    members: {
      ...
      _cleanupPool: function _cleanupPool() {
        var widget = this.__P_504_0.pop();

        while (widget) {
          widget.destroy();
          widget = this.__P_504_0.pop();
        }
      },
      ...
      __P_504_1: function __P_504_1() {
        var widget = this.__P_504_0.shift();
...
//# sourceMappingURL=AbstractWidget.js.map?dt=1613268459354