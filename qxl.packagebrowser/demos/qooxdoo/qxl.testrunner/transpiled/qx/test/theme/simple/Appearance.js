...
(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.theme.simple.Appearance", {
    ...
    members: (_members = {
      __P_80_0: qx.theme.simple.Appearance.appearances,
      testLabel: function testLabel() {
        var obj = this.__P_80_0.label;
      ...
      testTooltipError: function testTooltipError() {
        var obj = this.__P_80_0["tooltip-error"];
        var style = obj.style();
      ...
      testMoveFrame: function testMoveFrame() {
        var obj = this.__P_80_0["move-frame"];
        var style = obj.style();
        this.assertIdentical("main-dark", style.decorator);
      },
      testDragDropCursor: function testDragDropCursor() {
        var obj = this.__P_80_0["dragdrop-cursor"];
        var states = {
          copy: true,
          move: true,
          alias: true
      ...
      testSlideBarButtonForward: function testSlideBarButtonForward() {
        var style = this.__P_80_0["slidebar/button-forward"].style;
      ...
      testSlideBarButtonBackward: function testSlideBarButtonBackward() {
        var style = this.__P_80_0["slidebar/button-backward"].style;
      ...
      testTableStatusBar: function testTableStatusBar() {
        var style = this.__P_80_0["table/statusbar"].style();
      ...
      testTableColumnButton: function testTableColumnButton() {
        var style = this.__P_80_0["table/column-button"].style();
      ...
      testTableScrollerFocusIndicator: function testTableScrollerFocusIndicator() {
        var style = this.__P_80_0["table-scroller/focus-indicator"].style();

        this.assertIdentical("main", style.decorator);
      },
      testTableScrollerResizeLine: function testTableScrollerResizeLine() {
        var style = this.__P_80_0["table-scroller/resize-line"].style();
      ...
      testTableHeaderCell: function testTableHeaderCell() {
        var styleFunc = this.__P_80_0["table-header-cell"].style;
        var states = {
          first: true,
          disabled: true,
          sorted: true,
      ...
      testTableHeaderCellIcon: function testTableHeaderCellIcon() {
        var style = this.__P_80_0["table-header-cell/icon"].style();

        this.assertIdentical(5, style.paddingRight);
      },
      testTableHeaderCellSortIcon: function testTableHeaderCellSortIcon() {
        var style = this.__P_80_0["table-header-cell/sort-icon"].style();
      ...
      testTableEditorTextField: function testTableEditorTextField() {
        var style = this.__P_80_0["table-editor-textfield"].style();
      ...
      testProgressiveTableHeaderCell: function testProgressiveTableHeaderCell() {
        var style = this.__P_80_0["progressive-table-header-cell"].style();
      ...
      testTreeVirtual: function testTreeVirtual() {
        var styleFunc = this.__P_80_0["treevirtual"].style;
        var superStyles = {
          padding: [3, 4]
        };
      ...
      testTreeVirtualFolder: function testTreeVirtualFolder() {
        var styleFunc = this.__P_80_0["treevirtual-folder"].style;
        var states = {
          opened: true,
          drag: true
        };
      ...
      testTreeVirtualFile: function testTreeVirtualFile() {
        var styleFunc = this.__P_80_0["treevirtual-file"].style;
      ...
      testTreeVirtualLine: function testTreeVirtualLine() {
        var style = this.__P_80_0["treevirtual-line"].style();
      ...
      testTreeVirtualContract: function testTreeVirtualContract() {
        var style = this.__P_80_0["treevirtual-contract"].style();
      ...
      testTreeVirtualExpand: function testTreeVirtualExpand() {
        var style = this.__P_80_0["treevirtual-expand"].style();
      ...
      testTreeVirtualOnlyContract: function testTreeVirtualOnlyContract() {
        var style = this.__P_80_0["treevirtual-only-contract"].style();
      ...
      testTreeVirtualOnlyExpand: function testTreeVirtualOnlyExpand() {
        var style = this.__P_80_0["treevirtual-only-expand"].style();
      ...
      testTreeVirtualStartContract: function testTreeVirtualStartContract() {
        var style = this.__P_80_0["treevirtual-start-contract"].style();
      ...
      testTreeVirtualStartExpand: function testTreeVirtualStartExpand() {
        var style = this.__P_80_0["treevirtual-start-expand"].style();
      ...
      testTreeVirtualEndContract: function testTreeVirtualEndContract() {
        var style = this.__P_80_0["treevirtual-end-contract"].style();
      ...
      testTreeVirtualEndExpand: function testTreeVirtualEndExpand() {
        var style = this.__P_80_0["treevirtual-end-expand"].style();
      ...
      testTreeVirtualCrossContract: function testTreeVirtualCrossContract() {
        var style = this.__P_80_0["treevirtual-cross-contract"].style();
      ...
      testTreeVirtualCrossExpand: function testTreeVirtualCrossExpand() {
        var style = this.__P_80_0["treevirtual-cross-expand"].style();
      ...
      testTreeVirtualEnd: function testTreeVirtualEnd() {
        var style = this.__P_80_0["treevirtual-end"].style();
      ...
      testTreeVirtualCross: function testTreeVirtualCross() {
        var style = this.__P_80_0["treevirtual-cross"].style();
      ...
      var style = this.__P_80_0["resizer"].style();

      this.assertIdentical("main-dark", style.decorator);
    }), _defineProperty(_members, "testSplitpaneSplitter", function testSplitpaneSplitter() {
      var style = this.__P_80_0["splitpane/splitter"].style();
      ...
      var styleFunc = this.__P_80_0["splitpane/splitter/knob"].style;
      var states = {
        horizontal: true
      };
      var style = styleFunc(states);
      ...
      var style = this.__P_80_0["splitpane/slider"].style();
      ...
      var styleFunc = this.__P_80_0["menu"].style;
      var states = {
        submenu: true,
        contextmenu: true
      };
      ...
      var styleFunc = this.__P_80_0["menu-slidebar-button"].style;
      var style = styleFunc({
        hovered: true
      });
      ...
      var styleFunc = this.__P_80_0["menu-slidebar/button-backward"].style;
      var style = styleFunc({
        hovered: true
      });
      ...
      var styleFunc = this.__P_80_0["menu-slidebar/button-forward"].style;
      var style = styleFunc({
        hovered: true
      });
      ...
      var style = this.__P_80_0["menu-separator"].style();
      ...
      var styleFunc = this.__P_80_0["menu-button"].style;
      ...
      var styleFunc = this.__P_80_0["menu-checkbox"].style;
      var states = {
        checked: true,
        selected: true
      };
      ...
      var styleFunc = this.__P_80_0["menu-radiobutton"].style;
      var states = {
        checked: true,
        selected: true
      };
      ...
      var style = this.__P_80_0["group-item"].style();
      ...
      var style = this.__P_80_0["cell-number"].style();
...
//# sourceMappingURL=Appearance.js.map?dt=1613268429106