  ...
  qx.Class.define("qx.test.html.Iframe", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_52_0 = new qx.html.Root(helper);

        this.__P_52_0.setAttribute("id", "doc");

        var frame = this.__P_52_1 = new qx.html.Iframe();

        this.__P_52_0.add(frame); // Source in parent directory is not of same origin
        // when using file protocol – use non-existing file
        // in same directory instead


        if (window.location.protocol === "file:") {
          this.__P_52_3 = "blank.html";
        } else {
          this.__P_52_3 = qx.util.ResourceManager.getInstance().toUri("qx/static/blank.html");
        }
      },
      "test: set source to URL with same origin": function testSetSourceToURLWithSameOrigin() {
        var frame = this.__P_52_1;
        var source = this.__P_52_3;
      ...
      "test: update source on navigate": function testUpdateSourceOnNavigate() {
        var frame = this.__P_52_1; // As soon as the original frame has loaded,
...
//# sourceMappingURL=Iframe.js.map?dt=1613268426207