  ...
  qx.Class.define("qx.test.bom.AnimationFrame", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_7_0 = new qx.bom.AnimationFrame();
      },
      testStart: function testStart() {
        var clb = this.spy();

        this.__P_7_0.once("frame", clb);

        this.__P_7_0.startSequence(300);
...
//# sourceMappingURL=AnimationFrame.js.map?dt=1613268421157