  ...
  qx.Class.define("qx.test.ui.form.FormManager", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_107_0 = new qx.ui.form.Form();
        this.__P_107_1 = new qx.ui.form.TextField();
        this.__P_107_2 = new qx.ui.form.TextField();
      },
      tearDown: function tearDown() {
        this.__P_107_2.dispose();

        this.__P_107_1.dispose();

        this.__P_107_0.dispose();
      },
      testValidationContext: function testValidationContext() {
        var self = this; // add the widgets

        this.__P_107_0.add(this.__P_107_2, "TF2", function () {
          self.assertEquals(1, this.a);
        }, null, {
          a: 1
        });

        this.__P_107_0.validate();
      },
      testAddTwo: function testAddTwo() {
        // add the widgets
        this.__P_107_0.add(this.__P_107_1, "TF1");

        this.__P_107_0.add(this.__P_107_2, "TF2"); // get the view


        var view = new qx.test.DummyFormRenderer(this.__P_107_0); // check the items

        this.assertEquals(view.groups[0].items[0], this.__P_107_1);
        this.assertEquals(view.groups[0].items[1], this.__P_107_2); // check the names
      ...
      testRemove: function testRemove() {
        ...
        this.assertEquals(view.groups[0].items[0], this.__P_107_1);
        this.assertEquals(view.groups[0].items[1], this.__P_107_2);
        view.dispose(); // remove twice to see if the remove is reported correctly

        this.assertTrue(this.__P_107_0.remove(this.__P_107_1));
        this.assertFalse(this.__P_107_0.remove(this.__P_107_1)); // get the view

        var view = new qx.test.DummyFormRenderer(this.__P_107_0); // check the items

        this.assertEquals(view.groups[0].items[0], this.__P_107_2);
        view.dispose();
      },
      testAddTwoWithValidator: function testAddTwoWithValidator() {
        // add the widgets
        this.__P_107_1.setRequired(true);

        this.__P_107_0.add(this.__P_107_1, "TF1");

        this.__P_107_0.add(this.__P_107_2, "TF2", qx.util.Validate.email()); // validation should fail


        this.assertFalse(this.__P_107_0.validate());
        this.assertFalse(this.__P_107_1.getValid());
        this.assertFalse(this.__P_107_2.getValid()); // correct the values

        this.__P_107_1.setValue("a");

        this.__P_107_2.setValue("ab@cd.ef"); // validation should be ok


        this.assertTrue(this.__P_107_0.validate());
        this.assertTrue(this.__P_107_1.getValid());
        this.assertTrue(this.__P_107_2.getValid()); // check the validation manager itself

        this.assertTrue(this.__P_107_0.getValidationManager().validate());
      },
      testAddTwoWithHeader: function testAddTwoWithHeader() {
        this.__P_107_0.addGroupHeader("affe"); // add the widgets
      ...
      testRemoveHeader: function testRemoveHeader() {
        this.__P_107_0.addGroupHeader("affe0");

        this.__P_107_0.add(this.__P_107_1, "TF1");

        this.__P_107_0.addGroupHeader("affe1");
        ...
        this.assertEquals(view.groups[0].items[0], this.__P_107_1);
        this.assertEquals(view.groups[1].items[0], this.__P_107_2); // check the title

        this.assertEquals("affe0", view.groups[0].title);
        this.assertEquals("affe1", view.groups[1].title);
        view.dispose(); // remove twice to see if the remove is reported correctly

        this.assertTrue(this.__P_107_0.removeGroupHeader("affe1"));
        this.assertFalse(this.__P_107_0.removeGroupHeader("affe1")); // get the view
      ...
      testAddTwoWithTwoGroups: function testAddTwoWithTwoGroups() {
        this.__P_107_0.addGroupHeader("affe");

        this.__P_107_0.add(this.__P_107_1, "TF1");

        this.__P_107_0.addGroupHeader("affee");
        ...
        this.assertEquals(view.groups[0].items[0], this.__P_107_1);
        this.assertEquals(view.groups[1].items[0], this.__P_107_2); // check the names
      ...
      testAddTwoButtons: function testAddTwoButtons() {
        ...
        this.__P_107_0.addButton(b1);

        this.__P_107_0.addButton(b2); // get the view


        var view = new qx.test.DummyFormRenderer(this.__P_107_0); // check the buttons
      ...
      testRemoveButton: function testRemoveButton() {
        ...
        this.assertTrue(this.__P_107_0.removeButton(b1));
        this.assertFalse(this.__P_107_0.removeButton(b1)); // get the view

        var view = new qx.test.DummyFormRenderer(this.__P_107_0); // check the button
      ...
      testAddTwoWithButtons: function testAddTwoWithButtons() {
        ...
        this.__P_107_0.add(this.__P_107_2, "TF2");
      ...
      testAddTwoWithOptions: function testAddTwoWithOptions() {
        // add the widgets
        this.__P_107_0.add(this.__P_107_1, "TF1", null, "tf1", null, {
          a: 1
        });

        this.__P_107_0.add(this.__P_107_2, "TF2", null, "tf2", null, {
          a: 2
        }); // get the view
      ...
      testAddTwoWithButtonsOptions: function testAddTwoWithButtonsOptions() {
        ...
        this.__P_107_0.addButton(b2, {
          a: 2
        }); // get the view


        var view = new qx.test.DummyFormRenderer(this.__P_107_0); // check the buttons options
      ...
      testAddTwoWithHeaderOptions: function testAddTwoWithHeaderOptions() {
        ...
        var view = new qx.test.DummyFormRenderer(this.__P_107_0); // check the title
      ...
      testResetter: function testResetter() {
        ...
        this.__P_107_1.setValue("aaaa");

        this.__P_107_2.setValue("bbbb"); // add the widgets


        this.__P_107_0.add(this.__P_107_1, "TF1");

        this.__P_107_0.add(this.__P_107_2, "TF2"); // set some other values


        this.__P_107_1.setValue("111");

        this.__P_107_2.setValue("222");

        this.__P_107_0.reset(); // check


        this.assertEquals("aaaa", this.__P_107_1.getValue());
        this.assertEquals("bbbb", this.__P_107_2.getValue());
      },
      testAll: function testAll() {
        ...
        for (var i = 0; i < widgets.length; i++) {
          this.__P_107_0.add(widgets[i], "name" + i);
        } // reset


        this.__P_107_0.reset(); // validate


        this.assertTrue(this.__P_107_0.validate()); // get rid of the widgets
      ...
      testGetItems: function testGetItems() {
        // add the widgets
        this.__P_107_0.add(this.__P_107_1, "TF1", null, "a");

        this.__P_107_0.add(this.__P_107_2, "TF2", null, "b");

        var items = this.__P_107_0.getItems();

        this.assertEquals(items.a, this.__P_107_1);
        this.assertEquals(items.b, this.__P_107_2);
      },
      testGetItemsFallback: function testGetItemsFallback() {
        // add the widgets
        this.__P_107_0.add(this.__P_107_1, "TF1");

        this.__P_107_0.add(this.__P_107_2, "T F 2");

        var items = this.__P_107_0.getItems();

        this.assertEquals(items.TF1, this.__P_107_1);
        this.assertEquals(items.TF2, this.__P_107_2);
      },
      testGetItemsMixedWithGroups: function testGetItemsMixedWithGroups() {
        ...
        this.__P_107_0.addGroupHeader("x");

        var tf3 = new qx.ui.form.TextField();

        this.__P_107_0.add(tf3, "TF3");
      ...
      testRedefineResetter: function testRedefineResetter() {
        ...
        this.__P_107_0.redefineResetter();
      },
      testEvent: function testEvent() {
        var handler = this.spy();

        this.__P_107_0.addListener("change", handler);

        this.__P_107_0.add(this.__P_107_1, "TF1");

        this.assertCalledOnce(handler);

        this.__P_107_0.addGroupHeader("GROUP");
      ...
      testSingleRenderer: function testSingleRenderer() {
        ...
        this.__P_107_0.addGroupHeader("header");

        this.__P_107_0.add(this.__P_107_1, "TF1");

        this.__P_107_0.addButton(b1); // just check if the renderer is created without an error


        new qx.ui.form.renderer.Single(this.__P_107_0).dispose();
        b1.dispose();
      },
      testSinglePlaceholderRenderer: function testSinglePlaceholderRenderer() {
        ...
        new qx.ui.form.renderer.SinglePlaceholder(this.__P_107_0).dispose();
        b1.dispose();
      },
      testDoubleRenderer: function testDoubleRenderer() {
        ...
        new qx.ui.form.renderer.Double(this.__P_107_0).dispose();
        b1.dispose();
      },
      testGetItem: function testGetItem() {
        ...
        this.__P_107_0.add(f1, "a");

        this.__P_107_0.add(f2, "c");

        this.__P_107_0.add(f3, "label", null, "x");

        this.assertIdentical(f1, this.__P_107_0.getItem("a"));
        this.assertNull(this.__P_107_0.getItem("b"));
        this.assertIdentical(f2, this.__P_107_0.getItem("c"));
        this.assertNull(this.__P_107_0.getItem("label"));
        this.assertIdentical(f3, this.__P_107_0.getItem("x"));
...
//# sourceMappingURL=FormManager.js.map?dt=1613268430573