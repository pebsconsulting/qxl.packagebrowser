(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.ModelSelection", {
    ...
    members: {
      __P_113_0: function __P_113_0(widget, children) {
      ...
      __P_113_1: function __P_113_1(widget, children) {
        var children = children || widget.getChildren(); // check the model selection
      ...
      __P_113_2: function __P_113_2(widget, children) {
      ...
      __P_113_3: function __P_113_3(widget, children) {
        var children = children || widget.getChildren(); // check the set selection
      ...
      __P_113_5: function __P_113_5(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_113_8: function __P_113_8(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_113_11: function __P_113_11(box) {
      ...
      testListGetSingle: function testListGetSingle() {
        var list = this.__P_113_6();

        this.__P_113_0(list);

        this.__P_113_11(list);
      },
      ...
      testTreeGetSingle: function testTreeGetSingle() {
        var widget = this.__P_113_10();

        var children = widget.getItems(true);

        this.__P_113_0(widget, children);
      ...
      testTreeSetSingle: function testTreeSetSingle() {
        ...
        this.__P_113_2(widget, children);
      ...
      testTreeGetMulti: function testTreeGetMulti() {
        ...
        this.__P_113_1(widget, children);
      ...
      testTreeSetMulti: function testTreeSetMulti() {
        ...
        this.__P_113_3(widget, children);
...
//# sourceMappingURL=ModelSelection.js.map?dt=1613268430899