  ...
  qx.Class.define("qx.test.ui.tree.virtual.Sorting", {
    ...
    members: {
      testSorter: function testSorter() {
        ...
        this.__P_144_0(sortedModel, sorter);
        ...
        this.__P_144_1(expected); //this.__logModel(sortedModel);
      ...
      testModelUnmodified: function testModelUnmodified() {
        ...
        this.__P_144_2(rootChildrenClone.toArray(), root.getChildren().toArray());
      ...
      __P_144_0: function __P_144_0(model, sorter) {
        ...
        for (var i = 0; i < children.getLength(); i++) {
          ...
          if (child instanceof qx.test.ui.tree.virtual.Node) {
            this.__P_144_0(child, sorter);
          }
        }
      },
      __P_144_1: function __P_144_1(expected) {
      ...
      __P_144_2: function __P_144_2(expected, found) {
        var msg = "Expected [" + expected.join(", ") + "], but found [" + found.join(", ") + "]";
        this.assertEquals(expected.length, found.length, msg);
      ...
      ---------------------------------------------------------------------------
      */
      __P_144_3: function __P_144_3(model, level) {
        ...
        for (var i = 0; i < children.getLength(); i++) {
          this.__P_144_3(children.getItem(i), level + 1);
        }
      }
    }
  });
...
//# sourceMappingURL=Sorting.js.map?dt=1613268432735