  ...
  qx.Class.define("qx.test.ui.core.AbstractScrollArea", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_90_1 = new qx.ui.container.Composite(new qx.ui.layout.Grow());
        ...
        this.__P_90_0 = new qx.test.ui.core.AbstractScrollArea.fixture.CustomWidget();

        this.__P_90_1.add(this.__P_90_0);

        this.getRoot().add(this.__P_90_1);
      ...
      "test default behaviour": function testDefaultBehaviour() {
        ...
        this.__P_90_0.setSingleChild(inner);

        this.flush();
        this.assertBounds(inner, this.__P_90_0);
      },
      "test smaller widget than container": function testSmallerWidgetThanContainer() {
        ...
        this.flush();
        this.assertBounds(inner, this.__P_90_0);
        this.assertFalse(this.__P_90_0.hasScrollBar('x'));
        this.assertFalse(this.__P_90_0.hasScrollBar('y'));
      },
      "test bigger widget than container": function testBiggerWidgetThanContainer() {
        ...
        this.assertTrue(this.__P_90_0.hasScrollBar('x'));
        this.assertTrue(this.__P_90_0.hasScrollBar('y'));
      },
      ...
      "test bigger widget than smaller preferred container": function testBiggerWidgetThanSmallerPreferredContainer() {
        ...
        this.__P_90_1.resetMaxWidth();

        this.__P_90_1.resetMaxHeight();
...
//# sourceMappingURL=AbstractScrollArea.js.map?dt=1613268429883