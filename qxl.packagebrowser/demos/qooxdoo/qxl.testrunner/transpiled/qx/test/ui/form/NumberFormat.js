(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.NumberFormat", {
    ...
    members: {
      __P_114_0: function __P_114_0(widget) {
      ...
      testSpinner: function testSpinner() {
        this.__P_114_0(new qx.ui.form.Spinner());
      },
      testSlider: function testSlider() {
        this.__P_114_0(new qx.ui.form.Slider());
      }
    }
  });
...
//# sourceMappingURL=NumberFormat.js.map?dt=1613268430913