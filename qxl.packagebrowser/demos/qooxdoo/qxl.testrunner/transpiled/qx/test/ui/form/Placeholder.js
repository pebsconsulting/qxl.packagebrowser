(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.Placeholder", {
    ...
    members: {
      __P_115_0: function __P_115_0(clazz, childControlName) {
        var widget = new clazz();
        widget.setValue("affe");
        widget.setPlaceholder("aaa");
        this.getRoot().add(widget);
        this.flush();
        this.assertEquals("affe", this.__P_115_1(widget), "placeholder visible");
        this.assertEquals("affe", widget.getValue(), "Wrong value returned.");
        this.assertFalse(this.__P_115_2(widget));
        widget.destroy();
        widget = new clazz();
        widget.setPlaceholder("abc");
        this.getRoot().add(widget); // sync the appearance

        this.__P_115_3(widget);

        this.assertTrue(this.__P_115_2(widget));
        this.assertEquals("abc", this.__P_115_4(widget), "placeholder not visible");
        this.assertNull(widget.getValue(), "Wrong value returned."); // get rid of the widget

        widget.destroy();
      },
      __P_115_5: function __P_115_5(clazz) {
        var widget = new clazz();
        widget.setPlaceholder("abc");
        ...
        this.assertEquals("def", this.__P_115_1(widget), "wrong visible value");
        this.assertFalse(this.__P_115_2(widget)); // remove the value
        ...
        this.assertTrue(this.__P_115_2(widget));
        this.assertEquals("abc", this.__P_115_4(widget), "wrong visible value"); // get rid of the widget

        widget.destroy();
      },
      __P_115_6: function __P_115_6(clazz) {
        var widget = new clazz();
        widget.setPlaceholder("abc");
        ...
        widget.focus();
        this.flush();
        this.assertEquals("", this.__P_115_1(widget), "wrong visible value after focus");
        this.assertFalse(this.__P_115_2(widget), "1"); // test focus out
        ...
        window.setTimeout(function () {
          this.resume(function () {
            this.getRoot().focus();
            this.flush();
            this.assertTrue(this.__P_115_2(widget), "2");
            this.assertEquals("abc", this.__P_115_4(widget), "wrong visible value after blur"); // get rid of the widget
      ...
      __P_115_7: function __P_115_7(clazz) {
        var widget = new clazz();
        widget.setPlaceholder("abc");
        widget.setPlaceholder(null);
        this.assertFalse(this.__P_115_2(widget));
        this.assertNull(widget.getValue(), "wrong value");
        this.assertEquals("", this.__P_115_1(widget), "wrong visible value after focus"); // get rid of the widget

        widget.destroy();
      },
      __P_115_8: function __P_115_8(clazz) {
        var widget = new clazz();
        this.getRoot().add(widget);
        widget.setPlaceholder("abc");
        ...
        this.assertNull(widget.getValue(), "wrong value");
        this.assertFalse(this.__P_115_2(widget));
        this.assertEquals("", this.__P_115_1(widget), "wrong visible value");
      ...
      __P_115_9: function __P_115_9(widget) {
      ...
      __P_115_4: function __P_115_4(widget) {
      ...
      __P_115_2: function __P_115_2(widget) {
        var useQxPlaceholder = !qx.core.Environment.get("css.placeholder");
...
//# sourceMappingURL=Placeholder.js.map?dt=1613268430960