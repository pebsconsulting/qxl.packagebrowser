  ...
  qx.Class.define("qx.test.ui.decoration.LinearGradient", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_95_0 = new qx.ui.core.Widget();

        this.__P_95_0.setHeight(100);

        this.__P_95_1 = new qx.ui.decoration.Decorator();
        ...
        this.getRoot().add(this.__P_95_0);
      },
      tearDown: function tearDown() {
        this.__P_95_0.destroy();

        this.__P_95_1.dispose();
      },
      testDefault: function testDefault() {
        ...
        this.__P_95_0.setDecorator(this.__P_95_1);
...
//# sourceMappingURL=LinearGradient.js.map?dt=1613268430204