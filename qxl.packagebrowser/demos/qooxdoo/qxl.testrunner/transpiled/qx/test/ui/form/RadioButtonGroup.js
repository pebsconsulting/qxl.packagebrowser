  ...
  qx.Class.define("qx.test.ui.form.RadioButtonGroup", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_116_0 = new qx.ui.form.RadioButtonGroup();
        this.__P_116_1 = [];
        var radioButton;
        ...
        for (var i = 0, j = 10; i < j; i++) {
          ...
          this.__P_116_1.push(radioButton);

          this.__P_116_0.add(radioButton);
        }
      },
      ...
      testRemoveAll: function testRemoveAll() {
        ...
        var amountOfRadioButtons = this.__P_116_0.getRadioGroup().getItems().length;
...
//# sourceMappingURL=RadioButtonGroup.js.map?dt=1613268430973