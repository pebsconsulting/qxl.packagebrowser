(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.Color", {
    ...
    members: {
      __P_101_0: function __P_101_0(widget) {
      ...
      testColorSelector: function testColorSelector() {
        this.__P_101_0(new qx.ui.control.ColorSelector());
      },
      testColorPopup: function testColorPopup() {
        this.__P_101_0(new qx.ui.control.ColorPopup());
      }
    }
  });
...
//# sourceMappingURL=Color.js.map?dt=1613268430336