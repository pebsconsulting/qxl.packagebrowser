  ...
  qx.Class.define("qx.test.event.Emitter", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_47_0 = new qx.event.Emitter();
      },
      testOnOff: function testOnOff() {
        var spy = this.spy();

        this.__P_47_0.on("test", spy, this);

        this.__P_47_0.emit("test");

        this.assertCalledOnce(spy);
        this.assertCalledOn(spy, this);

        this.__P_47_0.off("test", spy, this);
      ...
      testOnOffById: function testOnOffById() {
        ...
        var id = this.__P_47_0.on("test", spy, this);

        this.__P_47_0.emit("test");

        this.assertCalledOnce(spy);

        this.__P_47_0.offById(id);
      ...
      testOffReturnId: function testOffReturnId() {
        ...
        var id = this.__P_47_0.on("test2", spy, this);

        var returnId = this.__P_47_0.off("test2", spy, this);
      ...
      testAddRemove: function testAddRemove() {
        ...
        this.__P_47_0.addListener("test", spy, this);

        this.__P_47_0.emit("test");

        this.assertCalledOnce(spy);

        this.__P_47_0.removeListener("test", spy, this);
      ...
      testAddAsyncFunction: function testAddAsyncFunction() {
        ...
        this.__P_47_0.addListener("test", f, this);

        this.__P_47_0.emit("test");

        this.__P_47_0.removeListener("test", f, this);
      ...
      testAddRemoveById: function testAddRemoveById() {
        ...
        var id = this.__P_47_0.addListener("test", spy, this);

        this.__P_47_0.emit("test");

        this.assertCalledOnce(spy);

        this.__P_47_0.removeListenerById(id);
      ...
      testOnTwoListeners: function testOnTwoListeners() {
        ...
        this.__P_47_0.on("test", spy1);

        this.__P_47_0.on("test", spy2);
      ...
      testTwoEvents: function testTwoEvents() {
        ...
        this.__P_47_0.on("test1", spy1);

        this.__P_47_0.on("test2", spy2);

        this.__P_47_0.emit("test1");

        this.assertCalledOnce(spy1);
        this.assertNotCalled(spy2);

        this.__P_47_0.emit("test2");
      ...
      testAddListenerOnce: function testAddListenerOnce() {
        ...
        this.__P_47_0.addListenerOnce("test", spy);
      ...
      testEmitData: function testEmitData() {
        ...
        this.__P_47_0.on("test", spy);

        this.__P_47_0.emit("test", 123);
      ...
      testEmitOrder: function testEmitOrder() {
        ...
        this.__P_47_0.on("test", function () {
          i++;
...
//# sourceMappingURL=Emitter.js.map?dt=1613268425566