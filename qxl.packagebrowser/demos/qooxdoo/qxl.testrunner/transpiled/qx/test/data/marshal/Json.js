  ...
  qx.Class.define("qx.test.data.marshal.Json", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_38_0 = new qx.data.marshal.Json();
        this.__P_38_1 = {
          s: 'String',
          n: 12,
          b: true
      ...
      tearDown: function tearDown() {
        this.__P_38_0.dispose(); // remove the former created classes
      ...
      "test$$member": function test$$member() {
        ...
        this.__P_38_0.toClass(data); // check if the class is defined
      ...
      testLocalizedString: function testLocalizedString() {
        ...
        this.__P_38_0.toClass(data);

        var model = this.__P_38_0.toModel(data);
      ...
      testClassCreationSingle: function testClassCreationSingle() {
        this.__P_38_0.toClass(this.__P_38_1); // check if the class is defined
        ...
        for (var name in clazz.$$properties) {
          this.assertEquals(this.__P_38_2[i], name, "Property " + i + "does have the wrong name.");
          this.assertEquals("change" + qx.lang.String.firstUp(this.__P_38_2[i]), clazz.$$properties[name].event, "event has a wrong name.");
          i++;
        }
      },
      ...
      testClassCreationObject: function testClassCreationObject() {
        ...
        this.__P_38_0.toClass(this.__P_38_1); // check if the classes are defined
      ...
      testClassCreationAllSmoke: function testClassCreationAllSmoke() {
        ...
        this.__P_38_0.toClass(this.__P_38_1);
      },
      testModelWithNumber: function testModelWithNumber() {
        ...
        this.__P_38_0.toClass(this.__P_38_1); // set the data


        var model = this.__P_38_0.toModel(this.__P_38_1); // check the model
      ...
      testModelWithAllSmoke: function testModelWithAllSmoke() {
        ...
        var model = this.__P_38_0.toModel(this.__P_38_1);
      ...
      testBubbleEventsDepth1: function testBubbleEventsDepth1() {
        ...
        this.__P_38_0.toClass(this.__P_38_1, true); // set the data


        var model = this.__P_38_0.toModel(this.__P_38_1); // check the event for a
      ...
      testBubbleEventsDepth2: function testBubbleEventsDepth2() {
        ...
        var model = this.__P_38_0.toModel(this.__P_38_1); // check the event for b
      ...
      testBubbleEventsDepth3: function testBubbleEventsDepth3() {
        ...
        var model = this.__P_38_0.toModel(this.__P_38_1); // check the event for c
      ...
      testBubbleEventsArrayDepth1: function testBubbleEventsArrayDepth1() {
        ...
        var model = this.__P_38_0.toModel(this.__P_38_1); // check the event for the first array element
      ...
      testAddValidationRule: function testAddValidationRule() {
        ...
        this.__P_38_0.dispose();

        this.__P_38_0 = new qx.data.marshal.Json(delegate);

        this.__P_38_0.toClass(this.__P_38_1);

        var model = this.__P_38_0.toModel(this.__P_38_1); // check for the right class hash
...
//# sourceMappingURL=Json.js.map?dt=1613268424833