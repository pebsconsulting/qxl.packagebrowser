  ...
  qx.Class.define("qx.test.util.NumberFormat", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_159_1 = qx.locale.Manager.getInstance().getLocale();
        qx.locale.Manager.getInstance().setLocale("de_DE");
        this.__P_159_0 = new qx.util.format.NumberFormat();
      },
      tearDown: function tearDown() {
        this.__P_159_0.dispose();

        qx.locale.Manager.getInstance().setLocale(this.__P_159_1);
      },
      ...
      testNumberFormat: function testNumberFormat() {
        var nf = this.__P_159_0; // this failed due to a rounding error
...
//# sourceMappingURL=NumberFormat.js.map?dt=1613268434133