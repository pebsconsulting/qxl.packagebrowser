  ...
  qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      for (var field in stateInfo) {
        ...
        switch (field) {
          case "onentry":
            this.setOnentry(this.__P_509_0(stateInfo[field], context));
            break;

          case "onexit":
            this.setOnexit(this.__P_509_0(stateInfo[field], context));
            break;
    ...
    members: {
       ...
       */
      __P_509_1: function __P_509_1(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_509_2: function __P_509_2(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_509_3: function __P_509_3(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_509_8: function __P_509_8(value) {
       ...
       * @return {var} the final value
       */
      __P_509_4: function __P_509_4(value) {
       ...
       * @return {var} the final value
       */
      __P_509_5: function __P_509_5(value) {
       ...
       * @return {var} the final value
       */
      __P_509_6: function __P_509_6(value) {
       ...
       * @return {var} the final value
       */
      __P_509_7: function __P_509_7(value) {
       ...
       *   unaltered.
       */
      __P_509_0: function __P_509_0(f, context) {
...
//# sourceMappingURL=State.js.map?dt=1613268459530