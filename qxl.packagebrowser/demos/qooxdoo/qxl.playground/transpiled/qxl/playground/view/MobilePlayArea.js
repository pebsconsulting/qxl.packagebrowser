  ...
  qx.Class.define("qxl.playground.view.MobilePlayArea", {
    ...
    construct: function construct() {
      ...
      sizeSelect.addListener("changeSelection", function (e) {
        ...
        if (newRes) {
          this.__P_432_0(newRes[0], newRes[1]);
        } else {
          this.__P_432_0(null, null);
        }
      }, this);
    ...
    members: {
       ...
       */
      __P_432_0: function __P_432_0(width, height) {
      ...
      reset: function reset(beforeReg, afterReg, code) {
        ...
        this.__P_432_1 = new qx.ui.mobile.page.Manager(false, this._playRoot);
      }
    }
  });
...
//# sourceMappingURL=MobilePlayArea.js.map?dt=1613268347578