  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.playground.Samples", {
    ...
    construct: function construct(array) {
      ...
      for (var _i = textAreas.length - 1; _i >= 0; _i--) {
        if (textAreas[_i].className == "qx_samples") {
          var name = textAreas[_i].title.split("-")[0];

          var mode = textAreas[_i].title.split("-")[1];

          var code = textAreas[_i].value;
          var data = {
            name: name,
            code: code,
            mode: mode,
...
//# sourceMappingURL=Samples.js.map?dt=1613268347335