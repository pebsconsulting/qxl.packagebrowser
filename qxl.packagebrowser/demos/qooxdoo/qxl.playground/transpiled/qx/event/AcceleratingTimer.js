    ...
    members: {
      ...
      _onInterval: function _onInterval() {
        ...
        if (this.__P_110_1 == null) {
          this.__P_110_1 = this.getInterval();
        }

        this.__P_110_1 = Math.max(this.getMinimum(), this.__P_110_1 - this.getDecrease());
...
//# sourceMappingURL=AcceleratingTimer.js.map?dt=1613268323366