  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.EditDistance", {
    statics: {
       ...
       */
      __P_407_0: function __P_407_0(dataA, dataB) {
       ...
       */
      __P_407_1: function __P_407_1(distance, dataA, dataB) {
        var operations = [];
      ...
      getEditOperations: function getEditOperations(dataA, dataB) {
        var distance = this.__P_407_0(dataA, dataB);

        var operations = this.__P_407_1(distance, dataA, dataB);
...
//# sourceMappingURL=EditDistance.js.map?dt=1613268345868