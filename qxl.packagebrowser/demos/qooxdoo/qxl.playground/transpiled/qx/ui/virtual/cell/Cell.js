  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.cell.Cell", {
    ...
    construct: function construct() {
      ...
      this.__P_376_0 = qx.ui.virtual.cell.CellStylesheet.getInstance();
      this.__P_376_1 = {};
      this.__P_376_2 = {};
      this.__P_376_3 = {};
      this.__P_376_4 = {};
    ...
    */
    members: {
      ...
      _storeStyle: function _storeStyle(propertyName, styles) {
        ...
        if (this.__P_376_10) {
          store = this.__P_376_2;
        } else {
          store = this.__P_376_1;
        }
      ...
      _applyPadding: function _applyPadding(value, old, name) {
        ...
        if (this.__P_376_10) {
          var paddingStore = this.__P_376_4;
        } else {
          paddingStore = this.__P_376_3;
        }
      ...
      */
      ...
      getCssClasses: function getCssClasses(value, states) {
        var cssClass = this.__P_376_0.getCssClass(this.__P_376_9) || "";
       ...
       */
      __P_376_11: function __P_376_11(states) {
        ...
        if (this.__P_376_9 == statesKey) {
          return;
        }

        this.__P_376_9 = statesKey;
        var themeStyles = this.__P_376_5[this.__P_376_9];

        if (!themeStyles) {
          this.__P_376_12();

          this.__P_376_13(states);

          this.__P_376_14(states);

          this.__P_376_15();

          this.__P_376_5[this.__P_376_9] = 1;
        }
       ...
       */
      __P_376_12: function __P_376_12() {
        var PropertyUtil = qx.util.PropertyUtil;
       ...
       * @param states {Object} A map containing the cell's state names as map keys.
       */
      __P_376_13: function __P_376_13(states) {
        this.__P_376_2 = {};
        this.__P_376_10 = true;
        var appearance = this.getAppearance();
        var PropertyUtil = qx.util.PropertyUtil;
        ...
        this.__P_376_10 = false;
      },

      /**
       * Compute a CSS class for the current values of all CSS properties
       */
      __P_376_14: function __P_376_14() {
        var styleString = Object.values(this.__P_376_2).join(";");

        this.__P_376_0.computeClassForStyles(this.__P_376_9, styleString);
      },

      /**
       * Cache the themed values for the current state combination
       */
      __P_376_15: function __P_376_15() {
        var properties = this.__P_376_8;
        var PropertyUtil = qx.util.PropertyUtil;
        var themeValues = {};
        ...
        this.__P_376_6[this.__P_376_9] = themeValues;
      },

      /**
       * Apply the themed values to the properties
       */
      __P_376_16: function __P_376_16() {
        var PropertyUtil = qx.util.PropertyUtil;
        var themeValues = this.__P_376_6[this.__P_376_9] || {};
      ...
      getStyles: function getStyles(value, states) {
        return Object.values(this.__P_376_1).join(";");
      },
      // overridden
      getInsets: function getInsets(value, states) {
        var user = this.__P_376_3;
        var theme = this.__P_376_4;
    ...
    destruct: function destruct() {
      this.__P_376_0 = this.__P_376_1 = this.__P_376_2 = this.__P_376_3 = this.__P_376_4 = this.__P_376_5 = this.__P_376_6 = this.__P_376_8 = null;
    }
  });
  qx.ui.virtual.cell.Cell.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Cell.js.map?dt=1613268343781