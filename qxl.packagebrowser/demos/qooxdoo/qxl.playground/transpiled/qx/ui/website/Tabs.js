    ...
    members: {
      ...
      init: function init() {
        ...
        if (active.length > 0) {
          ...
          this.__P_395_1(activePage);

          this._showPage(active, null);

          this.__P_395_2(activePage);
        }
       ...
       */
      __P_395_1: function __P_395_1(elem) {
       ...
       * @param elem {qxWeb} Element
       */
      __P_395_2: function __P_395_2(elem) {
...
//# sourceMappingURL=Tabs.js.map?dt=1613268345272