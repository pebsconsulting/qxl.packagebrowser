    ...
    */
    ...
    construct: function construct(url, serviceName) {
      ...
      if (qx.core.ServerSettings) {
        this.__P_163_0 = qx.core.ServerSettings.serverPathSuffix;
      }
    },
    ...
    */
    members: {
        ...
        req.addListener("completed", function (evt) {
          ...
          if (exTest != null) {
            ...
            if (refreshSession) {
              ...
              if (self.__P_163_0 != newSuffix) {
                self.__P_163_1 = self.__P_163_0;
                self.__P_163_0 = newSuffix;
              }
      ...
      fixUrl: function fixUrl(url) {
        if (this.__P_163_1 == null || this.__P_163_0 == null || this.__P_163_1 == "" || this.__P_163_1 == this.__P_163_0) {
          return url;
        }

        var index = url.indexOf(this.__P_163_1);

        if (index == -1) {
          return url;
        }

        return url.substring(0, index) + this.__P_163_0 + url.substring(index + this.__P_163_1.length);
      },
...
//# sourceMappingURL=Rpc.js.map?dt=1613268047606