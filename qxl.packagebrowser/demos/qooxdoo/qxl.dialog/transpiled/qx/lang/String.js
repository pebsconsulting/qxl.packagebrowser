    ...
    statics: {
      ...
      capitalize: function capitalize(str) {
        if (this.__P_171_1 === null) {
          ...
          this.__P_171_1 = new RegExp("(^|[^" + this.__P_171_0.replace(/[0-9A-F]{4}/g, function (match) {
            return unicodeEscapePrefix + match;
          }) + "])[" + this.__P_171_0.replace(/[0-9A-F]{4}/g, function (match) {
            return unicodeEscapePrefix + match;
          }) + "]", "g");
        }

        return str.replace(this.__P_171_1, function (match) {
...
//# sourceMappingURL=String.js.map?dt=1613268048503