  ...
  qx.Class.define("qx.ui.mobile.core.EventHandler", {
    ...
    */
    statics: {
       ...
       */
      __P_291_6: function __P_291_6(domEvent) {
        if (!domEvent.isPrimary()) {
          return;
        }

        var EventHandler = qx.ui.mobile.core.EventHandler;
        EventHandler.__P_291_2 = qx.bom.Viewport.getScrollLeft();
        EventHandler.__P_291_3 = qx.bom.Viewport.getScrollTop();
        EventHandler.__P_291_4 = domEvent.getScreenTop();

        EventHandler.__P_291_7();
        ...
        EventHandler.__P_291_1 = target;
        EventHandler.__P_291_8 = window.setTimeout(function () {
          EventHandler.__P_291_8 = null;
          var target = EventHandler.__P_291_1;
       ...
       */
      __P_291_9: function __P_291_9(domEvent) {
        qx.ui.mobile.core.EventHandler.__P_291_10();
      },
       ...
       */
      __P_291_11: function __P_291_11(domEvent) {
        if (!domEvent.isPrimary()) {
          return;
        }
        ...
        var deltaY = domEvent.getScreenTop() - EventHandler.__P_291_4;

        if (EventHandler.__P_291_1 && Math.abs(deltaY) >= qx.event.handler.GestureCore.TAP_MAX_DISTANCE[domEvent.getPointerType()]) {
          EventHandler.__P_291_10();
        }

        if (EventHandler.__P_291_1 && (EventHandler.__P_291_2 != qx.bom.Viewport.getScrollLeft() || EventHandler.__P_291_3 != qx.bom.Viewport.getScrollTop())) {
          EventHandler.__P_291_10();
        }
      },
       ...
       */
      __P_291_7: function __P_291_7() {
        var EventHandler = qx.ui.mobile.core.EventHandler;

        if (EventHandler.__P_291_8) {
          window.clearTimeout(EventHandler.__P_291_8);
          EventHandler.__P_291_8 = null;
        }
      },
       ...
       */
      __P_291_10: function __P_291_10() {
        var EventHandler = qx.ui.mobile.core.EventHandler;

        EventHandler.__P_291_7();

        var activeTarget = EventHandler.__P_291_1;

        if (activeTarget) {
          qx.bom.element.Class.remove(activeTarget, "active");
        }

        EventHandler.__P_291_1 = null;
      }
    },
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(document, "pointerdown", statics.__P_291_6);
      qx.event.Registration.addListener(document, "pointerup", statics.__P_291_9);
      qx.event.Registration.addListener(document, "pointercancel", statics.__P_291_9);
      qx.event.Registration.addListener(document, "pointermove", statics.__P_291_11);
    }
  });
  qx.ui.mobile.core.EventHandler.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=EventHandler.js.map?dt=1613268059509