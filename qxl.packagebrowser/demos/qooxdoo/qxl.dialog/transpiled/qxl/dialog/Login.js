  ...
  qx.Class.define("qxl.dialog.Login", {
    ...
    members: {
      ...
      _createWidgetContent: function _createWidgetContent() {
        ...
        container.add(this._message); // buttons

        var buttonPane = this._createButtonPane(); // login


        var loginButton = this._loginButton = new qx.ui.form.Button(this.tr("Login"));
        loginButton.setAllowStretchX(false);
        loginButton.addListener("execute", this._callCheckCredentials, this); // cancel

        var cancelButton = this._createCancelButton(); // forgot password
...
//# sourceMappingURL=Login.js.map?dt=1613268069907