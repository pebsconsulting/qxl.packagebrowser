  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.PackageTree", {
    ...
    construct: function construct() {
      ...
      this.setPadding(0);
      this.__P_591_0 = new qx.ui.tree.TreeFolder("Packages");

      this.__P_591_0.setOpen(true);

      this.setRoot(this.__P_591_0);
      this.setSelection([this.__P_591_0]); // Workaround: Since navigating in qx.ui.tree.Tree doesn't work, we've to
    ...
    */
    members: {
      ...
      setTreeData: function setTreeData(docTree) {
        ...
        this.__P_591_1(this.__P_591_0, docTree, 0);
      ...
      selectTreeNodeByClassName: function selectTreeNodeByClassName(className) {
        ...
        if (!className) {
          ...
          this.setSelection([this.__P_591_0]);
          this.scrollChildIntoView(this.__P_591_0);
          return qx.Promise.resolve(true);
        }
       ...
       */
      __P_591_2: function __P_591_2(packageTreeNode, packageDoc, depth) {
        var self = this;
        return function () {
          if (!packageTreeNode.loaded) {
            packageTreeNode.loaded = true;

            self.__P_591_1(packageTreeNode, packageDoc, depth + 1);
       ...
       *          {var} current depth in the tree
       */
      __P_591_1: function __P_591_1(treeNode, docNode, depth) {
        ...
        qx.Promise.map(packagesDoc, packageDoc => {
          ...
          packageTreeNode.addListener("changeOpen", this.__P_591_2(packageTreeNode, packageDoc, depth + 1), this); // Register the tree node
...
//# sourceMappingURL=PackageTree.js.map?dt=1613267734436