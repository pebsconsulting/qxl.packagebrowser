    ...
    members: {
      ...
      _getTocHtml: function _getTocHtml(classNode) {
        ...
        this.getPanels().forEach(panel => {
          ...
          q(tocItem).on("tap", function (firstItem) {
            return function () {
              this.__P_600_0(firstItem, firstItem.getName());
      ...
      _getDescriptionHtml: function _getDescriptionHtml(classNode) {
        ...
        if (classNode.getType() === "interface") {
          classHtml.add(this.__P_600_1(classNode));
        } else {
          classHtml.add(this.__P_600_2(classNode));
        }

        return classNode.getChildClasses().then(childClasses => {
          classHtml.add(this.__P_600_3(childClasses, "Direct " + subObjectsName + ":"));
          classHtml.add(this.__P_600_3(classNode.getInterfaces(), "Implemented interfaces:"));
          classHtml.add(this.__P_600_3(classNode.getMixins(), "Included mixins:"));
          return classNode.getImplementations();
        }).then(classes => {
          classHtml.add(this.__P_600_3(classes, "Implementations of this interface:"));
          return classNode.getIncluder();
        }).then(classes => {
          classHtml.add(this.__P_600_3(classes, "Classes including this mixin:"));
       ...
       */
      __P_600_3: function __P_600_3(dependentClasses, title) {
        var result = "";
       ...
       */
      __P_600_2: function __P_600_2(classNode) {
       ...
       * @return {String} HTML fragemnt
       */
      __P_600_1: function __P_600_1(classNode) {
      ...
      showItem: function showItem(itemName) {
        ...
        this.__P_600_0(itemNode, itemName);
       ...
       */
      __P_600_0: function __P_600_0(itemNode, itemName) {
...
//# sourceMappingURL=ClassViewer.js.map?dt=1613267734944