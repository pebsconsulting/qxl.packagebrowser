  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.Controller", {
    ...
    construct: function construct(widgetRegistry) {
      ...
      btn_inherited.addListener("changeValue", this.__P_590_3, this);
      btn_included.addListener("changeValue", this.__P_590_3, this);
      this._history = qx.bom.History.getInstance();

      this.__P_590_4();

      qx.core.Init.getApplication().getRoot().addListener("pointerdown", function (e) {
        this.__P_590_5 = e.isShiftPressed() || e.isCtrlOrCommandPressed();
      }, this, true);
    },
    members: {
      __P_590_5: false,
      ...
      load: function load(apidata) {
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            if (state) {
              this.__P_590_6(this.__P_590_7(state));
            } else {
              this.__P_590_6("");
            }
          });
      ...
      __P_590_4: function __P_590_4() {
        this._history.addListener("changeState", function (evt) {
          var item = this.__P_590_7(evt.getData());
      ...
      _updateHistory: function _updateHistory(className) {
        ...
        qx.bom.History.getInstance().addToHistory(this.__P_590_8(className), newTitle);
      },
      ...
      _selectClass: async function _selectClass(classNode, callback, self) {
        ...
        if (classNode instanceof qxl.apiviewer.dao.Class) {
          await this._tabViewController.openClass(classNode, this.__P_590_5);
        } else {
          await this._tabViewController.openPackage(classNode, this.__P_590_5);
        }
       ...
       * 
       */
      __P_590_6: function __P_590_6(fullItemName) {
      ...
      __P_590_8: function __P_590_8(state) {
        return state.replace(/(.*)#(.*)/g, "$1~$2");
      },
      __P_590_7: function __P_590_7(encodedState) {
...
//# sourceMappingURL=Controller.js.map?dt=1613267734382