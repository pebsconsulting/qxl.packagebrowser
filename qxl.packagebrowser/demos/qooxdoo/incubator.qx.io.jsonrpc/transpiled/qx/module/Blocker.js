  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Blocker", {
    statics: {
       ...
       */
      __P_188_0: function __P_188_0(item, color, opacity, zIndex) {
        ...
        if (isDocument) {
          item.__P_188_1.div.insertBefore(qxWeb(win.document.body).getChildren(':first'));
        } else {
          item.__P_188_1.div.appendTo(win.document.body);
        }

        qx.module.Blocker.__P_188_2(item, color, opacity, zIndex, isDocument);
      },
       ...
       */
      __P_188_2: function __P_188_2(item, color, opacity, zIndex, isDocument) {
        ...
        item.__P_188_1.div.setStyles(styles);
      },
       ...
       */
      __P_188_3: function __P_188_3(item, index) {
        if (!item.__P_188_1) {
          return;
        }

        item.__P_188_1.div.remove();
      },
       ...
       */
      __P_188_4: function __P_188_4(collection) {
        var blockerElements = qxWeb();
        collection.forEach(function (item, index) {
          if (typeof item.__P_188_1 !== "undefined") {
            blockerElements = blockerElements.concat(item.__P_188_1.div);
          }
        });
    ...
    members: {
      ...
      block: function block(color, opacity, zIndex) {
        ...
        this.forEach(function (item, index) {
          qx.module.Blocker.__P_188_0(item, color, opacity, zIndex);
        });
        return this;
      },
      ...
      unblock: function unblock() {
        ...
        this.forEach(qx.module.Blocker.__P_188_3);
        return this;
      },
      ...
      getBlocker: function getBlocker() {
        ...
        var collection = qx.module.Blocker.__P_188_4(this);
...
//# sourceMappingURL=Blocker.js.map?dt=1613267708026