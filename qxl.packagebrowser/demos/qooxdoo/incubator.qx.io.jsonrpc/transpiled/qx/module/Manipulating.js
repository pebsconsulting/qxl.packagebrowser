  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Manipulating", {
    statics: {
       ...
       */
      __P_191_0: function __P_191_0(property, value, duration) {
       ...
       * @internal
       */
      __P_191_2: function __P_191_2(element) {
        ...
        for (var i = 0, l = element.childNodes.length; i < l; i++) {
          if (element.childNodes[i].nodeType === 1) {
            return this.__P_191_2(element.childNodes[i]);
          }
        }
       ...
       * @internal
       */
      __P_191_3: function __P_191_3(arg) {
        if (!qx.lang.Type.isArray(arg)) {
    ...
    members: {
      ...
      appendTo: function appendTo(parent) {
        parent = qx.module.Manipulating.__P_191_3(parent);
      ...
      insertBefore: function insertBefore(target) {
        target = qx.module.Manipulating.__P_191_3(target);
      ...
      wrap: function wrap(wrapper) {
        wrapper = qx.module.Manipulating.__P_191_1(wrapper);
        ...
        this._forEachElement(function (item) {
          ...
          var innermost = qx.module.Manipulating.__P_191_2(clonedwrapper[0]);
      ...
      setScrollLeft: function setScrollLeft(value, duration) {
        ...
        if (duration && qx.bom.element && qx.bom.element.AnimationJs) {
          qx.module.Manipulating.__P_191_0.bind(this, "scrollLeft", value, duration)();
        }
      ...
      setScrollTop: function setScrollTop(value, duration) {
        ...
        if (duration && qx.bom.element && qx.bom.element.AnimationJs) {
          qx.module.Manipulating.__P_191_0.bind(this, "scrollTop", value, duration)();
        }
...
//# sourceMappingURL=Manipulating.js.map?dt=1613267708292