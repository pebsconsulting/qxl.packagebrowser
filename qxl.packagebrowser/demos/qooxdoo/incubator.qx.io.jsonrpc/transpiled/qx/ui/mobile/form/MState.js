    ...
    */
    members: {
      ...
      addState: function addState(state) {
        if (this.__P_462_0 === null) {
          this.__P_462_0 = {};
        }

        this.__P_462_0[state] = true;
      ...
      hasState: function hasState(state) {
        return this.__P_462_0 !== null && this.__P_462_0[state];
      },
      ...
      replaceState: function replaceState(oldState, newState) {
        if (this.hasState(oldState)) {
          delete this.__P_462_0[oldState];
          this.__P_462_0[newState] = true;
...
//# sourceMappingURL=MState.js.map?dt=1613267727148