    ...
    members: {
      ...
      init: function init() {
        ...
        if (active.length > 0) {
          ...
          this.__P_557_1(activePage);

          this._showPage(active, null);

          this.__P_557_2(activePage);
        }
       ...
       */
      __P_557_1: function __P_557_1(elem) {
       ...
       * @param elem {qxWeb} Element
       */
      __P_557_2: function __P_557_2(elem) {
...
//# sourceMappingURL=Tabs.js.map?dt=1613267732537