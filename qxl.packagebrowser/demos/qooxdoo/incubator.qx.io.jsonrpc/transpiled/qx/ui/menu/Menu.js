    ...
    */
    members: {
      ...
      */
       ...
       * and position.
       */
      __P_443_2: function __P_443_2() {
        var menuBounds = this._getMenuBounds();

        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_443_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_443_1) {
          this.__P_443_1.call(this);

          delete this.__P_443_1;
        }
      },
...
//# sourceMappingURL=Menu.js.map?dt=1613267725931