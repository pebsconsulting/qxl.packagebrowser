  ...
  qx.Class.define("qx.io.jsonrpc.Client", {
    ...
    members: {
      ...
      _throwTransportException(exception) {
        ...
        this.__P_155_0.forEach(request => {
      ...
      async send(message) {
        ...
        requests.forEach(request => {
          ...
          if (this.__P_155_0[id] !== undefined) {
...
//# sourceMappingURL=Client.js.map?dt=1613267705966