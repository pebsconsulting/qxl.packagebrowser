  ...
  qx.Class.define("qx.io.transport.AbstractClient", {
    ...
    statics: {
      ...
      registerTransport(uriRegExp, transportClass) {
        if (!this.constructor.__P_172_0) {
          this.constructor.__P_172_0 = [];
        }
        ...
        this.constructor.__P_172_0.push({
          uriRegExp,
    ...
    members: {
      ...
      selectTransport(transportOrUri) {
        ...
        if (qx.lang.Type.isString(transportOrUri)) {
          ...
          for (let registeredTransport of this.constructor.__P_172_0.reverse()) {
...
//# sourceMappingURL=AbstractClient.js.map?dt=1613267706923