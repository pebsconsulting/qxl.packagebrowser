  ...
  qx.Class.define("qx.test.log.DeprecationMethodOverriding", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_251_1 = qx.log.Logger.warn;
        this.__P_251_2 = qx.log.Logger.trace;
        var that = this;
      ...
      tearDown: function tearDown() {
        qx.log.Logger.warn = this.__P_251_1;
        qx.log.Logger.trace = this.__P_251_2;
        this.__P_251_1 = null;
        this.__P_251_2 = null;
        this.__P_251_0 = null;
      },
      "testClassA: baseclass": function testClassABaseclass() {
        ...
        this.__P_251_3(instance, 1, 1, null);
      ...
      "testClassB1: overrides method": function testClassB1OverridesMethod() {
        ...
        this.__P_251_3(instance, 2, 2, /qx.test.log.fixture.ClassB1.prototype._applyOldProperty()/);
      ...
      "testClassC1: doesn't override method": function testClassC1DoesnTOverrideMethod() {
        ...
        this.__P_251_3(instance, 2, 3, /qx.test.log.fixture.ClassB1.prototype._applyOldProperty()/);
      ...
      "testClassB2: doesn't override method": function testClassB2DoesnTOverrideMethod() {
        ...
        this.__P_251_3(instance, 1, 2, null);
      ...
      "testClassC2: overrides method": function testClassC2OverridesMethod() {
        ...
        this.__P_251_3(instance, 2, 3, /qx.test.log.fixture.ClassC2.prototype._applyOldProperty()/);

        instance.dispose();
      },
      __P_251_3: function __P_251_3(instance, callCountOldProperty, callCountNewProperty, reqExpWarnMsg) {
...
//# sourceMappingURL=DeprecationMethodOverriding.js.map?dt=1613267713878