(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.Color", {
    ...
    members: {
      __P_292_0: function __P_292_0(widget) {
      ...
      testColorSelector: function testColorSelector() {
        this.__P_292_0(new qx.ui.control.ColorSelector());
      },
      testColorPopup: function testColorPopup() {
        this.__P_292_0(new qx.ui.control.ColorPopup());
      }
    }
  });
...
//# sourceMappingURL=Color.js.map?dt=1613267716147