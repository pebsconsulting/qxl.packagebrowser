(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.Form", {
    ...
    members: {
      __P_297_0: function __P_297_0(widget) {
      ...
      __P_297_1: function __P_297_1(widget, where) {
        // check if the interface is implemented
      ...
      __P_297_2: function __P_297_2(widget) {
      ...
      testRequiredSpinner: function testRequiredSpinner() {
        this.__P_297_0(new qx.ui.form.Spinner());
      },
      testValidSpinner: function testValidSpinner() {
        this.__P_297_1(new qx.ui.form.Spinner());
      },
      testRequiredSlider: function testRequiredSlider() {
        this.__P_297_0(new qx.ui.form.Slider());
      },
      testValidSlider: function testValidSlider() {
        this.__P_297_1(new qx.ui.form.Slider());
      },
      testRequiredTextField: function testRequiredTextField() {
        this.__P_297_0(new qx.ui.form.TextField());
      },
      ...
      testRequiredRadioGroup: function testRequiredRadioGroup() {
        this.__P_297_0(new qx.ui.form.RadioGroup());
      },
      testRequiredRadioButtonGroup: function testRequiredRadioButtonGroup() {
        this.__P_297_0(new qx.ui.form.RadioButtonGroup());
      },
...
//# sourceMappingURL=Form.js.map?dt=1613267716271