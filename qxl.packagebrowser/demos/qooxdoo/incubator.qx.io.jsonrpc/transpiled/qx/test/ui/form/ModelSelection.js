(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.ModelSelection", {
    ...
    members: {
      __P_304_0: function __P_304_0(widget, children) {
      ...
      __P_304_1: function __P_304_1(widget, children) {
        var children = children || widget.getChildren(); // check the model selection
      ...
      __P_304_2: function __P_304_2(widget, children) {
      ...
      __P_304_3: function __P_304_3(widget, children) {
        var children = children || widget.getChildren(); // check the set selection
      ...
      __P_304_5: function __P_304_5(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_304_7: function __P_304_7() {
        var group = new qx.ui.form.RadioGroup();

        this.__P_304_8(group);

        return group;
      },
      __P_304_9: function __P_304_9() {
      ...
      __P_304_8: function __P_304_8(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_304_11: function __P_304_11(box) {
      ...
      testListGetSingle: function testListGetSingle() {
        var list = this.__P_304_6();

        this.__P_304_0(list);

        this.__P_304_11(list);
      },
      ...
      testTreeGetSingle: function testTreeGetSingle() {
        var widget = this.__P_304_10();

        var children = widget.getItems(true);

        this.__P_304_0(widget, children);
      ...
      testTreeSetSingle: function testTreeSetSingle() {
        ...
        this.__P_304_2(widget, children);
      ...
      testTreeGetMulti: function testTreeGetMulti() {
        ...
        this.__P_304_1(widget, children);
      ...
      testTreeSetMulti: function testTreeSetMulti() {
        ...
        this.__P_304_3(widget, children);
...
//# sourceMappingURL=ModelSelection.js.map?dt=1613267716582