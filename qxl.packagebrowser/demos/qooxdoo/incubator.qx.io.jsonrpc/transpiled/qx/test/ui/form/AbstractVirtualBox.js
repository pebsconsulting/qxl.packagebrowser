  ...
  qx.Class.define("qx.test.ui.form.AbstractVirtualBox", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_290_0 = new qx.ui.form.VirtualSelectBox();
        this.getRoot().add(this.__P_290_0);
        this.__P_290_1 = new qx.ui.form.VirtualComboBox();
        this.getRoot().add(this.__P_290_1);
        this.flush();
      },
      tearDown: function tearDown() {
        qx.test.ui.form.AbstractVirtualBox.prototype.tearDown.base.call(this);

        this.__P_290_0.dispose();

        this.__P_290_0 = null;

        this.__P_290_1.dispose();
      ...
      testStatePopupOpen: function testStatePopupOpen() {
        ...
        this.flush();
        this.assertTrue(this.__P_290_0.hasState("popupOpen"));

        this.__P_290_0.close();

        this.flush();
        this.assertFalse(this.__P_290_0.hasState("popupOpen"));

        this.__P_290_1.open();

        this.flush();
        this.assertTrue(this.__P_290_1.hasState("popupOpen"));

        this.__P_290_1.close();

        this.flush();
        this.assertFalse(this.__P_290_1.hasState("popupOpen"));
      },
      testListLengthAfterModelChangeSelectBox: function testListLengthAfterModelChangeSelectBox() {
        ...
        this.__P_290_0.setModel(model);

        this.__P_290_0.open();

        this.flush();

        var dropDown = this.__P_290_0.getChildControl("dropdown");
        ...
        this.__P_290_0.resetModel();
      },
      testListLengthAfterModelChangeComboBox: function testListLengthAfterModelChangeComboBox() {
        var model = new qx.data.Array(["a", "b", "c"]);

        this.__P_290_1.setModel(model);

        this.__P_290_1.open();

        this.flush();

        var dropDown = this.__P_290_1.getChildControl("dropdown");
...
//# sourceMappingURL=AbstractVirtualBox.js.map?dt=1613267716122