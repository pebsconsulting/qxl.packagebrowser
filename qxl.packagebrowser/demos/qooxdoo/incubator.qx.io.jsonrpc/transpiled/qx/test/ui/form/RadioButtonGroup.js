  ...
  qx.Class.define("qx.test.ui.form.RadioButtonGroup", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_307_0 = new qx.ui.form.RadioButtonGroup();
        this.__P_307_1 = [];
        var radioButton;
      ...
      testRemoveAll: function testRemoveAll() {
        ...
        var amountOfRadioButtons = this.__P_307_0.getRadioGroup().getItems().length;
...
//# sourceMappingURL=RadioButtonGroup.js.map?dt=1613267716644