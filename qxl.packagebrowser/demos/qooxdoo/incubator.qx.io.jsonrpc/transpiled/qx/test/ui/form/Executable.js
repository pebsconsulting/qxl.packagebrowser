  ...
  qx.Class.define("qx.test.ui.form.Executable", {
    ...
    members: {
      ...
      testToolbarButton: function testToolbarButton() {
        this.__P_296_0(new qx.ui.toolbar.Button());
      },
      testSplitButton: function testSplitButton() {
        this.__P_296_0(new qx.ui.toolbar.SplitButton());
      },
      testMenuCheckBox: function testMenuCheckBox() {
        this.__P_296_0(new qx.ui.menu.CheckBox());
      },
      testMenuRadioButton: function testMenuRadioButton() {
        this.__P_296_0(new qx.ui.menu.RadioButton());
      },
      testButtonInMenu: function testButtonInMenu() {
        this.__P_296_0(new qx.ui.menu.Button());
      },
      ...
      testDateChooser: function testDateChooser() {
        this.__P_296_0(new qx.ui.control.DateChooser());
      }
    }
  });
...
//# sourceMappingURL=Executable.js.map?dt=1613267716208