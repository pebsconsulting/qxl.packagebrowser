  ...
  qx.Class.define("qx.test.bom.element.Dimension", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_219_0 = document.createElement("span");
        document.body.appendChild(this.__P_219_0);
        this.__P_219_1 = document.createElement("span");
        this.__P_219_1.style.padding = "2px";
        document.body.appendChild(this.__P_219_1);
        this.__P_219_2 = document.createElement("div");
        this.__P_219_2.style.width = "200px";
        document.body.appendChild(this.__P_219_2);
        this.__P_219_3 = document.createElement("div");
        this.__P_219_3.style.padding = "2px";
        this.__P_219_3.style.width = "200px";
        document.body.appendChild(this.__P_219_3);
      },
      tearDown: function tearDown() {
        document.body.removeChild(this.__P_219_0);
        this.__P_219_0 = null;
        document.body.removeChild(this.__P_219_1);
        this.__P_219_1 = null;
        document.body.removeChild(this.__P_219_2);
        this.__P_219_2 = null;
        document.body.removeChild(this.__P_219_3);
        this.__P_219_3 = null;
      },
      testContentWidthOfInlineElement: function testContentWidthOfInlineElement() {
        this.assertEquals(0, qx.bom.element.Dimension.getContentWidth(this.__P_219_0));
      },
      testContentWidthOfInlineElementWithPadding: function testContentWidthOfInlineElementWithPadding() {
        this.assertEquals(0, qx.bom.element.Dimension.getContentWidth(this.__P_219_1));
      },
      testContentWidthOfBlockElement: function testContentWidthOfBlockElement() {
        this.assertEquals(200, qx.bom.element.Dimension.getContentWidth(this.__P_219_2));
      },
      testContentWidthOfBlockElementWithPadding: function testContentWidthOfBlockElementWithPadding() {
        this.assertEquals(200, qx.bom.element.Dimension.getContentWidth(this.__P_219_3));
      },
...
//# sourceMappingURL=Dimension.js.map?dt=1613267710123