  ...
  qx.Class.define("qx.test.data.store.Json", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_239_0 = new qx.data.store.Json();
        this.__P_239_1 = eval("({s: 'String', n: 12, b: true})");
        this.__P_239_2 = ["s", "n", "b"];
      ...
      tearDown: function tearDown() {
        ...
        this.__P_239_0.dispose(); // Remove the former created classes
      ...
      testLoadUrl: function testLoadUrl() {
        this.__P_239_0.addListener("loaded", function () {
          this.resume(function () {
            var model = this.__P_239_0.getModel();
      ...
      testProgressStates: function testProgressStates() {
        ...
        this.__P_239_0.addListener("changeState", function (evt) {
      ...
      testLoadResource: function testLoadResource() {
        ...
        this.__P_239_0.setUrl(resource);

        this.wait();
      },
      testParseErrorForResource: function testParseErrorForResource() {
        this.__P_239_0.addListener("parseError", function (ev) {
          this.resume(function () {
      ...
      testLoadAlias: function testLoadAlias() {
        ...
        this.__P_239_0.setUrl(alias);

        this.wait();
      },
      testDispose: function testDispose() {
        this.__P_239_0.setUrl(this.url);

        this.__P_239_0.dispose();
      },
      ...
      testOwnClassWith: function testOwnClassWith() {
        ...
        this.__P_239_0 = new qx.data.store.Json(null, delegate);
      ...
      testDisposeOldModel: function testDisposeOldModel() {
        this.__P_239_0.addListener("loaded", function () {
          this.resume(function () {
            var model = this.__P_239_0.getModel(); // check if the new model is not the old model
        ...
        this.__P_239_0.setModel(fakeModel);
      ...
      testErrorEvent: function testErrorEvent() {
        this.__P_239_0.addListener("error", function (ev) {
          this.resume(function () {
            this.assertNotNull(ev);
          }, this);
        }, this);

        this.__P_239_0.setUrl("not-found");
      ...
      "test Internal Server Error": function testInternalServerError() {
        ...
        this.__P_239_0.addListener("error", function (e) {
          this.resume(function () {
...
//# sourceMappingURL=Json.js.map?dt=1613267712408