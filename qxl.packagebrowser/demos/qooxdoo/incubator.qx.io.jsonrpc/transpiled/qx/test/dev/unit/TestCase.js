  ...
  qx.Class.define("qx.test.dev.unit.TestCase", {
    ...
    members: {
      ...
      testResumeHandler: function testResumeHandler() {
        this.__P_242_0(this.resumeHandler(function (param) {
      ...
      __P_242_0: function __P_242_0(callback) {
        window.setTimeout(this.__P_242_1.bind(this, callback), 0);
      },
      __P_242_1: function __P_242_1(callback) {
...
//# sourceMappingURL=TestCase.js.map?dt=1613267712620