  ...
  qx.Mixin.define("qx.ui.mobile.container.MIScroll", {
      ...
      */
      _scrollTo: function _scrollTo(x, y, time) {
        if (this._isScrollable()) {
          ...
          if (this.__P_286_2) {
            this.__P_286_2.scrollTo(-x, -y, time);
          } else {
      ...
      __P_286_0: function __P_286_0() {
        if (!window.iScroll) {
          ...
          loader.on("load", this.__P_286_3, this);
          loader.open("GET", path);
          loader.send();
        } else {
          this.addListenerOnce("appear", function () {
            this._setScroll(this.__P_286_4());
          }, this);
        }
      },
       ...
       */
      __P_286_3: function __P_286_3(request) {
    ...
    */
    destruct: function destruct() {
      this.__P_286_5(); // Cleanup iScroll
...
//# sourceMappingURL=MIScroll.js.map?dt=1613267932869