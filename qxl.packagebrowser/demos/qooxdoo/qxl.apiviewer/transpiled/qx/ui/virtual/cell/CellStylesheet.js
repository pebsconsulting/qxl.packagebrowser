  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.cell.CellStylesheet", {
    ...
    construct: function construct() {
      ...
      this.__P_377_0 = qx.bom.Stylesheet.createElement(stylesheet);
      this.__P_377_1 = {};
      this.__P_377_2 = {};
    },
    members: {
      ...
      getCssClass: function getCssClass(key) {
        return this.__P_377_1[key] || null;
      },
      ...
      computeClassForStyles: function computeClassForStyles(key, styleString) {
        var cssClass = this.__P_377_2[styleString];

        if (!cssClass) {
          // generate stylesheet rule
          var cssClass = this.__P_377_3();

          qx.bom.Stylesheet.addRule(this.__P_377_0, "." + cssClass, styleString);
          this.__P_377_2[styleString] = cssClass;
        }

        this.__P_377_1[key] = cssClass;
        return cssClass;
      },
       ...
       */
      __P_377_3: function __P_377_3() {
        return "qx-cell-" + this.toHashCode() + "-" + this.__P_377_4++;
      },
      __P_377_4: 0
    },
...
//# sourceMappingURL=CellStylesheet.js.map?dt=1613267939043