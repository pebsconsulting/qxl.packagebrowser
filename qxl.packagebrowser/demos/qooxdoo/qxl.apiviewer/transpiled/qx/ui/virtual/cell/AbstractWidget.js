  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractWidget", {
    ...
    members: {
      ...
      _cleanupPool: function _cleanupPool() {
        var widget = this.__P_374_0.pop();

        while (widget) {
          widget.destroy();
          widget = this.__P_374_0.pop();
        }
      },
      ...
      __P_374_1: function __P_374_1() {
        var widget = this.__P_374_0.shift();
...
//# sourceMappingURL=AbstractWidget.js.map?dt=1613267938966