  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MModelSelection", {
    construct: function construct() {
      ...
      this.__P_252_0 = new qx.data.Array(); // listen to the changes

      this.__P_252_0.addListener("change", this.__P_252_1, this);

      this.addListener("changeSelection", this.__P_252_2, this);
    },
    events: {
      /**
    ...
    members: {
       ...
       */
      __P_252_1: function __P_252_1() {
        this.__P_252_3 = true;
        var selectables = this.getSelectables(true);
        var itemSelection = [];

        var modelSelection = this.__P_252_0.toArray();
        ...
        this.__P_252_3 = false; // check if the setting has worked
      ...
      setModelSelection: function setModelSelection(modelSelection) {
        ...
        modelSelection.unshift(this.__P_252_0.getLength()); // remove index

        modelSelection.unshift(0); // start index

        var returnArray = this.__P_252_0.splice.apply(this.__P_252_0, modelSelection);
...
//# sourceMappingURL=MModelSelection.js.map?dt=1613267930472