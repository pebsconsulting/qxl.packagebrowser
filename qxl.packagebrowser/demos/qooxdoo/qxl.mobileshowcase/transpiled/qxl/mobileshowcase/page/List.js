  ...
  qx.Class.define("qxl.mobileshowcase.page.List", {
    ...
    members: {
      ...
      _initialize: function _initialize() {
        qxl.mobileshowcase.page.List.prototype._initialize.base.call(this);
        ...
        var list = new qx.ui.mobile.list.List({
          ...
          configureGroupItem: function configureGroupItem(item, data, group) {
            item.setTitle("#" + group + " " + data.title);
            item.setSelectable(true);
          },
          group: function group(data, row) {
            var title = "Items";
      ...
      */
      _onWaypoint: function _onWaypoint(evt) {
        ...
        qx.bom.element.Attribute.set(targetElement, "data-waypoint-label", this._waypointsY[index] + " [" + direction + "]"); // 100% waypoint
      ...
      */
      _loadMoreModelItems: function _loadMoreModelItems() {
       ...
       */
      _showDialog: function _showDialog(text) {
        qx.ui.mobile.dialog.Manager.getInstance().confirm("Selection", text, null, this, ["OK"]);
      }
    }
  });
  qxl.mobileshowcase.page.List.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=List.js.map?dt=1613268275142