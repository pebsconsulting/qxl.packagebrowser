(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.mobileshowcase.page.Carousel", {
    ...
    members: {
      ...
      _createScrollContainer: function _createScrollContainer() {
        ...
        page5.add(new qx.ui.mobile.basic.Label("You can add as many pages as you want."), {
          flex: 1
        });
        ...
        page6.add(new qx.ui.mobile.basic.Label("Previous page is shown when you swipe right."), {
          flex: 1
        });
        carousel.add(page1);
        carousel.add(page2);
  ...
  qxl.mobileshowcase.page.Carousel.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Carousel.js.map?dt=1613268275046