(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.mobileshowcase.page.Basic", {
    ...
    members: {
      ...
      _initialize: function _initialize() {
        qxl.mobileshowcase.page.Basic.prototype._initialize.base.call(this); // BASIC WIDGET CHANGE MENU


        this.getContent().add(new qx.ui.mobile.form.Title("Widget Modes")); // TOGGLE BUTTON
        ...
        var exImage = new qx.ui.mobile.basic.Image("qxl/mobileshowcase/icon/mobile.png"); // ATOMS
        ...
        this._widgets.push(exCollapsible); // BUILD VIEW
      ...
      _createCollapsible: function _createCollapsible() {
  ...
  qxl.mobileshowcase.page.Basic.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Basic.js.map?dt=1613268275401