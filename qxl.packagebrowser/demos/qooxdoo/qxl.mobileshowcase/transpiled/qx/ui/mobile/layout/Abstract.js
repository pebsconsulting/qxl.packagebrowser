    ...
    members: {
      ...
      connectToWidget: function connectToWidget(widget) {
        ...
        if (widget) {
          ...
          if (this.__P_145_0) {
            for (var property in this.__P_145_0) {
              this.reset(property);
              this.set(property, this.__P_145_0[property]);
            }
          }
        } else {
          this.__P_145_0 = null;
      ...
      _getChildLayoutPropertyValue: function _getChildLayoutPropertyValue(widget, property) {
        var cache = this.__P_145_2(widget);
       ...
       *     Key / value pairs.
       */
      __P_145_2: function __P_145_2(widget) {
        if (!this.__P_145_1) {
          this.__P_145_1 = {};
        }

        var cache = this.__P_145_1;
...
//# sourceMappingURL=Abstract.js.map?dt=1613268286609