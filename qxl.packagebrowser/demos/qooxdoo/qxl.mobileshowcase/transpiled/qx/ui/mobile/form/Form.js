      ...
      validate: function validate() {
        ...
        for (var i = 0; i < groups.length; i++) {
          ...
          for (var j = 0; j < group.items.length; j++) {
            ...
            if (!item.isValid()) {
              this.__P_46_0.push(item);

              if (this.__P_46_1 != null) {
                this.__P_46_1.showErrorForItem(item);
              } else {
...
//# sourceMappingURL=Form.js.map?dt=1613268278713