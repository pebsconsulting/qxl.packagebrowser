  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_37_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_37_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_37_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_37_3()) {
      ...
      __P_37_0: function __P_37_0() {
        ...
        if (qx.bom.client.Engine.__P_37_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613268278142