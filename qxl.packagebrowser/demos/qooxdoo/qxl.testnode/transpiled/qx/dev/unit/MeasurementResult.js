  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.dev.unit.MeasurementResult", {
    ...
    construct: function (message, iterations, ownTime, renderTime) {
      this.__P_26_0 = message;
      this.__P_26_1 = iterations;
      this.__P_26_2 = ownTime;
      this.__P_26_3 = renderTime;
    },
    members: {
      __P_26_0: null,
      __P_26_1: null,
      ...
      getData: function () {
        return {
          message: this.__P_26_0,
          iterations: this.__P_26_1,
          ownTime: this.__P_26_2,
          renderTime: this.__P_26_3
        };
      },
       ...
       */
      toString: function () {
        return ["Measured: " + this.__P_26_0, "Iterations: " + this.__P_26_1, "Time: " + this.__P_26_2 + "ms", "Render time: " + this.__P_26_3 + "ms"].join("\n");
      }
    }
  });
...
//# sourceMappingURL=MeasurementResult.js.map?dt=1613268395339