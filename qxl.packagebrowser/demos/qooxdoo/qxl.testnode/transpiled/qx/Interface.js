  ...
  qx.Bootstrap.define("qx.Interface", {
    statics: {
      ...
      */
       ...
       */
      __P_13_0: function (object, clazz, iface, wrap, shouldThrow) {
        // Validate members
        ...
        if (members) {
          for (var key in members) {
            if (qx.Bootstrap.isFunction(members[key])) {
              var isPropertyMethod = this.__P_13_1(clazz, key);
              ...
              if (shouldWrapFunction) {
                object[key] = this.__P_13_2(iface, object[key], key, members[key]);
              }
            } else {
       ...
       *   system.
       */
      __P_13_1: function (clazz, methodName) {
       ...
       */
      __P_13_3: function (clazz, iface, shouldThrow) {
        if (iface.$$properties) {
       ...
       */
      __P_13_4: function (clazz, iface, shouldThrow) {
        if (iface.$$events) {
      ...
      assertObject: function (object, iface) {
        ...
        this.__P_13_0(object, clazz, iface, false, true);

        this.__P_13_3(clazz, iface, true);

        this.__P_13_4(clazz, iface, true); // Validate extends, recursive
      ...
      assert: function (clazz, iface, wrap) {
        this.__P_13_0(clazz.prototype, clazz, iface, wrap, true);
      ...
      objectImplements: function (object, iface) {
        ...
        if (!this.__P_13_0(object, clazz, iface) || !this.__P_13_3(clazz, iface) || !this.__P_13_4(clazz, iface)) {
          return false;
      ...
      classImplements: function (clazz, iface) {
        if (!this.__P_13_0(clazz.prototype, clazz, iface) || !this.__P_13_3(clazz, iface) || !this.__P_13_4(clazz, iface)) {
          return false;
        } // Validate extends, recursive
      ...
      */
       ...
       */
      __P_13_2: function (iface, origFunction, functionName, preCondition) {},
       ...
       */
      __P_13_6: function (name, config) {}
    }
  });
  qx.Interface.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Interface.js.map?dt=1613268394137