  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationHandle", {
    ...
    construct: function () {
      ...
      this.__P_138_0 = css && css["play-state"];
      this.__P_138_1 = true;
      this.addListenerOnce("end", this.__P_138_2, this);
    },
    events: {
    ...
    members: {
       ...
       */
      isPaused: function () {
        return this.el.style[this.__P_138_0] == "paused";
      },
      ...
      pause: function () {
        if (this.el) {
          this.el.style[this.__P_138_0] = "paused";
          this.el.$$animation.__P_138_1 = false; // in case the animation is based on JS
      ...
      play: function () {
        if (this.el) {
          this.el.style[this.__P_138_0] = "running";
          this.el.$$animation.__P_138_1 = true; // in case the animation is based on JS
      ...
      stop: function () {
        if (this.el && qx.core.Environment.get("css.animation") && !this.jsAnimation) {
          this.el.style[this.__P_138_0] = "";
          this.el.style[qx.core.Environment.get("css.animation").name] = "";
          this.el.$$animation.__P_138_1 = false;
          this.el.$$animation.__P_138_3 = true;
...
//# sourceMappingURL=AnimationHandle.js.map?dt=1613268401556