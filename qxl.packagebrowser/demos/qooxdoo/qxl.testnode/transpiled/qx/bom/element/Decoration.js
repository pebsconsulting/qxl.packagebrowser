  ...
  qx.Class.define("qx.bom.element.Decoration", {
    ...
    */
    statics: {
       ...
       */
      __P_115_4: function (style, width, height) {
       ...
       */
      __P_115_5: function (style, repeat, source) {
       ...
       * @return {Map} image URI and style infos
       */
      __P_115_6: function (style, repeat, sourceid) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
       ...
       */
      __P_115_8: function (style, data, height) {
       ...
       * @return {Map} style infos and image URI
       */
      __P_115_9: function (style, data, width) {
        // Use clipped image (multi-images on x-axis)
       ...
       * @return {Map} image URI and style infos
       */
      __P_115_7: function (style, repeat, sourceid) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        var clipped = ResourceManager.getCombinedFormat(sourceid);
       ...
       * @param source {String} image source
       */
      __P_115_10: function (style, source, repeat) {
...
//# sourceMappingURL=Decoration.js.map?dt=1613268400264