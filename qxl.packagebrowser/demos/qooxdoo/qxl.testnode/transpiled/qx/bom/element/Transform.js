  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.Transform", {
    statics: {
      ...
      __P_139_0: qx.core.Environment.get("css.transform"),
      ...
      setOrigin: function (el, value) {
        if (this.__P_139_0 != null) {
          el.style[this.__P_139_0["origin"]] = value;
        }
      },
      ...
      getOrigin: function (el) {
        if (this.__P_139_0 != null) {
          return el.style[this.__P_139_0["origin"]];
        }
      ...
      setStyle: function (el, value) {
        if (this.__P_139_0 != null) {
          el.style[this.__P_139_0["style"]] = value;
        }
      },
      ...
      getStyle: function (el) {
        if (this.__P_139_0 != null) {
          return el.style[this.__P_139_0["style"]];
        }
      ...
      setPerspective: function (el, value) {
        if (this.__P_139_0 != null) {
          el.style[this.__P_139_0["perspective"]] = value + "px";
        }
      },
      ...
      getPerspective: function (el) {
        if (this.__P_139_0 != null) {
          return el.style[this.__P_139_0["perspective"]];
        }
      ...
      setPerspectiveOrigin: function (el, value) {
        if (this.__P_139_0 != null) {
          el.style[this.__P_139_0["perspective-origin"]] = value;
        }
      },
      ...
      getPerspectiveOrigin: function (el) {
        if (this.__P_139_0 != null) {
          var value = el.style[this.__P_139_0["perspective-origin"]];

          if (value != "") {
            return value;
          } else {
            var valueX = el.style[this.__P_139_0["perspective-origin"] + "X"];
            var valueY = el.style[this.__P_139_0["perspective-origin"] + "Y"];
      ...
      setBackfaceVisibility: function (el, value) {
        if (this.__P_139_0 != null) {
          el.style[this.__P_139_0["backface-visibility"]] = value ? "visible" : "hidden";
        }
      },
      ...
      getBackfaceVisibility: function (el) {
        if (this.__P_139_0 != null) {
          return el.style[this.__P_139_0["backface-visibility"]] == "visible";
        }
...
//# sourceMappingURL=Transform.js.map?dt=1613268401595