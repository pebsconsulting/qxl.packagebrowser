    ...
    statics: {
      ...
      addClasses: {
        ...
        "default": function (element, classes) {
          ...
          if (old) {
            result = old.split(this.__P_127_0);
      ...
      removeClasses: {
        ...
        "default": function (element, classes) {
          ...
          return element.className = element.className.replace(reg, "").replace(this.__P_127_1, "").replace(this.__P_127_0, " ");
        }
      }[qx.core.Environment.get("html.classlist") ? "native" : "default"],
...
//# sourceMappingURL=Class.js.map?dt=1613268400755