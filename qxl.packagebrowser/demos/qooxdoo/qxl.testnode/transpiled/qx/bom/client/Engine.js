  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function () {
        ...
        if (qx.bom.client.Engine.__P_5_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_5_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_5_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_5_3()) {
      ...
      __P_5_0: function () {
        ...
        if (qx.bom.client.Engine.__P_5_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613268392652