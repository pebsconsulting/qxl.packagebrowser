  ...
  qx.Bootstrap.define("qx.bom.client.Plugin", {
    statics: {
      ...
      getQuicktimeVersion: function () {
        var entry = qx.bom.client.Plugin.__P_133_0["quicktime"];
        return qx.bom.client.Plugin.__P_133_1(entry.control, entry.plugin);
      },
      ...
      getWindowsMediaVersion: function () {
        var entry = qx.bom.client.Plugin.__P_133_0["wmv"];
        return qx.bom.client.Plugin.__P_133_1(entry.control, entry.plugin, true);
      },
      ...
      getDivXVersion: function () {
        var entry = qx.bom.client.Plugin.__P_133_0["divx"];
        return qx.bom.client.Plugin.__P_133_1(entry.control, entry.plugin);
      },
      ...
      getSilverlightVersion: function () {
        var entry = qx.bom.client.Plugin.__P_133_0["silverlight"];
        return qx.bom.client.Plugin.__P_133_1(entry.control, entry.plugin);
      },
      ...
      getPdfVersion: function () {
        var entry = qx.bom.client.Plugin.__P_133_0["pdf"];
        return qx.bom.client.Plugin.__P_133_1(entry.control, entry.plugin);
      },
      ...
      getQuicktime: function () {
        var entry = qx.bom.client.Plugin.__P_133_0["quicktime"];
        return qx.bom.client.Plugin.__P_133_2(entry.control, entry.plugin);
      },
      ...
      getWindowsMedia: function () {
        var entry = qx.bom.client.Plugin.__P_133_0["wmv"];
        return qx.bom.client.Plugin.__P_133_2(entry.control, entry.plugin, true);
      },
       ...
       */
      __P_133_1: function (activeXName, pluginNames, forceActiveX) {
        var available = qx.bom.client.Plugin.__P_133_2(activeXName, pluginNames, forceActiveX); // don't check if the plugin is not available
       ...
       */
      __P_133_2: function (activeXName, pluginNames, forceActiveX) {
        // IE checks
        if (qx.bom.client.Engine.getName() == "mshtml" && (qx.bom.client.Browser.getDocumentMode() < 11 || forceActiveX)) {
          if (!this.getActiveX()) {
            return false;
...
//# sourceMappingURL=Plugin.js.map?dt=1613268401322