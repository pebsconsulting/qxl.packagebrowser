  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.OperatingSystem", {
    statics: {
       ...
       */
      getVersion: function () {
        var version = qx.bom.client.OperatingSystem.__P_7_1(navigator.userAgent);

        if (version == null) {
          version = qx.bom.client.OperatingSystem.__P_7_2(navigator.userAgent);
        }
       ...
       */
      __P_7_1: function (userAgent) {
        var str = [];

        for (var key in qx.bom.client.OperatingSystem.__P_7_0) {
          str.push(key);
        }
        ...
        if (match && match[1]) {
          return qx.bom.client.OperatingSystem.__P_7_0[match[1]];
        }
...
//# sourceMappingURL=OperatingSystem.js.map?dt=1613268392789