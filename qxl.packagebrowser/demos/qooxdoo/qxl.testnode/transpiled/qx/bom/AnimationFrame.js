  ...
  qx.Bootstrap.define("qx.bom.AnimationFrame", {
    ...
    members: {
      ...
      startSequence: function (duration) {
        this.__P_73_0 = false;
        var start = window.performance && performance.now ? performance.now() + qx.bom.AnimationFrame.__P_73_1 : Date.now();
    ...
    statics: {
      ...
      request: function (callback, context) {
        ...
        var cb = function (time) {
          ...
          if (time < 1e10) {
            time = qx.bom.AnimationFrame.__P_73_1 + time;
          }
    ...
    defer: function (statics) {
      ...
      statics.__P_73_1 = window.performance && performance.timing && performance.timing.navigationStart; // if not, simply use the current time

      if (!statics.__P_73_1) {
        statics.__P_73_1 = Date.now();
      }
    }
  });
...
//# sourceMappingURL=AnimationFrame.js.map?dt=1613268397945