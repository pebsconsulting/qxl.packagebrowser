    ...
    statics: {
      ...
      create: function (content, html, win) {
        ...
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
          ...
          qx.bom.element.Style.setStyles(el, this.__P_134_4(html));
        }
      ...
      setValue: function (element, value) {
        ...
        if (element.useHtml) {
          if (qx.bom.Label.__P_134_5 && typeof qx.bom.Label.__P_134_5 === "function") {
            value = qx.bom.Label.__P_134_5(value);
          }
      ...
      getHtmlSize: function (content, styles, width) {
        var element = this._htmlElement || this.__P_134_3(); // apply width


        element.style.width = width != undefined ? width + "px" : "auto"; // insert content

        element.innerHTML = content;
        return this.__P_134_6(element, styles);
      },
      ...
      getTextSize: function (text, styles) {
        var element = this._textElement || this.__P_134_1();
       ...
       * @return {Map} A map with preferred <code>width</code> and <code>height</code>.
       */
      __P_134_6: function (element, styles) {
        // sync styles
        var keys = this.__P_134_0;
...
//# sourceMappingURL=Label.js.map?dt=1613268401382