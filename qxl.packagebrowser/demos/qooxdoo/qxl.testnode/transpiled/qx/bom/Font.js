    ...
    */
    members: {
      ...
      _applySize: function (value, old) {
        this.__P_122_0.fontSize = value === null ? null : value + "px";
      },
      _applyLineHeight: function (value, old) {
        this.__P_122_0.lineHeight = value === null ? null : value;
      },
      // property apply
      _applyFamily: function (value, old) {
        ...
        this.__P_122_0.fontFamily = family;
      },
      // property apply
      _applyBold: function (value, old) {
        this.__P_122_0.fontWeight = value == null ? null : value ? "bold" : "normal";
      },
      // property apply
      _applyItalic: function (value, old) {
        this.__P_122_0.fontStyle = value == null ? null : value ? "italic" : "normal";
      },
      // property apply
      _applyDecoration: function (value, old) {
        this.__P_122_0.textDecoration = value == null ? null : value;
      },
      // property apply
      _applyColor: function (value, old) {
        this.__P_122_0.color = null;

        if (value) {
          this.__P_122_0.color = qx.theme.manager.Color.getInstance().resolve(value);
        }
      },
      // property apply
      _applyWeight: function (value, old) {
        this.__P_122_0.fontWeight = value;
      },
      // property apply
      _applyTextShadow: function (value, old) {
        this.__P_122_0.textShadow = value == null ? null : value;
      },
...
//# sourceMappingURL=Font.js.map?dt=1613268400588