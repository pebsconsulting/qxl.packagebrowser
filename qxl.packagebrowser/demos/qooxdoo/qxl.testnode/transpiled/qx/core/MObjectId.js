    ...
    members: {
      ...
      _applyQxObjectId: function (value, oldValue) {
        if (!this.__P_35_1) {
          ...
          if (owner) {
            owner.__P_35_2(this, value, oldValue);
          }
       ...
       */
      __P_35_2: function (obj, newId, oldId) {
        delete this.__P_35_0[oldId];
        this.__P_35_0[newId] = obj;
      },
      ...
      _cascadeQxObjectIdChanges: function () {
        ...
        if (this.__P_35_0) {
          for (var name in this.__P_35_0) {
            var obj = this.__P_35_0[name];
      ...
      getOwnedQxObjects: function () {
        return this.__P_35_0 ? Object.values(this.__P_35_0) : [];
      }
    }
  });
...
//# sourceMappingURL=MObjectId.js.map?dt=1613268396015