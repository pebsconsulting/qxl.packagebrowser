  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Property", {
    statics: {
       ...
       */
      __P_15_5: function (inheritables) {
       ...
       */
      __P_15_6: function (clazz, config, name) {
       ...
       * @param name {String} Name of the property
       */
      __P_15_7: function (clazz, config, name) {
        var upname = qx.Bootstrap.firstUp(name);
        var members = clazz.prototype;
       ...
       */
      __P_15_12: function (instance, members, name, variant, code, args) {
       ...
       * @return {var} Return value of the generated function
       */
      __P_15_13: function (clazz, name, variant, code, args) {
       ...
       * @param variant {String} Method variant.
       */
      __P_15_9: function (clazz, name, variant) {
        var code = this.__P_15_14(clazz, name, variant);
       ...
       */
      __P_15_14: function (clazz, name, variant) {
       ...
       * @return {var} Return value of the generated function
       */
      __P_15_10: function (clazz, name, variant) {
        var code = this.__P_15_15(clazz, name, variant);
       ...
       * @return {String[]} the string builder array
       */
      __P_15_15: function (clazz, name, variant) {
        var config = clazz.$$properties[name];
        var members = clazz.prototype;
        var code = [];
       ...
       */
      __P_15_16: function (variant, name) {
       ...
       * @param name {String} name of the property
       */
      __P_15_17: function (code, clazz, config, name) {
        code.push('var equ=');
       ...
       */
      __P_15_18: function (code, config, name, variant, incomingValue) {
        {
       ...
       * @param name {String} name of the property
       */
      __P_15_20: function (code, clazz, config, name) {
       ...
       * @param variant {String} Method variant.
       */
      __P_15_21: function (code, incomingValue, store, variant) {
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_15_22: function (code, name, variant, incomingValue) {
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_15_23: function (code, config, name, variant, incomingValue) {
       ...
       * @param name {String} name of the property
       */
      __P_15_19: function (code, config, name) {
        if (config.inheritable) {
       ...
       * @param variant {String} Method variant.
       */
      __P_15_24: function (code, config, name, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_15_25: function (code, config, name, variant) {
       ...
       */
      __P_15_26: function (code, config, name, variant, refresh) {
...
//# sourceMappingURL=Property.js.map?dt=1613268394546