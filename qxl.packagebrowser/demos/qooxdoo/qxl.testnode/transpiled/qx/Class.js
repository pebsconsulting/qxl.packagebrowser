  ...
  qx.Bootstrap.define("qx.Class", {
    statics: {
      ...
      */
       ...
       */
      __P_4_2: function (clazz, group, key, anno) {
        if (anno !== undefined) {
       ...
       */
      __P_4_1: function (name, type, extend, statics, construct, destruct, mixins) {
      ...
      */
       ...
       */
      __P_4_5: function (clazz, events, patch) {
        if (clazz.$$events) {
       ...
       */
      __P_4_3: function (clazz, properties, patch) {
       ...
       */
      __P_4_4: function (clazz, members, patch, base, wrap) {
        var proto = clazz.prototype;
        var key, member;
       ...
       */
      __P_4_6: function (clazz, mixin, patch) {
      ...
      */
       ...
       */
      __P_4_13: function (construct, name, type) {
...
//# sourceMappingURL=Class.js.map?dt=1613268392599