    ...
    */
    statics: {
      ...
      getManager: function (target) {
        ...
        var manager = this.__P_18_0[hash];

        if (!manager) {
          manager = new qx.event.Manager(target, this);
          this.__P_18_0[hash] = manager;
        }
       ...
       * @see #createEvent
       */
      __P_18_1: function (target, type, clazz, args) {
       ...
       * @see #createEvent
       */
      __P_18_2: function (target, type, clazz, args) {
      ...
      fireNonBubblingEvent: function (target, type, clazz, args) {
        var evt = this.__P_18_2.apply(this, arguments);
      ...
      */
      ...
      addHandler: function (handler) {
        // Append to list
        this.__P_18_3.push(handler); // Re-sort list


        this.__P_18_3.sort(function (a, b) {
      ...
      */
      ...
      addDispatcher: function (dispatcher, priority) {
        // Append to list
        this.__P_18_4.push(dispatcher); // Re-sort list


        this.__P_18_4.sort(function (a, b) {
          return a.PRIORITY - b.PRIORITY;
        });
      },
...
//# sourceMappingURL=Registration.js.map?dt=1613268394906