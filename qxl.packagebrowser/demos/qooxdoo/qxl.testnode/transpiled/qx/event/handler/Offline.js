  ...
  qx.Class.define("qx.event.handler.Offline", {
    ...
    */
    ...
    construct: function (manager) {
      ...
      this.__P_108_0 = manager;
      this.__P_108_1 = manager.getWindow();
    ...
    members: {
      ...
      */
      ...
      _initObserver: function () {
        this.__P_108_2 = qx.lang.Function.listener(this._onNative, this);
        qx.bom.Event.addNativeListener(this.__P_108_1, "offline", this.__P_108_2);
        qx.bom.Event.addNativeListener(this.__P_108_1, "online", this.__P_108_2);
      },
      ...
      _stopObserver: function () {
        qx.bom.Event.removeNativeListener(this.__P_108_1, "offline", this.__P_108_2);
        qx.bom.Event.removeNativeListener(this.__P_108_1, "online", this.__P_108_2);
      },
      ...
      _onNative: qx.event.GlobalError.observeMethod(function (domEvent) {
        qx.event.Registration.fireEvent(this.__P_108_1, domEvent.type, qx.event.type.Event, []);
      }),
      ...
      */
       ...
       */
      isOnline: function () {
        return !!this.__P_108_1.navigator.onLine;
      }
    },
    ...
    */
    destruct: function () {
      ...
      delete qx.event.handler.Appear.__P_108_3[this.toHashCode()];
    },
...
//# sourceMappingURL=Offline.js.map?dt=1613268399852