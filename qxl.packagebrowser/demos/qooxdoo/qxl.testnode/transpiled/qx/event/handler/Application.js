  ...
  qx.Class.define("qx.event.handler.Application", {
    ...
    */
    ...
    construct: function (manager) {
      ...
      this.__P_9_2 = false;
      this.__P_9_3 = false;
      this.__P_9_4 = false; // Initialize observers
    ...
    members: {
      ...
      */
      ...
      __P_9_5: function () {
        ...
        if (!this.__P_9_2 && this.__P_9_0 && qx.$$loader.scriptLoaded) {
          ...
          if (qx.core.Environment.get("engine.name") == "mshtml") {
            if (qx.event.Registration.hasListener(this._window, "ready")) {
              this.__P_9_2 = true; // Fire user event
       ...
       */
      __P_9_6: function () {
        this.__P_9_3 = true; // Fire user event
      ...
      */
      ...
      _onNativeLoad: function () {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_9_7),
          "false": this.__P_9_7
        });
      ...
      _onNativeUnload: function () {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_9_8),
          "false": this.__P_9_8
        });
        callback.apply(this, arguments);
      },
...
//# sourceMappingURL=Application.js.map?dt=1613268392952