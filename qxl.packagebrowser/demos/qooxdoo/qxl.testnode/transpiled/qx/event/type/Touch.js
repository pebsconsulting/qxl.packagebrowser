    ...
    */
    members: {
      ...
      isMultiTouch: function () {
        return this.__P_132_0().length > 1;
      },
      ...
      getDocumentLeft: function (touchIndex) {
        return this.__P_132_1(touchIndex).pageX;
      },
      ...
      getDocumentTop: function (touchIndex) {
        return this.__P_132_1(touchIndex).pageY;
      },
      ...
      getScreenLeft: function (touchIndex) {
        return this.__P_132_1(touchIndex).screenX;
      },
      ...
      getScreenTop: function (touchIndex) {
        return this.__P_132_1(touchIndex).screenY;
      },
      ...
      getViewportLeft: function (touchIndex) {
        return this.__P_132_1(touchIndex).clientX;
      },
      ...
      getViewportTop: function (touchIndex) {
        return this.__P_132_1(touchIndex).clientY;
      },
      ...
      getIdentifier: function (touchIndex) {
        return this.__P_132_1(touchIndex).identifier;
      },
       ...
       */
      __P_132_1: function (touchIndex) {
        touchIndex = touchIndex == null ? 0 : touchIndex;
        return this.__P_132_0()[touchIndex];
      },
...
//# sourceMappingURL=Touch.js.map?dt=1613268401271