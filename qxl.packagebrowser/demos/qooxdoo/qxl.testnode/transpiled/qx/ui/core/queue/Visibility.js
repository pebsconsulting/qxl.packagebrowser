  ...
  qx.Class.define("qx.ui.core.queue.Visibility", {
    statics: {
      ...
      remove: function (widget) {
        if (this.__P_50_1[widget.toHashCode()]) {
          delete this.__P_50_1[widget.toHashCode()];
          qx.lang.Array.remove(this.__P_50_0, widget);
        }

        delete this.__P_50_2[widget.toHashCode()];
      },
      ...
      isVisible: function (widget) {
        return this.__P_50_2[widget.toHashCode()] || false;
      },
       ...
       * @return {Boolean} Whether the widget is visible
       */
      __P_50_3: function (widget) {
        var data = this.__P_50_2;
      ...
      add: function (widget) {
        ...
        this.__P_50_0.unshift(widget);

        this.__P_50_1[widget.toHashCode()] = widget;
      ...
      flush: function () {
        ...
        var queue = this.__P_50_0;
        var data = this.__P_50_2; // Dynamically add children to queue
...
//# sourceMappingURL=Visibility.js.map?dt=1613268396982