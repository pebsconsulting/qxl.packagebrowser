  ...
  qx.Class.define("qx.ui.core.LayoutItem", {
    ...
    */
    members: {
      ...
      */
       ...
       */
      getBounds: function () {
        return this.__P_47_5 || this.__P_47_1 || null;
      },

      /**
       * Reconfigure number of separators
       */
      clearSeparators: function () {// empty template
      },
       ...
       */
      renderSeparator: function (separator, bounds) {// empty template
      },
      ...
      renderLayout: function (left, top, width, height) {
        ...
        var computed = this.__P_47_1;

        if (!computed) {
          computed = this.__P_47_1 = {};
        } // Detect changes
        ...
        if (this.__P_47_2) {
          changes.local = true;
          delete this.__P_47_2;
        }

        if (this.__P_47_4) {
          changes.margin = true;
          delete this.__P_47_4;
        }
        /*
        ...
        if (this.getHeight() == null && this._hasHeightForWidth()) {
          ...
          if (flowHeight != null && flowHeight !== this.__P_47_0) {
            // This variable is used in the next computation of the size hint
            this.__P_47_0 = flowHeight; // Re-add to layout queue
      ...
      getSizeHint: function (compute) {
        ...
        hint = this.__P_47_3 = this._computeSizeHint(); // Respect height for width

        if (this._hasHeightForWidth() && this.__P_47_0 && this.getHeight() == null) {
          hint.height = this.__P_47_0;
        } // normalize width
      ...
      */
      ...
      setLayoutProperties: function (props) {
        ...
        var storage = this.__P_47_6;

        if (!storage) {
          storage = this.__P_47_6 = {};
      ...
      getLayoutProperties: function () {
        return this.__P_47_6 || this.__P_47_7;
      },
      ...
      */
      ...
      clone: function () {
        ...
        var props = this.__P_47_6;

        if (props) {
          clone.__P_47_6 = qx.lang.Object.clone(props);
        }
    ...
    */
    destruct: function () {
      ...
      this.$$parent = this.$$subparent = this.__P_47_6 = this.__P_47_1 = this.__P_47_5 = this.__P_47_3 = null;
    }
  });
  qx.ui.core.LayoutItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=LayoutItem.js.map?dt=1613268396897