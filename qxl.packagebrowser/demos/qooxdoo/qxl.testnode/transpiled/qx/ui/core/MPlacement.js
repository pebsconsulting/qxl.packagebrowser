  ...
  qx.Mixin.define("qx.ui.core.MPlacement", {
    ...
    members: {
      ...
      placeToWidget: function (target, liveupdate) {
        ...
        if (liveupdate) {
          this.__P_88_5(); // Bind target and livupdate to placeToWidget


          this.__P_88_2 = qx.lang.Function.bind(this.placeToWidget, this, target, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_88_2); // Remove the listener when the element disappears.

          this.__P_88_4 = function () {
            this.__P_88_5();
          };

          this.addListener("disappear", this.__P_88_4, this);
        }
      ...
      __P_88_5: function () {
        if (this.__P_88_2) {
          qx.event.Idle.getInstance().removeListener("interval", this.__P_88_2);
          this.__P_88_2 = null;
        }

        if (this.__P_88_4) {
          this.removeListener("disappear", this.__P_88_4, this);
          this.__P_88_4 = null;
        }
      },
      ...
      placeToElement: function (elem, liveupdate) {
        ...
        if (liveupdate) {
          ...
          this.__P_88_2 = qx.lang.Function.bind(this.placeToElement, this, elem, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_88_2); // Remove the listener when the element disappears.
...
//# sourceMappingURL=MPlacement.js.map?dt=1613268398723