  ...
  qx.Class.define("qx.ui.core.Widget", {
    ...
    */
    construct: function () {
      ...
      this.__P_29_0 = this.__P_29_1(); // Initialize properties
    ...
    */
    statics: {
      ...
      __P_29_2: new qx.util.ObjectPool()
    },
    ...
    members: {
      ...
      */
      ...
      _setLayout: function (layout) {
        if (this.__P_29_5) {
          this.__P_29_5.connectToWidget(null);
        }
      ...
      renderLayout: function (left, top, width, height) {
        ...
        if (inner || changes.local || changes.margin) {
          if (this.__P_29_5 && this.hasLayoutChildren()) {
            ...
            this.__P_29_5.renderLayout(innerWidth, innerHeight, padding);
      ...
      */
      ...
      clearSeparators: function () {
        var reg = this.__P_29_6;

        if (!reg) {
          return;
        }

        var pool = qx.ui.core.Widget.__P_29_2;
        var content = this.getContentElement();
        var widget;
      ...
      renderSeparator: function (separator, bounds) {
        // Insert
        var widget = qx.ui.core.Widget.__P_29_2.getObject(qx.ui.core.Widget);
      ...
      */
      ...
      invalidateLayoutCache: function () {
        ...
        if (this.__P_29_5) {
          this.__P_29_5.invalidateLayoutCache();
        }
      },
      ...
      */
      ...
      getLayoutChildren: function () {
        var children = this.__P_29_7;

        if (!children) {
          return this.__P_29_8;
        }
      ...
      _getChildren: function () {
        return this.__P_29_7 || this.__P_29_8;
      },
      ...
      _add: function (child, options) {
        ...
        if (child.getLayoutParent() == this) {
          qx.lang.Array.remove(this.__P_29_7, child);
        }

        if (this.__P_29_7) {
          this.__P_29_7.push(child);
        } else {
          this.__P_29_7 = [child];
        }

        this.__P_29_9(child, options);
      },
      ...
      _addAt: function (child, index, options) {
        ...
        if (ref) {
          qx.lang.Array.insertBefore(this.__P_29_7, child, ref);
        } else {
          this.__P_29_7.push(child);
        }
      ...
      _addBefore: function (child, before, options) {
        ...
        qx.lang.Array.insertBefore(this.__P_29_7, child, before);
      ...
      _addAfter: function (child, after, options) {
        ...
        qx.lang.Array.insertAfter(this.__P_29_7, child, after);
      ...
      _removeAt: function (index) {
        ...
        var child = this.__P_29_7[index];
        qx.lang.Array.removeAt(this.__P_29_7, index);
      ...
      _removeAll: function () {
        ...
        var children = this.__P_29_7.concat();

        this.__P_29_7.length = 0;

        for (var i = children.length - 1; i >= 0; i--) {
          this.__P_29_10(children[i]);
        }
      ...
      */
       ...
       */
      __P_29_9: function (child, options) {
      ...
      __P_29_10: function (child) {
        ...
        if (this.__P_29_5) {
          this.__P_29_5.invalidateChildrenCache();
        } // Add to layout queue
      ...
      */
       ...
       */
      __P_29_11: function (style, value) {
        var content = this.getContentElement();
        var decorator = this.getDecorator();
        decorator = qx.theme.manager.Decoration.getInstance().resolve(decorator);
      ...
      */
      ...
      _applyToolTipText: function (value, old) {
        {
          ...
          this.__P_29_4 = manager.addListener("changeLocale", function () {
      ...
      // property apply
      _applyTextColor: function (value, old) {// empty template
      },
      // property apply
      ...
      // property apply
      _applyFont: function (value, old) {// empty template
      },
      ...
      */
      ...
      addState: function (state) {
        ...
        this.__P_29_12[state] = true; // Fast path for hovered state
      ...
      removeState: function (state) {
        ...
        delete this.__P_29_12[state]; // Fast path for hovered state
      ...
      */
      ...
      syncAppearance: function () {
        ...
        if (this.__P_29_15) {
          // Clear flag
          delete this.__P_29_15; // Check if the selector was created previously
        ...
        this.fireDataEvent("syncAppearance", this.__P_29_12);
      },
      // property apply
      ...
      updateAppearance: function () {
        // Clear selector
        this.__P_29_15 = true; // Add to appearance queue
      ...
      */
       ...
       */
      syncWidget: function (jobs) {// empty implementation
      },
      ...
      */
      // property apply
      _applyNativeContextMenu: function (value, old, name) {// empty body to allow overriding
      },
      // property apply
      ...
      */
      ...
      _createChildControl: function (id) {
        ...
        return this.__P_29_13[id] = control;
      },
    ...
    */
    destruct: function () {
      ...
      if (!qx.core.ObjectRegistry.inShutDown) {
        {
          if (this.__P_29_4) {
            qx.locale.Manager.getInstance().removeListenerById(this.__P_29_4);
          }
      ...
      if (!qx.core.ObjectRegistry.inShutDown) {
        ...
        this._disposeArray("__P_29_6");
      } // Clear children array


      this._disposeArray("__P_29_7"); // Cleanup map of appearance states


      this.__P_29_12 = this.__P_29_13 = null; // Dispose layout manager and HTML elements

      this._disposeObjects("__P_29_5", "__P_29_0");
    }
  });
  qx.ui.core.Widget.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Widget.js.map?dt=1613268395744