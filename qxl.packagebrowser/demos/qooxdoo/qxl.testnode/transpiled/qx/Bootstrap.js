  ...
  qx.Bootstrap.define("qx.Bootstrap", {
    statics: {
      ...
      executePendingDefers: function (dbClassInfo) {
        ...
        if (!dbClassInfo) {
          var pendingDefers = this.__P_8_0;
          this.__P_8_0 = [];
      ...
      */
       ...
       * @type {String[]}
       */
      __P_8_1: ["isPrototypeOf", "hasOwnProperty", "toLocaleString", "toString", "valueOf", "propertyIsEnumerable", "constructor"],
      ...
      keys: {
        ...
        "BROKEN_IE": function (map) {
          ...
          var shadowedKeys = qx.Bootstrap.__P_8_1;
      ...
      */
      ...
      getClass: function (value) {
        ...
        return qx.Bootstrap.__P_8_2[classString] || classString.slice(8, -1);
      },
...
//# sourceMappingURL=Bootstrap.js.map?dt=1613268392894