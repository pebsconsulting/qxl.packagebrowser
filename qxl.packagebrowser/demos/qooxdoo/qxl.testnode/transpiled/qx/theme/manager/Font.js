    ...
    members: {
      ...
      resolve: function (value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          var font = this.__P_95_0(theme.fonts[value]);
       ...
       */
      __P_95_1: function (fonts, fontName) {
        ...
        if (value) {
          ...
          for (var key in source) {
            if (source[key].include && source[source[key].include]) {
              this.__P_95_1(source, key);
            }

            var font = this.__P_95_0(source[key]);
...
//# sourceMappingURL=Font.js.map?dt=1613268399169