  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.placement.Placement", {
    ...
    construct: function () {
      ...
      this.__P_117_0 = qx.util.placement.DirectAxis;
    },
    properties: {
      /**
    ...
    statics: {
      ...
      compute: function (size, area, target, offsets, position, modeX, modeY) {
        this.__P_117_1 = this.__P_117_1 || new qx.util.placement.Placement();
        var splitted = position.split("-");
        var edge = splitted[0];
        var align = splitted[1];

        this.__P_117_1.set({
          axisX: this.__P_117_2(modeX),
          axisY: this.__P_117_2(modeY),
          edge: edge,
          align: align
        });

        return this.__P_117_1.compute(size, area, target, offsets);
      },
      __P_117_3: null,
      __P_117_4: null,
      __P_117_5: null,
       ...
       */
      __P_117_2: function (mode) {
        switch (mode) {
          case "direct":
            this.__P_117_3 = this.__P_117_3 || qx.util.placement.DirectAxis;
            return this.__P_117_3;

          case "keep-align":
            this.__P_117_4 = this.__P_117_4 || qx.util.placement.KeepAlignAxis;
            return this.__P_117_4;

          case "best-fit":
            this.__P_117_5 = this.__P_117_5 || qx.util.placement.BestFitAxis;
    ...
    members: {
      ...
      compute: function (size, area, target, offsets) {
        var axisX = this.getAxisX() || this.__P_117_0;
        ...
        }, area.width, this.__P_117_6());

        var axisY = this.getAxisY() || this.__P_117_0;
...
//# sourceMappingURL=Placement.js.map?dt=1613268400311