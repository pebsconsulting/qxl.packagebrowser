  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Assert", {
    statics: {
       ...
       *
       */
      __P_60_1: function __P_60_1(comment, msgvarargs) {
       ...
       */
      __P_60_2: function __P_60_2(value) {
        var stringValue;
      ...
      */
      ...
      assertType: function assertType(value, type, msg) {
        ...
        _typeof(value) === type || this.__P_60_1(msg || "", "Expected value to be typeof '", type, "' but found ", value, "!");
      },
       ...
       * class
       */
      __P_60_3: function __P_60_3(object, classname) {
        if (!object) {
          return false;
        }
...
//# sourceMappingURL=Assert.js.map?dt=1613267510101