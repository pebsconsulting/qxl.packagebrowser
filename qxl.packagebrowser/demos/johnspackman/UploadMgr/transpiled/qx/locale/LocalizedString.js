  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.locale.LocalizedString", {
    ...
    construct: function construct(translation, messageId, args, localized) {
      ...
      this.__P_111_0 = messageId;
      this.__P_111_1 = !!localized;
      this.__P_111_2 = args;
    },
    members: {
      __P_111_1: null,
      ...
      translate: function translate() {
        if (this.__P_111_1) {
          return qx.locale.Manager.getInstance().localize(this.__P_111_0, this.__P_111_2);
        }

        return qx.locale.Manager.getInstance().translate(this.__P_111_0, this.__P_111_2);
      },
...
//# sourceMappingURL=LocalizedString.js.map?dt=1613267514178