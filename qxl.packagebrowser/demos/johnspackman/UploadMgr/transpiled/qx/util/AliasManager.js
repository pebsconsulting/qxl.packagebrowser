  ...
  qx.Class.define("qx.util.AliasManager", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_28_0 = {}; // Define static alias from setting
    ...
    members: {
      ...
      _preprocess: function _preprocess(value) {
        ...
        if (dynamics[value] === false) {
          ...
          if (this.__P_28_0[value]) {
            return this.__P_28_0[value];
          }

          var alias = value.substring(0, value.indexOf("/"));
          var resolved = this.__P_28_0[alias];
      ...
      add: function add(alias, base) {
        ...
        this.__P_28_0[alias] = base; // Localify stores
      ...
      remove: function remove(alias) {
        delete this.__P_28_0[alias]; // No signal for depending objects here. These
...
//# sourceMappingURL=AliasManager.js.map?dt=1613267508218