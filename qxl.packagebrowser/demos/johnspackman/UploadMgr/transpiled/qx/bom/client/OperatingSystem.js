  ...
  qx.Bootstrap.define("qx.bom.client.OperatingSystem", {
    statics: {
      ...
      getVersion: function getVersion() {
        var version = qx.bom.client.OperatingSystem.__P_47_1(navigator.userAgent);

        if (version == null) {
          version = qx.bom.client.OperatingSystem.__P_47_2(navigator.userAgent);
        }
       ...
       */
      __P_47_1: function __P_47_1(userAgent) {
        var str = [];

        for (var key in qx.bom.client.OperatingSystem.__P_47_0) {
          str.push(key);
        }
        ...
        if (match && match[1]) {
          return qx.bom.client.OperatingSystem.__P_47_0[match[1]];
        }
       ...
       * @return {String} version number as string or null.
       */
      __P_47_2: function __P_47_2(userAgent) {
...
//# sourceMappingURL=OperatingSystem.js.map?dt=1613267509180