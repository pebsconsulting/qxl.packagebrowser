  ...
  qx.Class.define("qx.ui.core.queue.Layout", {
    statics: {
      ...
      remove: function remove(widget) {
        delete this.__P_43_0[widget.toHashCode()];
      },
      ...
      add: function add(widget) {
        this.__P_43_0[widget.toHashCode()] = widget;
      ...
      */
      isScheduled: function isScheduled(widget) {
        return !!this.__P_43_0[widget.toHashCode()];
      },
      ...
      flush: function flush() {
        ...
        var queue = this.__P_43_2(); // iterate in reversed order to process widgets with the smallest nesting
...
//# sourceMappingURL=Layout.js.map?dt=1613267508975