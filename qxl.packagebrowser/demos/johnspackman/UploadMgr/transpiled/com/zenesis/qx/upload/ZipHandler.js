(function () {
  ...
  qx.Class.define("com.zenesis.qx.upload.ZipHandler", {
    ...
    construct: function construct(uploader) {
      com.zenesis.qx.upload.AbstractHandler.constructor.call(this, uploader);
      this.__P_14_0 = new JSZip();
    },
    members: {
      generateAsync: function generateAsync(options, onUpdate) {
        return this.__P_14_0.generateAsync(options, onUpdate);
      },
      ...
      _createFile: function _createFile(input) {
        ...
        if (!bomFiles || !bomFiles.length) this.debug("No files found to upload via ZipHandler");
        var files = [];
      ...
      _doUpload: function _doUpload(file) {
        this.__P_14_0.file(file.getFilename(), file.getBrowserObject());
  ...
  com.zenesis.qx.upload.ZipHandler.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ZipHandler.js.map?dt=1613267506734