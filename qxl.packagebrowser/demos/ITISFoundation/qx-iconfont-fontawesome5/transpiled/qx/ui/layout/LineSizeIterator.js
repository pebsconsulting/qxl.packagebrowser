  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.layout.LineSizeIterator", {
    ...
    construct: function construct(children, spacing) {
      this.__P_21_0 = children;
      this.__P_21_1 = spacing;
      this.__P_21_2 = children.length > 0;
      this.__P_21_3 = 0;
    },
    members: {
      __P_21_0: null,
      ...
      computeNextLine: function computeNextLine(availWidth) {
        ...
        var children = this.__P_21_0;
        var lineHeight = 0;
        var lineWidth = 0;
        var lineChildren = [];
        var gapsBefore = [];

        for (var i = this.__P_21_3; i < children.length; i++) {
          var child = children[i];
          var size = child.getSizeHint();

          var gapBefore = this.__P_21_4(i);

          var childWidth = size.width + gapBefore;
          var isFirstChild = i == this.__P_21_3;
       ...
       */
      __P_21_4: function __P_21_4(childIndex) {
        var isFirstInLine = childIndex == this.__P_21_3;

        if (isFirstInLine) {
          return this.__P_21_0[childIndex].getMarginLeft();
        } else {
          return Math.max(this.__P_21_0[childIndex - 1].getMarginRight(), this.__P_21_0[childIndex].getMarginLeft(), this.__P_21_1);
        }
      },
...
//# sourceMappingURL=LineSizeIterator.js.map?dt=1613267390104