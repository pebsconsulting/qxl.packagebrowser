  ...
  ************************************************************************ */
  ...
  qx.Class.define("widgetbrowser.pages.Embed", {
    ...
    construct: function construct() {
      ...
      this.__P_85_0 = new qx.ui.container.Composite(gridLayout);
      this.add(this.__P_85_0, {
        width: "100%",
        height: "100%"
      });
      this.initWidgets();
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        if (qx.core.Environment.get("html.canvas")) {
          ...
          canvas.addListener("redraw", this.__P_85_1, this);
          widgets.push(canvas);

          this.__P_85_0.add(canvas, {
            row: 3,
            column: 0
          });
        } else {
          this.__P_85_0.add(new qx.ui.basic.Label("Browser does not support canvas"), {
            row: 3,
            column: 0
          });
        } // HTML
        ...
        this.__P_85_0.add(htmlContainer, {
          row: 3,
          column: 1
        });
...
//# sourceMappingURL=Embed.js.map?dt=1613267463972