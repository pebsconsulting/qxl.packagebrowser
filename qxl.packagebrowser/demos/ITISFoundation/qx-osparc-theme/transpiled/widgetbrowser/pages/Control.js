  ...
  ************************************************************************ */
  ...
  qx.Class.define("widgetbrowser.pages.Control", {
    ...
    construct: function construct() {
      ...
      this.__P_84_0 = new qx.ui.container.Composite(new qx.ui.layout.VBox(20));
      this.add(this.__P_84_0, {
        top: 0
      });
      this.initWidgets();
    },
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        this.__P_84_0.add(label);

        this.__P_84_0.add(colorSelector); // ColorPopup
        ...
        this.__P_84_0.add(openColorPopup);
...
//# sourceMappingURL=Control.js.map?dt=1613267463945