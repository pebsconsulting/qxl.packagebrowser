  ...
  ************************************************************************ */
  ...
  qx.Class.define("widgetbrowser.pages.Window", {
    ...
    construct: function construct() {
      ...
      this.__P_82_0 = new qx.ui.window.Desktop().set({
        decorator: decorator
      });
      this.add(this.__P_82_0, {
        edge: 0,
        top: 0
      });
      this.initWidgets();
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        this.__P_82_0.add(w3, {
          left: 80,
          top: 230
        });
      },
      __P_82_1: function __P_82_1() {
        // Create the Window
...
//# sourceMappingURL=Window.js.map?dt=1613267463893