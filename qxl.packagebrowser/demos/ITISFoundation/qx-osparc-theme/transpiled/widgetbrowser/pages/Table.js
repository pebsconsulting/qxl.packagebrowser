  ...
  ************************************************************************ */
  ...
  qx.Class.define("widgetbrowser.pages.Table", {
    ...
    members: {
      ...
      __P_81_2: function __P_81_2(rowCount) {
        var rowData = [];
        ...
        for (var row = 0; row < rowCount; row++) {
          ...
          rowData.push([this.__P_81_0++, Math.random() * 10000, date, Math.random() > 0.5]);
        }
...
//# sourceMappingURL=Table.js.map?dt=1613267463769