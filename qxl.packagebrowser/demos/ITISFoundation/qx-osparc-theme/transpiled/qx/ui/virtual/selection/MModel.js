  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.virtual.selection.MModel", {
    construct: function construct() {
      ...
      this.__P_192_0.addListener("change", this._onChangeSelection, this);

      this._applySelection(this.__P_192_0, null);
    },
    properties: {
    ...
    members: {
      ...
      */
      ...
      setSelection: function setSelection(value) {
        if (value) {
          this.__P_192_0.replace(value);
        } else {
          this.__P_192_0.removeAll();
        }
      },
      ...
      */
       ...
       */
      __P_192_5: function __P_192_5(newSelection) {
        var selection = this.getSelection();
...
//# sourceMappingURL=MModel.js.map?dt=1613267471187