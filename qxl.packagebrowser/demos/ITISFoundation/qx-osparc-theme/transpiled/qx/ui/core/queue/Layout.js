  ...
  qx.Class.define("qx.ui.core.queue.Layout", {
    statics: {
      ...
      remove: function remove(widget) {
        delete this.__P_41_0[widget.toHashCode()];
      },
      ...
      add: function add(widget) {
        this.__P_41_0[widget.toHashCode()] = widget;
      ...
      */
      ...
      flush: function flush() {
        ...
        var queue = this.__P_41_2(); // iterate in reversed order to process widgets with the smallest nesting
       ...
       */
      __P_41_2: function __P_41_2() {
        var sortedQueue = [];

        var levels = this.__P_41_3();
...
//# sourceMappingURL=Layout.js.map?dt=1613267461152