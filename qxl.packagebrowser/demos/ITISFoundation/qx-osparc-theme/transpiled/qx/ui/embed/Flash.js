  ...
  qx.Class.define("qx.ui.embed.Flash", {
    ...
    members: {
      ...
      */
      ...
      _checkLoading: function _checkLoading() {
        ...
        if (source != "" && source != null && source != "undefined") {
          if (!this.isLoaded()) {
            if (!this.__P_152_0) {
              this.__P_152_0 = new Date().getTime();
            }

            var timeDiff = new Date().getTime() - this.__P_152_0;
      ...
      */
       ...
       */
      __P_152_1: function __P_152_1(key, value) {
...
//# sourceMappingURL=Flash.js.map?dt=1613267468806