  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Xhr", {
    ...
    construct: function construct() {
      var boundFunc = qx.Bootstrap.bind(this.__P_200_0, this); // GlobalError shouldn't be included in qx.Website builds so use it
      ...
      if (qx.event && qx.event.GlobalError && qx.event.GlobalError.observeMethod) {
        this.__P_200_1 = qx.event.GlobalError.observeMethod(boundFunc);
      } else {
        this.__P_200_1 = boundFunc;
      }

      this.__P_200_2 = qx.Bootstrap.bind(this.__P_200_3, this);
      this.__P_200_4 = qx.Bootstrap.bind(this.__P_200_5, this);
      this.__P_200_6 = qx.Bootstrap.bind(this.__P_200_7, this);
      ...
      if (window.attachEvent) {
        this.__P_200_9 = qx.Bootstrap.bind(this.__P_200_10, this);
        window.attachEvent("onunload", this.__P_200_9);
      }
    },
    statics: {
      UNSENT: 0,
    ...
    members: {
      ...
      */
      ...
      open: function open(method, url, async, user, password) {
        this.__P_200_11(); // Mimick native behavior
        ...
        this.__P_200_12 = false;
        this.__P_200_13 = false;
        this.__P_200_14 = false; // Store URL for later checks
        ...
        this.__P_200_16 = async; // Default values according to spec.
        ...
        if (!this.__P_200_17() && this.readyState > qx.bom.request.Xhr.UNSENT) {
        ...
        this.__P_200_18.onreadystatechange = this.__P_200_1;
        ...
        try {
          ...
          this.__P_200_18.open(method, url, async, user, password); // BUGFIX: IE, Firefox < 3.5
          ...
          if (this.__P_200_16) {
            ...
            if (window.XDomainRequest) {
              this.readyState = 4;
              this.__P_200_18 = new XDomainRequest();
              this.__P_200_18.onerror = qx.Bootstrap.bind(function () {
              ...
              this.__P_200_18.open(method, url, async, user, password);
        ...
        if (qx.core.Environment.get("engine.name") === "mshtml" && qx.core.Environment.get("browser.documentmode") < 9 && this.__P_200_18.readyState > 0) {
          this.__P_200_18.setRequestHeader("If-Modified-Since", "-1");
        } // BUGFIX: Firefox
        // Firefox < 4 fails to trigger onreadystatechange OPENED for sync requests


        if (qx.core.Environment.get("engine.name") === "gecko" && parseInt(qx.core.Environment.get("engine.version"), 10) < 2 && !this.__P_200_16) {
      ...
      setRequestHeader: function setRequestHeader(key, value) {
        this.__P_200_11(); // Detect conditional requests


        if (key == "If-Match" || key == "If-Modified-Since" || key == "If-None-Match" || key == "If-Range") {
          this.__P_200_14 = true;
        }

        this.__P_200_18.setRequestHeader(key, value);
      ...
      send: function send(data) {
        this.__P_200_11(); // BUGFIX: IE & Firefox < 3.5
        // For sync requests, some browsers throw error on open()
        // while it should be on send()
        //


        if (!this.__P_200_16 && this.__P_200_19) {
          throw this.__P_200_19;
        } // BUGFIX: Opera
        ...
        if (this.timeout > 0) {
          this.__P_200_21 = window.setTimeout(this.__P_200_6, this.timeout);
        } // BUGFIX: Firefox 2
        ...
        data = data !== null && this.__P_200_22.indexOf(dataType) === -1 ? data.toString() : data; // Some browsers may throw an error when sending of async request fails.
        ...
        try {
          ...
          if (this.__P_200_16) {
            this.__P_200_18.responseType = this.responseType;
          }

          this.__P_200_18.send(data);
        } catch (SendError) {
          if (!this.__P_200_16) {
            throw SendError;
          } // BUGFIX
        ...
        if (qx.core.Environment.get("engine.name") === "gecko" && !this.__P_200_16) {
          // Properties all set, only missing native readystatechange event
          this.__P_200_0();
        } // Set send flag


        this.__P_200_13 = true;
        return this;
      },
      ...
      abort: function abort() {
        ...
        this.__P_200_12 = true;

        this.__P_200_18.abort();

        if (this.__P_200_18 && this.readyState !== qx.bom.request.Xhr.DONE) {
          this.readyState = this.__P_200_18.readyState;
        }
      ...
      */
      ...
      getResponseHeader: function getResponseHeader(header) {
        ...
        if (qx.core.Environment.get("browser.documentmode") === 9 && this.__P_200_18.aborted) {
          return "";
        }

        return this.__P_200_18.getResponseHeader(header);
      },
      ...
      getAllResponseHeaders: function getAllResponseHeaders() {
        ...
        return this.__P_200_18.getAllResponseHeaders();
      },
      ...
      overrideMimeType: function overrideMimeType(mimeType) {
        ...
        if (this.__P_200_18.overrideMimeType) {
          this.__P_200_18.overrideMimeType(mimeType);
        } else {
      ...
      */
      ...
      dispose: function dispose() {
        ...
        window.clearTimeout(this.__P_200_21); // Remove unload listener in IE. Aborting on unload is no longer required
        // for this instance.

        if (window.detachEvent) {
          window.detachEvent("onunload", this.__P_200_9);
        } // May fail in IE


        try {
          this.__P_200_18.onreadystatechange;
        ...
        this.__P_200_18.onreadystatechange = noop;
        this.__P_200_18.onload = noop;
        this.__P_200_18.onerror = noop;
        this.__P_200_18.onprogress = noop; // Abort any network activity

        this.abort(); // Remove reference to native XHR

        this.__P_200_18 = null;
        this.responseText = null;
        this.__P_200_20 = true;
        return true;
      },
      ...
      */
      ...
      __P_200_8: function __P_200_8() {
        ...
        this.__P_200_18 = this._createNativeXhr(); // Track native ready state changes

        this.__P_200_18.onreadystatechange = this.__P_200_1; // Track native abort, when supported

        if (qx.Bootstrap.getClass(this.__P_200_18.onabort) !== "Undefined") {
          this.__P_200_18.onabort = this.__P_200_2;
        } // Track native progress, when supported


        if (qx.Bootstrap.getClass(this.__P_200_18.onprogress) !== "Undefined") {
          this.__P_200_18.onprogress = this.__P_200_4;
          this.progress = {
        ...
        this.__P_200_20 = this.__P_200_13 = this.__P_200_12 = false; // Initialize data white list

        this.__P_200_22 = ["ArrayBuffer", "Blob", "File", "HTMLDocument", "String", "FormData"];
      },
       ...
       */
      __P_200_5: function __P_200_5(e) {
      ...
      __P_200_0: function __P_200_0() {
        ...
        if (this.readyState === qx.bom.request.Xhr.DONE && this.__P_200_12 && !this.__P_200_13) {
          return;
        } // BUGFIX: IE
        ...
        if (!this.__P_200_16 && (nxhr.readyState == 2 || nxhr.readyState == 3)) {
          return;
       ...
       */
      __P_200_27: function __P_200_27() {
        ...
        if (this.__P_200_24) {
          ...
          this.__P_200_24 = false; // Fire either "abort", "load" or "error"
        } else {
          if (this.__P_200_12) {
            this._emit("abort");
          } else {
       ...
       */
      __P_200_28: function __P_200_28() {
      ...
      __P_200_7: function __P_200_7() {
        ...
        this.__P_200_24 = true; // No longer consider request. Abort.
       ...
       */
      __P_200_25: function __P_200_25() {
        ...
        if (qx.core.Environment.get("engine.name") === "opera") {
          if (isDone && // Done
          this.__P_200_14 && // Conditional request
          !this.__P_200_12 && // Not aborted
       ...
       */
      __P_200_26: function __P_200_26() {
        // BUGFIX: IE
       ...
       */
      __P_200_10: function __P_200_10() {
        try {
          // Abort and dispose
          if (this) {
            this.dispose();
       ...
       */
      __P_200_17: function __P_200_17() {
       ...
       */
      __P_200_11: function __P_200_11() {
        if (this.__P_200_20) {
...
//# sourceMappingURL=Xhr.js.map?dt=1613267471778