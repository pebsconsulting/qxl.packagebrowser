  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_28_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_28_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_28_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_28_3()) {
      ...
      __P_28_0: function __P_28_0() {
        ...
        if (qx.bom.client.Engine.__P_28_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1613267459421