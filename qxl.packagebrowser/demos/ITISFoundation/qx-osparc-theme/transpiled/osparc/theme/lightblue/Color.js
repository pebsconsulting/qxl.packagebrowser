  ...
  ************************************************************************ */
  ...
  qx.Theme.define("osparc.theme.lightblue.Color", {
    colors: {
      ...
      // background
      "background-main-lighter": "#D8E3F1",
      // navbar bg
      "background-main-lighter+": "#BFCAD8",
      // dashboard button
      "contrasted-background": "#9CAFC9",
      // dashboard button hovered
      "contrasted-background+": "#8396B0",
  ...
  osparc.theme.lightblue.Color.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Color.js.map?dt=1613267456172